...
public class HtmlPolicyBuilderTest extends TestCase {
    ...
    @Test
    public static final void testDuplicateAttributesDoNotReachElementPolicy_add10_failAssert0_add2261_failAssert0_literalMutationNumber14652_failAssert0() throws Exception {
        try {
            {
                {
                ...
                junit.framework.TestCase.fail("testDuplicateAttributesDoNotReachElementPolicy_add10_failAssert0_add2261 should have thrown AssertionFailedError");
            }
            junit.framework.TestCase.fail("testDuplicateAttributesDoNotReachElementPolicy_add10_failAssert0_add2261_failAssert0_literalMutationNumber14652 should have thrown AssertionFailedError");
