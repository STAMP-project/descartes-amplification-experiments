...
public class HtmlPolicyBuilderTest extends TestCase {
    ...
    @Test
    public static final void testDuplicateAttributesDoNotReachElementPolicy_add10_failAssert0_add2152_failAssert0() throws Exception {
        try {
            {
            ...
            junit.framework.TestCase.fail("testDuplicateAttributesDoNotReachElementPolicy_add10_failAssert0_add2152 should have thrown AssertionFailedError");
