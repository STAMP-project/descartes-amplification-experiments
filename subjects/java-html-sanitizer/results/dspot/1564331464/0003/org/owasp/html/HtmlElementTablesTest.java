...
public final class HtmlElementTablesTest extends TestCase {
    ...
    @Test
    public void testElementNames_add6() throws Exception {
        boolean boolean_18 = (t.indexForName("a")) != (t.indexForName("b"));
        boolean boolean_19 = (t.indexForName("p")) != (t.indexForName("q"));
        boolean boolean_20 = (t.indexForName("customclass")) >= 0;
        int o_testElementNames_add6__9 = t.nElementTypes();
        TestCase.assertEquals(145, ((int) (o_testElementNames_add6__9)));
        for (int ei = 0, nei = this.t.nElementTypes(); ei < nei; ++ei) {
            String s = this.t.canonNameForIndex(ei);
            this.t.indexForName(s);
            ++ei;
