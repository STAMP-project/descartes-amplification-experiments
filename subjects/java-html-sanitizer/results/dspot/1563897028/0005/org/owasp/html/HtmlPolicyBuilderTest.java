...
public class HtmlPolicyBuilderTest extends TestCase {
    ...
    @Test
    public static final void testDuplicateAttributesDoNotReachElementPolicy_add10_failAssert0_add2009_failAssert0() throws Exception {
        try {
            {
            ...
            junit.framework.TestCase.fail("testDuplicateAttributesDoNotReachElementPolicy_add10_failAssert0_add2009 should have thrown AssertionFailedError");
