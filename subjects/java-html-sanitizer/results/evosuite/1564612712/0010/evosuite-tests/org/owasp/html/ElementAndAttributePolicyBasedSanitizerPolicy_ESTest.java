...
public class ElementAndAttributePolicyBasedSanitizerPolicy_ESTest extends ElementAndAttributePolicyBasedSanitizerPolicy_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      MockFile mockFile0 = new MockFile("'rC0yp83*gqi/H43 Vp");
      MockPrintWriter mockPrintWriter0 = new MockPrintWriter(mockFile0);
      Handler<Object> handler0 = (Handler<Object>) mock(Handler.class, new ViolatedAssumptionAnswer());
      HtmlStreamRenderer.CloseableHtmlStreamRenderer htmlStreamRenderer_CloseableHtmlStreamRenderer0 = new HtmlStreamRenderer.CloseableHtmlStreamRenderer(mockPrintWriter0, handler0, handler0);
