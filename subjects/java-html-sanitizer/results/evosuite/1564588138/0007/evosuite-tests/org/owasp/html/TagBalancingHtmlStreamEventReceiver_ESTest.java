...
public class TagBalancingHtmlStreamEventReceiver_ESTest extends TagBalancingHtmlStreamEventReceiver_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      HtmlStreamRenderer.CloseableHtmlStreamRenderer htmlStreamRenderer_CloseableHtmlStreamRenderer0 = new HtmlStreamRenderer.CloseableHtmlStreamRenderer((Appendable) null, handler0, handler1);
      ...
      tagBalancingHtmlStreamEventReceiver0.closeTag(",]#\"[C~&`Ig,|GJ2}");
      assertFalse(immutableSet0.contains(",]#\"[C~&`Ig,|GJ2}"));
  }
  ...
  public void test1()  throws Throwable  {
      ...
      try { 
        tagBalancingHtmlStreamEventReceiver0.closeTag("Ra^1a0k;s2;wChe.{");
