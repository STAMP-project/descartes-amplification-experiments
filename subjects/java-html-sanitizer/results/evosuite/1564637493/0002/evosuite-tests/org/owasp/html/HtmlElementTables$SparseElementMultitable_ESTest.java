...
public class HtmlElementTables$SparseElementMultitable_ESTest extends HtmlElementTables$SparseElementMultitable_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      int[] intArray3 = htmlElementTables_SparseElementMultitable0.getElementIndexList(0, 2729);
      assertEquals(0, intArray3.length);
  }

  @Test(timeout = 4000)
  public void test1()  throws Throwable  {
      int[][][] intArray0 = new int[1][6][8];
      int[][] intArray1 = new int[1][2];
      intArray0[0] = intArray1;
      HtmlElementTables.SparseElementMultitable htmlElementTables_SparseElementMultitable0 = new HtmlElementTables.SparseElementMultitable(intArray0);
      int[] intArray2 = htmlElementTables_SparseElementMultitable0.getElementIndexList(1, 0);
  ...
  public void test2()  throws Throwable  {
      ...
      try { 
        htmlElementTables_SparseElementMultitable0.getElementIndexList((-164), 0);
  ...
  public void test4()  throws Throwable  {
      int[][][] intArray0 = new int[1][1][6];
      HtmlElementTables.SparseElementMultitable htmlElementTables_SparseElementMultitable0 = new HtmlElementTables.SparseElementMultitable(intArray0);
      int[] intArray1 = htmlElementTables_SparseElementMultitable0.getElementIndexList(0, 16);
  ...
  public void test5()  throws Throwable  {
      int[][][] intArray0 = new int[1][1][6];
      HtmlElementTables.SparseElementMultitable htmlElementTables_SparseElementMultitable0 = new HtmlElementTables.SparseElementMultitable(intArray0);
      int[] intArray1 = htmlElementTables_SparseElementMultitable0.getElementIndexList(16, 0);
