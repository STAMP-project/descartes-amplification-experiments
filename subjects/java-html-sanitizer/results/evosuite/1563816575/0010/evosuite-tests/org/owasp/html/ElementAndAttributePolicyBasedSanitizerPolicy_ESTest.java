...
public class ElementAndAttributePolicyBasedSanitizerPolicy_ESTest extends ElementAndAttributePolicyBasedSanitizerPolicy_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      HtmlStreamRenderer.CloseableHtmlStreamRenderer htmlStreamRenderer_CloseableHtmlStreamRenderer0 = new HtmlStreamRenderer.CloseableHtmlStreamRenderer(charArrayWriter0, handler0, handler0);
      ElementAndAttributePolicyBasedSanitizerPolicy elementAndAttributePolicyBasedSanitizerPolicy0 = new ElementAndAttributePolicyBasedSanitizerPolicy(htmlStreamRenderer_CloseableHtmlStreamRenderer0, (ImmutableMap<String, ElementAndAttributePolicies>) null, (ImmutableSet<String>) null);
      // Undeclared exception!
      try { 
        elementAndAttributePolicyBasedSanitizerPolicy0.closeDocument();
