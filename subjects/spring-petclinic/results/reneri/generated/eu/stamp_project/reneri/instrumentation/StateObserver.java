...
public class StateObserver {
    ...
    static {
        ...
        eu.stamp_project.reneri.instrumentation.StateObserver.REPLACEMENT = new java.lang.String[128];
        for (int i = 0; i <= 31; i++) {
            eu.stamp_project.reneri.instrumentation.StateObserver.REPLACEMENT[i] = java.lang.String.format("\\u%04x", ((int) (i)));
        }
        eu.stamp_project.reneri.instrumentation.StateObserver.REPLACEMENT['"'] = "\\\"";
        eu.stamp_project.reneri.instrumentation.StateObserver.REPLACEMENT['\\'] = "\\\\";
        eu.stamp_project.reneri.instrumentation.StateObserver.REPLACEMENT['\t'] = "\\t";
        eu.stamp_project.reneri.instrumentation.StateObserver.REPLACEMENT['\b'] = "\\b";
        eu.stamp_project.reneri.instrumentation.StateObserver.REPLACEMENT['\n'] = "\\n";
        eu.stamp_project.reneri.instrumentation.StateObserver.REPLACEMENT['\r'] = "\\r";
        eu.stamp_project.reneri.instrumentation.StateObserver.REPLACEMENT['\f'] = "\\f";
    }
    ...
    public static void observeMethodCall(java.lang.String containerClassName, java.lang.String methodName, java.lang.String methodDescription, java.lang.Class[] parameterTypes, java.lang.Object[] parameters, java.lang.Class thatType, java.lang.Object that, java.lang.Class resultType, java.lang.Object result) {
        synchronized(eu.stamp_project.reneri.instrumentation.StateObserver.counter) {
            ...
            // observe(pointcut + "|#trace|length", stackTrace.length - 1);
            eu.stamp_project.reneri.instrumentation.StateObserver.observe((pointcut + "|#trace"), stackTrace);
