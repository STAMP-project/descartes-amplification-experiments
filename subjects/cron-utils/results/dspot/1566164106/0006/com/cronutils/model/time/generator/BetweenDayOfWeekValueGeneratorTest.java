...
public class BetweenDayOfWeekValueGeneratorTest {
    @Test(timeout = 10000)
    public void testGenerateCandidatesNotIncludingIntervalExtremes_literalMutationNumber32_failAssert0() throws Exception {
        try {
            ...
            List<Integer> values = generator.generateCandidates(1, 0);
            values.contains(29);
            org.junit.Assert.fail("testGenerateCandidatesNotIncludingIntervalExtremes_literalMutationNumber32 should have thrown DateTimeException");
