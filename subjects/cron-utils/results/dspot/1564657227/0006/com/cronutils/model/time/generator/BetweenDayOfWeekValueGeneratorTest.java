...
public class BetweenDayOfWeekValueGeneratorTest {
    @Test(timeout = 10000)
    public void testGenerateCandidatesNotIncludingIntervalExtremes_literalMutationNumber29_failAssert0() throws Exception {
        try {
            ...
            List<Integer> values = generator.generateCandidates(0, 29);
            values.contains(29);
            org.junit.Assert.fail("testGenerateCandidatesNotIncludingIntervalExtremes_literalMutationNumber29 should have thrown DateTimeException");
