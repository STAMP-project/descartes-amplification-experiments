...
public class BetweenDayOfWeekValueGeneratorTest {
    @Test(timeout = 10000)
    public void testGenerateCandidatesNotIncludingIntervalExtremes_literalMutationNumber35_failAssert0() throws Exception {
        try {
            ...
            List<Integer> values = generator.generateCandidates(1, 58);
            values.contains(29);
            org.junit.Assert.fail("testGenerateCandidatesNotIncludingIntervalExtremes_literalMutationNumber35 should have thrown DateTimeException");
