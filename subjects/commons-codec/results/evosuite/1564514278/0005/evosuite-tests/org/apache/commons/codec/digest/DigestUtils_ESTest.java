...
public class DigestUtils_ESTest extends DigestUtils_ESTest_scaffolding {
  ...
  public void test3()  throws Throwable  {
      MessageDigest messageDigest0 = DigestUtils.getDigest("SHA-512", (MessageDigest) null);
      assertEquals("SHA-512", messageDigest0.getAlgorithm());
  }

  @Test(timeout = 4000)
  public void test4()  throws Throwable  {
      MessageDigest messageDigest0 = DigestUtils.getDigest("D9s uz", (MessageDigest) null);
