...
public class JMethod_ESTest extends JMethod_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      JPackage jPackage0 = new JPackage(":M+N{.~z_JL\"ObU'I", jCodeModel0);
      EClassType eClassType0 = EClassType.ANNOTATION_TYPE_DECL;
      JDefinedClass jDefinedClass0 = new JDefinedClass(jPackage0, 58, (String) null, eClassType0);
      JMethod jMethod0 = new JMethod(jDefinedClass0, 44, jCodeModel0.SHORT, "x@<");
      assertEquals("x@<", jMethod0.name());
  }

  @Test(timeout = 4000)
  public void test1()  throws Throwable  {
      JCodeModel jCodeModel0 = new JCodeModel();
      AbstractJType[] abstractJTypeArray0 = new AbstractJType[1];
