...
public class JFormatter_ESTest extends JFormatter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn("psiix").when(jDefinedClass0).name();
  ...
  public void test1()  throws Throwable  {
      ...
      JDefinedClass jDefinedClass0 = mock(JDefinedClass.class, new ViolatedAssumptionAnswer());
      doReturn(jCodeModel0).when(jDefinedClass0).owner();
      doReturn("[+BUaLU").when(jDefinedClass0).toString();
      doReturn("[+BUaLU").when(jDefinedClass0).name();
      doReturn((IJClassContainer) null).when(jDefinedClass0).parentContainer();
      StringWriter stringWriter0 = new StringWriter();
      SourcePrintWriter sourcePrintWriter0 = new SourcePrintWriter(stringWriter0, "[+BUaLU");
      JFormatter jFormatter0 = new JFormatter(sourcePrintWriter0, "[+BUaLU");
      // Undeclared exception!
      try { 
        jFormatter0.writeClassFull(jDefinedClass0);
        fail("Expecting exception: NullPointerException");
