...
public class JFormatter_ESTest extends JFormatter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      SourcePrintWriter sourcePrintWriter0 = new SourcePrintWriter(stringWriter0, "+|.y)Ck>t{?WJ*\"3|v");
      JFormatter jFormatter0 = new JFormatter(sourcePrintWriter0, "+|.y)Ck>t{?WJ*\"3|v");
      ...
      doReturn("+|.y)Ck>t{?WJ*\"3|v").when(jDefinedClass0).name();
  ...
  public void test1()  throws Throwable  {
      ...
      JDefinedClass jDefinedClass0 = mock(JDefinedClass.class, new ViolatedAssumptionAnswer());
      doReturn(jCodeModel0).when(jDefinedClass0).owner();
      doReturn("+|.y)Ck>t{?WJ*\"3|v").when(jDefinedClass0).toString();
      doReturn("+|.y)Ck>t{?WJ*\"3|v").when(jDefinedClass0).name();
