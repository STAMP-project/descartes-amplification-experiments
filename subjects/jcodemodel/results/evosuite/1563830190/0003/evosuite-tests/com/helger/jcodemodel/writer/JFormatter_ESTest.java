...
public class JFormatter_ESTest extends JFormatter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn("_collectShouldBeImported(").when(jDefinedClass0).toString();
      doReturn("_collectShouldBeImported(").when(jDefinedClass0).name();
      ...
      SourcePrintWriter sourcePrintWriter0 = new SourcePrintWriter(stringWriter0, "1");
  ...
  public void test1()  throws Throwable  {
      ...
      JDefinedClass jDefinedClass0 = mock(JDefinedClass.class, new ViolatedAssumptionAnswer());
      doReturn(jCodeModel0).when(jDefinedClass0).owner();
      doReturn("b").when(jDefinedClass0).toString();
      doReturn("b").when(jDefinedClass0).name();
  ...
  public void test2()  throws Throwable  {
      ...
      JDefinedClass jDefinedClass0 = mock(JDefinedClass.class, new ViolatedAssumptionAnswer());
      doReturn(jCodeModel0).when(jDefinedClass0).owner();
      doReturn("^\"dojE^q)\"1").when(jDefinedClass0).toString();
      doReturn("^\"dojE^q)\"1").when(jDefinedClass0).name();
      doReturn(iJClassContainer0).when(jDefinedClass0).parentContainer();
      SourcePrintWriter sourcePrintWriter0 = new SourcePrintWriter(stringWriter0, "^\"dojE^q)\"1");
      JFormatter jFormatter0 = new JFormatter(sourcePrintWriter0, "^\"dojE^q)\"1");
      // Undeclared exception!
      try { 
        jFormatter0.writeClassFull(jDefinedClass0);
