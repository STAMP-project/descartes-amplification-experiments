...
public class JDirectClass_ESTest extends JDirectClass_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      JDirectClass jDirectClass0 = new JDirectClass(jCodeModel0, ".Ps`Q@/;fT`~uz/`n");
      assertEquals("Ps`Q@/;fT`~uz/`n", jDirectClass0.name());
  }
  ...
  public void test2()  throws Throwable  {
      ...
      assertEquals(EClassType.ENUM, jDirectClass1.getClassType());
  }
}
