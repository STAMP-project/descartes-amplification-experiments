...
public class JFormatter_ESTest extends JFormatter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      SourcePrintWriter sourcePrintWriter0 = new SourcePrintWriter(stringWriter0, "^=*zx_LC9ww~NfLW");
      JFormatter jFormatter0 = new JFormatter(sourcePrintWriter0, "^=*zx_LC9ww~NfLW");
      ...
      doReturn("^=*zx_LC9ww~NfLW").when(jDefinedClass0).toString();
  ...
  public void test1()  throws Throwable  {
      ...
      doReturn(jCodeModel0).when(jDefinedClass0).owner();
      doReturn("^=*zx_LC9ww~NfLW").when(jDefinedClass0).toString();
      doReturn("^=*zx_LC9ww~NfLW").when(jDefinedClass0).name();
  ...
  public void test2()  throws Throwable  {
      ...
      SourcePrintWriter sourcePrintWriter0 = new SourcePrintWriter(stringWriter0, "^m*zx_LC9'w~NfLW");
      JFormatter jFormatter0 = new JFormatter(sourcePrintWriter0, "^m*zx_LC9'w~NfLW");
      // Undeclared exception!
      try { 
        jFormatter0.writeClassFull(jDefinedClass0);
        fail("Expecting exception: NullPointerException");
