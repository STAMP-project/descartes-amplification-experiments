...
public class JFormatter_ESTest extends JFormatter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      SourcePrintWriter sourcePrintWriter0 = new SourcePrintWriter(stringWriter0, "; isVarName=");
      JFormatter jFormatter0 = new JFormatter(sourcePrintWriter0, "; isVarName=");
      ...
      doReturn("; isVarName=").when(jDefinedClass0).toString();
      doReturn("; isVarName=").when(jDefinedClass0).name();
