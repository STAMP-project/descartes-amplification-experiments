...
public class JFormatter_ESTest extends JFormatter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      SourcePrintWriter sourcePrintWriter0 = new SourcePrintWriter(stringWriter0, "<&$-`8IG{");
      ...
      doReturn("+:y").when(jDefinedClass0).name();
  ...
  public void test1()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      SourcePrintWriter sourcePrintWriter0 = new SourcePrintWriter(stringWriter0, "2f@j");
      JFormatter jFormatter0 = new JFormatter(sourcePrintWriter0, "2f@j");
      ...
      JDefinedClass jDefinedClass0 = mock(JDefinedClass.class, new ViolatedAssumptionAnswer());
      doReturn(jCodeModel0).when(jDefinedClass0).owner();
      doReturn("2f@j").when(jDefinedClass0).toString();
      doReturn("2f@j").when(jDefinedClass0).name();
  ...
  public void test2()  throws Throwable  {
      ...
      JDefinedClass jDefinedClass0 = mock(JDefinedClass.class, new ViolatedAssumptionAnswer());
      doReturn(jCodeModel0).when(jDefinedClass0).owner();
      doReturn("2%y").when(jDefinedClass0).toString();
      doReturn("2%y").when(jDefinedClass0).name();
      doReturn(iJClassContainer0).when(jDefinedClass0).parentContainer();
      doReturn(true).when(jDefinedClass0).hasHeaderComment();
      doReturn((JDocComment) null).when(jDefinedClass0).headerComment();
      StringWriter stringWriter0 = new StringWriter();
      SourcePrintWriter sourcePrintWriter0 = new SourcePrintWriter(stringWriter0, "2%y");
      JFormatter jFormatter0 = new JFormatter(sourcePrintWriter0, "2%y");
      // Undeclared exception!
      try { 
        jFormatter0.writeClassFull(jDefinedClass0);
        fail("Expecting exception: NullPointerException");
