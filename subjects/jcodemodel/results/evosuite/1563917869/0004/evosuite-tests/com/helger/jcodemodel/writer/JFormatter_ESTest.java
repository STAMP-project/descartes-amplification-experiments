...
public class JFormatter_ESTest extends JFormatter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      SourcePrintWriter sourcePrintWriter0 = new SourcePrintWriter(stringWriter0, "qq");
      JFormatter jFormatter0 = new JFormatter(sourcePrintWriter0, "x!=YvB<F`O?z}8q^l*");
      ...
      doReturn("qq").when(jDefinedClass1).toString();
      doReturn("x!=YvB<F`O?z}8q^l*").when(jDefinedClass1).name();
  ...
  public void test1()  throws Throwable  {
      ...
      doReturn("qq").when(jDefinedClass0).toString();
      doReturn("qq").when(jDefinedClass0).name();
      doReturn(iJClassContainer0).when(jDefinedClass0).parentContainer();
      SourcePrintWriter sourcePrintWriter0 = new SourcePrintWriter(stringWriter0, "qq");
      JFormatter jFormatter0 = new JFormatter(sourcePrintWriter0, "qq");
      // Undeclared exception!
      try { 
  ...
  public void test2()  throws Throwable  {
      ...
      JDefinedClass jDefinedClass0 = mock(JDefinedClass.class, new ViolatedAssumptionAnswer());
      doReturn(jCodeModel0).when(jDefinedClass0).owner();
      doReturn("xqF").when(jDefinedClass0).toString();
      doReturn("xqF").when(jDefinedClass0).name();
      doReturn(iJClassContainer0).when(jDefinedClass0).parentContainer();
      doReturn(true).when(jDefinedClass0).hasHeaderComment();
      doReturn((JDocComment) null).when(jDefinedClass0).headerComment();
      StringWriter stringWriter0 = new StringWriter();
      SourcePrintWriter sourcePrintWriter0 = new SourcePrintWriter(stringWriter0, "xqF");
      JFormatter jFormatter0 = new JFormatter(sourcePrintWriter0, "xqF");
      // Undeclared exception!
      try { 
        jFormatter0.writeClassFull(jDefinedClass0);
        fail("Expecting exception: NullPointerException");
