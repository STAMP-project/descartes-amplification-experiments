...
public class JFormatter_ESTest extends JFormatter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn("7.QF,Y<;[").when(jDefinedClass1).toString();
      doReturn((String) null).when(jDefinedClass1).name();
      doReturn(jDefinedClass0, (IJClassContainer) null).when(jDefinedClass1).parentContainer();
      doReturn(false).when(jDefinedClass1).hasHeaderComment();
      SourcePrintWriter sourcePrintWriter0 = new SourcePrintWriter(stringWriter0, "XM>~DsFRWJ@e2;O");
      JFormatter jFormatter0 = new JFormatter(sourcePrintWriter0, "so`F;v?v`C>1NPO");
  ...
  public void test1()  throws Throwable  {
      ...
      JDefinedClass jDefinedClass1 = mock(JDefinedClass.class, new ViolatedAssumptionAnswer());
      doReturn(jCodeModel0).when(jDefinedClass1).owner();
      doReturn("7x.QF,Y<;[").when(jDefinedClass1).toString();
      doReturn((String) null).when(jDefinedClass1).name();
      ...
      SourcePrintWriter sourcePrintWriter0 = new SourcePrintWriter(stringWriter0, "7x.QF,Y<;[");
      JFormatter jFormatter0 = new JFormatter(sourcePrintWriter0, "7x.QF,Y<;[");
      // Undeclared exception!
      try { 
        jFormatter0.writeClassFull(jDefinedClass1);
        fail("Expecting exception: NullPointerException");
