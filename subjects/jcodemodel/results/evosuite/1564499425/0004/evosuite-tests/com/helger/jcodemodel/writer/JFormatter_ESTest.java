...
public class JFormatter_ESTest extends JFormatter_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      doReturn("Added import class '").when(jDefinedClass0).name();
      ...
      SourcePrintWriter sourcePrintWriter0 = new SourcePrintWriter(stringWriter0, "w|*>$>v");
      JFormatter jFormatter0 = new JFormatter(sourcePrintWriter0, "Added import class '");
      // Undeclared exception!
      try { 
