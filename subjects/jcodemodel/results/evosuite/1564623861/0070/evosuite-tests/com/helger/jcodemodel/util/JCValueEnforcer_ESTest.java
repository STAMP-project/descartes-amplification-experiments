...
public class JCValueEnforcer_ESTest extends JCValueEnforcer_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      Supplier<String> supplier0 = (Supplier<String>) mock(Supplier.class, new ViolatedAssumptionAnswer());
      HashSet<SQLInvalidAuthorizationSpecException> hashSet0 = JCValueEnforcer.notNull((HashSet<SQLInvalidAuthorizationSpecException>) linkedHashSet0, (Supplier<? extends String>) supplier0);
