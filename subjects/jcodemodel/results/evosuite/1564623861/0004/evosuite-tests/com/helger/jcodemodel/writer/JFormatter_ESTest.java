...
public class JFormatter_ESTest extends JFormatter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      SourcePrintWriter sourcePrintWriter0 = new SourcePrintWriter(stringWriter0, "K\"w#>;i~iuG");
      JFormatter jFormatter0 = new JFormatter(sourcePrintWriter0, "' is already in the import list.");
      ...
      doReturn("' is already in the import list.").when(jDefinedClass0).toString();
      doReturn("' is already in the import list.").when(jDefinedClass0).name();
  ...
  public void test1()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      SourcePrintWriter sourcePrintWriter0 = new SourcePrintWriter(stringWriter0, "F6_j_");
      JFormatter jFormatter0 = new JFormatter(sourcePrintWriter0, "F6_j_");
      JCodeModel jCodeModel0 = new JCodeModel();
      IJClassContainer<JDirectClass> iJClassContainer0 = (IJClassContainer<JDirectClass>) mock(IJClassContainer.class, new ViolatedAssumptionAnswer());
      JDefinedClass jDefinedClass0 = mock(JDefinedClass.class, new ViolatedAssumptionAnswer());
      doReturn(jCodeModel0).when(jDefinedClass0).owner();
      doReturn("F6_j_").when(jDefinedClass0).toString();
      doReturn("F6_j_").when(jDefinedClass0).name();
  ...
  public void test2()  throws Throwable  {
      ...
      JDefinedClass jDefinedClass0 = mock(JDefinedClass.class, new ViolatedAssumptionAnswer());
      doReturn(jCodeModel0).when(jDefinedClass0).owner();
      doReturn("+e3cx0O~N\"]1>M").when(jDefinedClass0).toString();
      ...
      SourcePrintWriter sourcePrintWriter0 = new SourcePrintWriter(stringWriter0, "+e3cx0O~N\"]1>M");
      JFormatter jFormatter0 = new JFormatter(sourcePrintWriter0, "+e3cx0O~N\"]1>M");
      // Undeclared exception!
      try { 
        jFormatter0.writeClassFull(jDefinedClass0);
