...
public class JFormatter_ESTest extends JFormatter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      SourcePrintWriter sourcePrintWriter0 = new SourcePrintWriter(stringWriter0, "Added import>class '");
      JFormatter jFormatter0 = new JFormatter(sourcePrintWriter0, "/#Gf2D\"]Z.>2E`xs");
      ...
      doReturn("Added import>class '").when(jDefinedClass0).toString();
  ...
  public void test1()  throws Throwable  {
      ...
      JDefinedClass jDefinedClass0 = mock(JDefinedClass.class, new ViolatedAssumptionAnswer());
      doReturn(jCodeModel0).when(jDefinedClass0).owner();
      doReturn("sn2NS").when(jDefinedClass0).toString();
      doReturn("sn2NS").when(jDefinedClass0).name();
      ...
      SourcePrintWriter sourcePrintWriter0 = new SourcePrintWriter(stringWriter0, "sn2NS");
      JFormatter jFormatter0 = new JFormatter(sourcePrintWriter0, "sn2NS");
      // Undeclared exception!
      try { 
        jFormatter0.writeClassFull(jDefinedClass0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test2()  throws Throwable  {
      ...
      JDefinedClass jDefinedClass0 = mock(JDefinedClass.class, new ViolatedAssumptionAnswer());
      doReturn(jCodeModel0).when(jDefinedClass0).owner();
      doReturn("Failed to remove field with name '").when(jDefinedClass0).toString();
      doReturn("Failed to remove field with name '").when(jDefinedClass0).name();
      doReturn(iJClassContainer0).when(jDefinedClass0).parentContainer();
      StringWriter stringWriter0 = new StringWriter();
      SourcePrintWriter sourcePrintWriter0 = new SourcePrintWriter(stringWriter0, "Failed to remove field with name '");
      JFormatter jFormatter0 = new JFormatter(sourcePrintWriter0, "Failed to remove field with name '");
      // Undeclared exception!
      try { 
        jFormatter0.writeClassFull(jDefinedClass0);
