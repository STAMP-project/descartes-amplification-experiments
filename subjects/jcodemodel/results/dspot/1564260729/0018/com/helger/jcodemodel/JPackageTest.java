...
public final class JPackageTest {
    ...
    @Test(timeout = 10000)
    public void testGetParent_mg33_mg10795() throws Exception {
        ...
        AbstractJClass o_testGetParent_mg33_mg10795__22 = o_testGetParent_mg33__17.narrowAny();
        Assert.assertFalse(((JNarrowedClass) (o_testGetParent_mg33_mg10795__22)).isInterface());
        Assert.assertFalse(((JNarrowedClass) (o_testGetParent_mg33_mg10795__22)).isArray());
        Assert.assertFalse(((Collection) (((JNarrowedClass) (o_testGetParent_mg33_mg10795__22)).getTypeParameters())).isEmpty());
        Assert.assertFalse(((JNarrowedClass) (o_testGetParent_mg33_mg10795__22)).isAbstract());
        Assert.assertFalse(((JNarrowedClass) (o_testGetParent_mg33_mg10795__22)).isError());
        Assert.assertEquals("com.helger.jcodemodel.JNarrowedClass(com.helger.jcodemodel.JExpr<? extends java.lang.Object>)", ((JNarrowedClass) (o_testGetParent_mg33_mg10795__22)).toString());
        Assert.assertTrue(((Collection) (((JNarrowedClass) (o_testGetParent_mg33_mg10795__22)).getAllInnerClasses())).isEmpty());
        Assert.assertTrue(((JNarrowedClass) (o_testGetParent_mg33_mg10795__22)).isParameterized());
        Assert.assertNull(((JNarrowedClass) (o_testGetParent_mg33_mg10795__22)).getPrimitiveType());
        Assert.assertFalse(((JNarrowedClass) (o_testGetParent_mg33_mg10795__22)).isPrimitive());
        Assert.assertTrue(((JNarrowedClass) (o_testGetParent_mg33_mg10795__22)).isReference());
        Assert.assertNull(((JCodeModel) (wModel)).getBuildingCharset());
        Assert.assertTrue(((Collection) (((JCodeModel) (wModel)).getAllDontImportClasses())).isEmpty());
        Assert.assertEquals("\n", ((JCodeModel) (wModel)).getBuildingNewLine());
        Assert.assertFalse(((Collection) (((JCodeModel) (wModel)).getAllPackages())).isEmpty());
    ...
    @Test(timeout = 10000)
    public void testGetParent_mg45_mg7855() throws Exception {
        final JCodeModel wModel = new JCodeModel();
        Assert.assertNull(((JCodeModel) (wModel)).getBuildingCharset());
        Assert.assertTrue(((Collection) (((JCodeModel) (wModel)).getAllDontImportClasses())).isEmpty());
        Assert.assertEquals("\n", ((JCodeModel) (wModel)).getBuildingNewLine());
        ...
        String o_testGetParent_mg45_mg7855__21 = o_testGetParent_mg45__16.name();
        Assert.assertEquals("? super JExpr", o_testGetParent_mg45_mg7855__21);
        Assert.assertNull(((JCodeModel) (wModel)).getBuildingCharset());
        Assert.assertTrue(((Collection) (((JCodeModel) (wModel)).getAllDontImportClasses())).isEmpty());
        Assert.assertEquals("\n", ((JCodeModel) (wModel)).getBuildingNewLine());
        Assert.assertFalse(((Collection) (((JCodeModel) (wModel)).getAllPackages())).isEmpty());
