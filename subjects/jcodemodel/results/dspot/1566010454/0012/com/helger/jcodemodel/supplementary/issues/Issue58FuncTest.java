...
public final class Issue58FuncTest {
    ...
    @Test(timeout = 10000)
    public void testIssue_mg60() throws Exception {
        String __DSPOT_sFullyQualifiedClassName_18 = "K`HNw]f4QDhB+ _ 2&pb";
        final JCodeModel generator = new JCodeModel();
        final JDefinedClass aClass = generator._class("test.Test");
        final JMethod aMethod = aClass.method(0, generator.VOID, "name");
        Assert.assertTrue(((JMethod) (aMethod)).getThrows().isEmpty());
        Assert.assertFalse(((JMethod) (aMethod)).hasVarArgs());
        Assert.assertFalse(((JMethod) (aMethod)).isConstructor());
        JVar o_testIssue_mg60__8 = aMethod.param(generator.ref("test.UnknownClass"), "p");
        Assert.assertEquals(-1828404188, ((int) (((JVar) (o_testIssue_mg60__8)).hashCode())));
        JMethod o_testIssue_mg60__10 = aClass.getMethod("name", new AbstractJType[]{ generator.ref("test.UnknownClass") });
        Assert.assertTrue(((JMethod) (o_testIssue_mg60__10)).getThrows().isEmpty());
        Assert.assertFalse(((JMethod) (o_testIssue_mg60__10)).hasVarArgs());
        Assert.assertFalse(((JMethod) (o_testIssue_mg60__10)).isConstructor());
        AbstractJClass o_testIssue_mg60__12 = generator.ref(__DSPOT_sFullyQualifiedClassName_18);
        Assert.assertEquals(-174413084, ((int) (((JDirectClass) (o_testIssue_mg60__12)).hashCode())));
        Assert.assertFalse(((JDirectClass) (o_testIssue_mg60__12)).isAbstract());
        Assert.assertNull(((JDirectClass) (o_testIssue_mg60__12)).getOuter());
        Assert.assertFalse(((JDirectClass) (o_testIssue_mg60__12)).isAnnotationTypeDeclaration());
        Assert.assertFalse(((JDirectClass) (o_testIssue_mg60__12)).isAnonymous());
        Assert.assertTrue(((JDirectClass) (o_testIssue_mg60__12)).isClass());
        Assert.assertFalse(((JDirectClass) (o_testIssue_mg60__12)).isInterface());
        Assert.assertFalse(((JDirectClass) (o_testIssue_mg60__12)).isPackage());
        Assert.assertNull(((JDirectClass) (o_testIssue_mg60__12)).getPrimitiveType());
        Assert.assertTrue(((Collection) (((JDirectClass) (o_testIssue_mg60__12)).getAllInnerClasses())).isEmpty());
        Assert.assertFalse(((JDirectClass) (o_testIssue_mg60__12)).isParameterized());
        Assert.assertEquals("com.helger.jcodemodel.JDirectClass(K`HNw]f4QDhB+ _ 2&pb)", ((JDirectClass) (o_testIssue_mg60__12)).toString());
        Assert.assertTrue(((Collection) (((JDirectClass) (o_testIssue_mg60__12)).getTypeParameters())).isEmpty());
        Assert.assertTrue(((JDirectClass) (o_testIssue_mg60__12)).isReference());
        Assert.assertFalse(((JDirectClass) (o_testIssue_mg60__12)).isArray());
        Assert.assertFalse(((JDirectClass) (o_testIssue_mg60__12)).isPrimitive());
        Assert.assertFalse(((JDirectClass) (o_testIssue_mg60__12)).isError());
        Assert.assertTrue(((JMethod) (aMethod)).getThrows().isEmpty());
        Assert.assertFalse(((JMethod) (aMethod)).hasVarArgs());
        Assert.assertFalse(((JMethod) (aMethod)).isConstructor());
        Assert.assertEquals(-1828404188, ((int) (((JVar) (o_testIssue_mg60__8)).hashCode())));
    ...
    @Test(timeout = 10000)
    public void testIssue_literalMutationString40() throws Exception {
        final JCodeModel generator = new JCodeModel();
        final JDefinedClass aClass = generator._class("test.Test");
        final JMethod aMethod = aClass.method(0, generator.VOID, "name");
        Assert.assertTrue(((JMethod) (aMethod)).getThrows().isEmpty());
        Assert.assertFalse(((JMethod) (aMethod)).hasVarArgs());
        Assert.assertFalse(((JMethod) (aMethod)).isConstructor());
        JVar o_testIssue_literalMutationString40__7 = aMethod.param(generator.ref("test.UnknownClass"), "p");
        Assert.assertEquals(-1828404188, ((int) (((JVar) (o_testIssue_literalMutationString40__7)).hashCode())));
        JMethod o_testIssue_literalMutationString40__9 = aClass.getMethod("name", new AbstractJType[]{ generator.ref("xx") });
        Assert.assertNull(o_testIssue_literalMutationString40__9);
        Assert.assertTrue(((JMethod) (aMethod)).getThrows().isEmpty());
        Assert.assertFalse(((JMethod) (aMethod)).hasVarArgs());
        Assert.assertFalse(((JMethod) (aMethod)).isConstructor());
        Assert.assertEquals(-1828404188, ((int) (((JVar) (o_testIssue_literalMutationString40__7)).hashCode())));
