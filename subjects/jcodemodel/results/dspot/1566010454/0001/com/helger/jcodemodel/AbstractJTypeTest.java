...
public final class AbstractJTypeTest {
    ...
    @Test(timeout = 10000)
    public void testIsAssignableFromRandomized_mg93() throws Exception {
        ...
        AbstractJClass o_testIsAssignableFromRandomized_mg93__71 = _Object.narrow(__DSPOT_aClazzes_24);
        Assert.assertFalse(((JNarrowedClass) (o_testIsAssignableFromRandomized_mg93__71)).isInterface());
        Assert.assertFalse(((JNarrowedClass) (o_testIsAssignableFromRandomized_mg93__71)).isArray());
        Assert.assertTrue(((Collection) (((JNarrowedClass) (o_testIsAssignableFromRandomized_mg93__71)).getTypeParameters())).isEmpty());
        Assert.assertFalse(((JNarrowedClass) (o_testIsAssignableFromRandomized_mg93__71)).isAbstract());
        Assert.assertFalse(((JNarrowedClass) (o_testIsAssignableFromRandomized_mg93__71)).isError());
        Assert.assertNull(((JNarrowedClass) (o_testIsAssignableFromRandomized_mg93__71)).getPrimitiveType());
        Assert.assertTrue(((Collection) (((JNarrowedClass) (o_testIsAssignableFromRandomized_mg93__71)).getAllInnerClasses())).isEmpty());
        Assert.assertTrue(((JNarrowedClass) (o_testIsAssignableFromRandomized_mg93__71)).isParameterized());
        Assert.assertEquals("com.helger.jcodemodel.JNarrowedClass(java.lang.Object<>)", ((JNarrowedClass) (o_testIsAssignableFromRandomized_mg93__71)).toString());
        Assert.assertTrue(((JNarrowedClass) (o_testIsAssignableFromRandomized_mg93__71)).isReference());
        Assert.assertFalse(((JNarrowedClass) (o_testIsAssignableFromRandomized_mg93__71)).isPrimitive());
        Assert.assertTrue(((Collection) (((JCodeModel) (codeModel)).getAllPackages())).isEmpty());
        Assert.assertNull(((JCodeModel) (codeModel)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (codeModel)).getBuildingNewLine());
        Assert.assertTrue(((Collection) (((JCodeModel) (codeModel)).getAllDontImportClasses())).isEmpty());
    ...
    @Test(timeout = 10000)
    public void testIsAssignableFromRandomized_mg125() throws Exception {
        final JCodeModel codeModel = new JCodeModel();
        Assert.assertTrue(((Collection) (((JCodeModel) (codeModel)).getAllPackages())).isEmpty());
        Assert.assertNull(((JCodeModel) (codeModel)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (codeModel)).getBuildingNewLine());
        ...
        JTypeWildcard o_testIsAssignableFromRandomized_mg125__70 = _Integer.wildcardExtends();
        Assert.assertFalse(((JTypeWildcard) (o_testIsAssignableFromRandomized_mg125__70)).isInterface());
        Assert.assertFalse(((JTypeWildcard) (o_testIsAssignableFromRandomized_mg125__70)).isAbstract());
        Assert.assertFalse(((JTypeWildcard) (o_testIsAssignableFromRandomized_mg125__70)).isError());
        Assert.assertNull(((JTypeWildcard) (o_testIsAssignableFromRandomized_mg125__70)).getPrimitiveType());
        Assert.assertTrue(((Collection) (((JTypeWildcard) (o_testIsAssignableFromRandomized_mg125__70)).getAllInnerClasses())).isEmpty());
        Assert.assertFalse(((JTypeWildcard) (o_testIsAssignableFromRandomized_mg125__70)).isParameterized());
        Assert.assertEquals("com.helger.jcodemodel.JTypeWildcard(? extends java.lang.Integer)", ((JTypeWildcard) (o_testIsAssignableFromRandomized_mg125__70)).toString());
        Assert.assertTrue(((Collection) (((JTypeWildcard) (o_testIsAssignableFromRandomized_mg125__70)).getTypeParameters())).isEmpty());
        Assert.assertTrue(((JTypeWildcard) (o_testIsAssignableFromRandomized_mg125__70)).isReference());
        Assert.assertFalse(((JTypeWildcard) (o_testIsAssignableFromRandomized_mg125__70)).isArray());
        Assert.assertFalse(((JTypeWildcard) (o_testIsAssignableFromRandomized_mg125__70)).isPrimitive());
        Assert.assertTrue(((Collection) (((JCodeModel) (codeModel)).getAllPackages())).isEmpty());
        Assert.assertNull(((JCodeModel) (codeModel)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (codeModel)).getBuildingNewLine());
        Assert.assertTrue(((Collection) (((JCodeModel) (codeModel)).getAllDontImportClasses())).isEmpty());
