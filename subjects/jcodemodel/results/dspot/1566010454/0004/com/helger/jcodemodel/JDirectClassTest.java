...
public final class JDirectClassTest {
    ...
    @Test(timeout = 10000)
    public void testBasic_rv277() throws Exception {
        final JCodeModel cm = new JCodeModel();
        ...
        Assert.assertFalse(o_testBasic_rv277__41);
    ...
    @Test(timeout = 10000)
    public void testBasic_rv251_mg13794_failAssert0() throws Exception {
        try {
            int __DSPOT_index_2530 = 1360747322;
            final JCodeModel cm = new JCodeModel();
            final JDirectClass rClassId = cm.directClass("id.aa.R")._class("id");
            ...
            __DSPOT_invoc_33.remove(__DSPOT_index_2530);
            org.junit.Assert.fail("testBasic_rv251_mg13794 should have thrown IndexOutOfBoundsException");
        } catch (IndexOutOfBoundsException expected) {
            Assert.assertEquals("Index: 1360747322, Size: 2", expected.getMessage());
        }
    }

    @Test(timeout = 10000)
    public void testBasic_mg209_failAssert0_rv10439_failAssert0() throws Exception {
        try {
            {
                boolean __DSPOT_bIndentRequired_2117 = true;
                boolean __DSPOT_bBracesRequired_2116 = false;
                int __DSPOT_nIndex_47 = -1775795945;
                final JCodeModel cm = new JCodeModel();
                final JDirectClass rClassId = cm.directClass("id.aa.R")._class("id");
                rClassId.name();
                ...
                final JDefinedClass aClassAct = aPkg2._class("HelloAndroidActivity_");
                final JMethod aMethodCreate = aClassAct.method(JMod.PUBLIC, cm.BOOLEAN, "onCreateOptionsMenu");
                JBlock __DSPOT_invoc_30 = aMethodCreate.body().add(JExpr.ref("menuInflater").invoke("inflate").arg(myMenu));
                final JMethod aMethodSelected = aClassAct.method(JMod.PUBLIC, cm.BOOLEAN, "onOptionsItemSelected");
                aMethodSelected.body()._if(JExpr.ref("itemId_").eq(myItem));
                CodeModelTestsHelper.parseCodeModel(cm);
                aMethodCreate.paramAtIndex(__DSPOT_nIndex_47);
                org.junit.Assert.fail("testBasic_mg209 should have thrown ArrayIndexOutOfBoundsException");
                __DSPOT_invoc_30.block(__DSPOT_bBracesRequired_2116, __DSPOT_bIndentRequired_2117);
            }
            org.junit.Assert.fail("testBasic_mg209_failAssert0_rv10439 should have thrown ArrayIndexOutOfBoundsException");
        } catch (ArrayIndexOutOfBoundsException expected) {
            Assert.assertEquals("-1775795945", expected.getMessage());
        }
    }
    ...
    @Test(timeout = 10000)
    public void testBasic_rv277_mg12694() throws Exception {
        final JCodeModel cm = new JCodeModel();
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllPackages())).isEmpty());
        ...
        CodeModelTestsHelper.parseCodeModel(cm);
        boolean o_testBasic_rv277__41 = __DSPOT_invoc_33.virtual();
        JPackage o_testBasic_rv277_mg12694__56 = aPkg2.parent();
        Assert.assertTrue(((Collection) (((JPackage) (o_testBasic_rv277_mg12694__56)).getAllResourceFiles())).isEmpty());
        Assert.assertFalse(((JPackage) (o_testBasic_rv277_mg12694__56)).isUnnamed());
        Assert.assertFalse(((JPackage) (o_testBasic_rv277_mg12694__56)).isClass());
        Assert.assertTrue(((Collection) (((JPackage) (((JPackage) (o_testBasic_rv277_mg12694__56)).getPackage())).getAllResourceFiles())).isEmpty());
        Assert.assertFalse(((JPackage) (((JPackage) (o_testBasic_rv277_mg12694__56)).getPackage())).isUnnamed());
        Assert.assertFalse(((JPackage) (((JPackage) (o_testBasic_rv277_mg12694__56)).getPackage())).isClass());
        Assert.assertTrue(((Collection) (((JPackage) (((JPackage) (((JPackage) (o_testBasic_rv277_mg12694__56)).getPackage())).getPackage())).getAllResourceFiles())).isEmpty());
        Assert.assertFalse(((JPackage) (((JPackage) (((JPackage) (o_testBasic_rv277_mg12694__56)).getPackage())).getPackage())).isUnnamed());
        Assert.assertFalse(((JPackage) (((JPackage) (((JPackage) (o_testBasic_rv277_mg12694__56)).getPackage())).getPackage())).isClass());
        Assert.assertTrue(((JPackage) (((JPackage) (((JPackage) (o_testBasic_rv277_mg12694__56)).getPackage())).getPackage())).isPackage());
        Assert.assertTrue(((JPackage) (((JPackage) (o_testBasic_rv277_mg12694__56)).getPackage())).isPackage());
        Assert.assertTrue(((JPackage) (o_testBasic_rv277_mg12694__56)).isPackage());
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        Assert.assertFalse(((Collection) (((JCodeModel) (cm)).getAllPackages())).isEmpty());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllDontImportClasses())).isEmpty());
    ...
    @Test(timeout = 10000)
    public void testBasic_rv277_mg12966_failAssert0() throws Exception {
        try {
            int __DSPOT_index_2441 = -1117732511;
            final JCodeModel cm = new JCodeModel();
            final JDirectClass rClassId = cm.directClass("id.aa.R")._class("id");
            String o_testBasic_rv277__6 = rClassId.name();
            String o_testBasic_rv277__7 = rClassId._package().name();
            ...
            CodeModelTestsHelper.parseCodeModel(cm);
            boolean o_testBasic_rv277__41 = __DSPOT_invoc_33.virtual();
            __DSPOT_invoc_33.remove(__DSPOT_index_2441);
            org.junit.Assert.fail("testBasic_rv277_mg12966 should have thrown ArrayIndexOutOfBoundsException");
        } catch (ArrayIndexOutOfBoundsException expected) {
            Assert.assertEquals("-1117732511", expected.getMessage());
        }
    }

    @Test(timeout = 10000)
    public void testBasic_rv251_mg13656() throws Exception {
        final JCodeModel cm = new JCodeModel();
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllPackages())).isEmpty());
        ...
        CodeModelTestsHelper.parseCodeModel(cm);
        __DSPOT_invoc_33._return();
        Collection<JAnnotationUse> o_testBasic_rv251_mg13656__54 = aMethodCreate.annotations();
        Assert.assertTrue(o_testBasic_rv251_mg13656__54.isEmpty());
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        Assert.assertFalse(((Collection) (((JCodeModel) (cm)).getAllPackages())).isEmpty());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllDontImportClasses())).isEmpty());
    ...
    @Test(timeout = 10000)
    public void testBasic_rv277_mg12964_failAssert0() throws Exception {
        try {
            int __DSPOT_nNewPos_2440 = -11203868;
            final JCodeModel cm = new JCodeModel();
            final JDirectClass rClassId = cm.directClass("id.aa.R")._class("id");
            String o_testBasic_rv277__6 = rClassId.name();
            String o_testBasic_rv277__7 = rClassId._package().name();
            ...
            CodeModelTestsHelper.parseCodeModel(cm);
            boolean o_testBasic_rv277__41 = __DSPOT_invoc_33.virtual();
            __DSPOT_invoc_33.pos(__DSPOT_nNewPos_2440);
            org.junit.Assert.fail("testBasic_rv277_mg12964 should have thrown IllegalArgumentException");
        } catch (IllegalArgumentException expected) {
            Assert.assertEquals("The expression must be true but it is not: Illegal position provided: -11203868", expected.getMessage());
        }
    }

    @Test(timeout = 10000)
    public void testBasic_rv268_mg7624() throws Exception {
        String __DSPOT_sName_1517 = "3-o#d&Vi6?]AJv^%M+B)";
        String __DSPOT_sMethod_60 = "%1I,&C;G<+|h=gdwL%G{";
        final JCodeModel cm = new JCodeModel();
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllPackages())).isEmpty());
        ...
        Assert.assertFalse(((JDirectClass) (rClassId)).isPrimitive());
        Assert.assertFalse(((JDirectClass) (rClassId)).isError());
        String o_testBasic_rv268__7 = rClassId.name();
        Assert.assertEquals("id", o_testBasic_rv268__7);
        String o_testBasic_rv268__8 = rClassId._package().name();
        Assert.assertEquals("id.aa", o_testBasic_rv268__8);
        String o_testBasic_rv268__10 = rClassId.fullName();
        Assert.assertEquals("id.aa.R.id", o_testBasic_rv268__10);
        final JDirectClass rClassMenu = cm.directClass("id.aa.R")._class("menu");
        Assert.assertEquals(87469099, ((int) (((JDirectClass) (rClassMenu)).hashCode())));
        Assert.assertFalse(((JDirectClass) (rClassMenu)).isAbstract());
        Assert.assertFalse(((JDirectClass) (rClassMenu)).isAnonymous());
        ...
        Assert.assertFalse(((JDirectClass) (rClassMenu)).isPrimitive());
        Assert.assertFalse(((JDirectClass) (rClassMenu)).isError());
        String o_testBasic_rv268__14 = rClassMenu.name();
        Assert.assertEquals("menu", o_testBasic_rv268__14);
        String o_testBasic_rv268__15 = rClassMenu._package().name();
        Assert.assertEquals("id.aa", o_testBasic_rv268__15);
        String o_testBasic_rv268__17 = rClassMenu.fullName();
        Assert.assertEquals("id.aa.R.menu", o_testBasic_rv268__17);
        final JFieldRef myItem = rClassId.staticRef("myItem");
        Assert.assertEquals(512961099, ((int) (((JFieldRef) (myItem)).hashCode())));
        final JFieldRef myMenu = rClassMenu.staticRef("myMenu");
        Assert.assertEquals(-564731709, ((int) (((JFieldRef) (myMenu)).hashCode())));
        ...
        aMethodSelected.body()._if(JExpr.ref("itemId_").eq(myItem));
        CodeModelTestsHelper.parseCodeModel(cm);
        __DSPOT_invoc_33.invokeThis(__DSPOT_sMethod_60);
        boolean o_testBasic_rv268_mg7624__56 = aPkg2.hasResourceFile(__DSPOT_sName_1517);
        Assert.assertFalse(o_testBasic_rv268_mg7624__56);
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        Assert.assertFalse(((Collection) (((JCodeModel) (cm)).getAllPackages())).isEmpty());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllDontImportClasses())).isEmpty());
    ...
    @Test(timeout = 10000)
    public void testBasic_rv277_mg14420() throws Exception {
        String __DSPOT_sName_2624 = "N#B2f@P{(}2((`;Ot`.U";
        final JCodeModel cm = new JCodeModel();
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllPackages())).isEmpty());
        ...
        CodeModelTestsHelper.parseCodeModel(cm);
        boolean o_testBasic_rv277__41 = __DSPOT_invoc_33.virtual();
        JEnumConstant o_testBasic_rv277_mg14420__57 = aClassAct.enumConstant(__DSPOT_sName_2624);
        Assert.assertFalse(((JEnumConstant) (o_testBasic_rv277_mg14420__57)).hasArgs());
        Assert.assertEquals(1206987162, ((int) (((JEnumConstant) (o_testBasic_rv277_mg14420__57)).hashCode())));
        Assert.assertEquals("id.aa.HelloAndroidActivity_.N#B2f@P{(}2((`;Ot`.U", ((JEnumConstant) (o_testBasic_rv277_mg14420__57)).getName());
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        Assert.assertFalse(((Collection) (((JCodeModel) (cm)).getAllPackages())).isEmpty());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllDontImportClasses())).isEmpty());
