...
public final class NestedClassFuncTest {
    ...
    @Test(timeout = 10000)
    public void testBasic_rv71() throws Exception {
        final JCodeModel cm = new JCodeModel();
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllPackages())).isEmpty());
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        ...
        JDefinedClass __DSPOT_invoc_6 = c._extends(cm.ref(NestedClassFuncTest.MockInnerClass.class));
        CodeModelTestsHelper.parseCodeModel(cm);
        AbstractJClass o_testBasic_rv71__11 = __DSPOT_invoc_6._extends();
        Assert.assertFalse(((JReferencedClass) (o_testBasic_rv71__11)).isParameterized());
        Assert.assertTrue(((Collection) (((JReferencedClass) (o_testBasic_rv71__11)).getAllInnerClasses())).isEmpty());
        Assert.assertEquals("com.helger.jcodemodel.JReferencedClass(com.helger.jcodemodel.NestedClassFuncTest.MockInnerClass)", ((JReferencedClass) (o_testBasic_rv71__11)).toString());
        Assert.assertTrue(((Collection) (((JReferencedClass) (o_testBasic_rv71__11)).getTypeParameters())).isEmpty());
        Assert.assertTrue(((JReferencedClass) (o_testBasic_rv71__11)).isReference());
        Assert.assertFalse(((JReferencedClass) (o_testBasic_rv71__11)).isArray());
        Assert.assertFalse(((JReferencedClass) (o_testBasic_rv71__11)).isPrimitive());
        Assert.assertFalse(((JReferencedClass) (o_testBasic_rv71__11)).isError());
        Assert.assertFalse(((Collection) (((JCodeModel) (cm)).getAllPackages())).isEmpty());
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllDontImportClasses())).isEmpty());
