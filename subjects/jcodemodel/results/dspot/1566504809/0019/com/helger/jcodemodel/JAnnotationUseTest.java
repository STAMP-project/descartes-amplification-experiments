...
public final class JAnnotationUseTest {
    ...
    @Test(timeout = 10000)
    public void testPackageAnnotation_rv55() throws Exception {
        String __DSPOT_sValue_44 = "|_k>]VY+z,lI:lZE.`#n";
        String __DSPOT_sName_43 = "z&T&5+;N4Sb)kE+#PmjF";
        final JCodeModel cm = new JCodeModel();
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllPackages())).isEmpty());
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        ...
        JAnnotationUse __DSPOT_invoc_3 = cm._package("foo").annotate(Inherited.class);
        CodeModelTestsHelper.parseCodeModel(cm);
        JAnnotationUse o_testPackageAnnotation_rv55__10 = __DSPOT_invoc_3.param(__DSPOT_sName_43, __DSPOT_sValue_44);
        Assert.assertNull(((AbstractJClass) (((JAnnotationUse) (o_testPackageAnnotation_rv55__10)).getAnnotationClass())).getPrimitiveType());
        Assert.assertTrue(((AbstractJClass) (((JAnnotationUse) (o_testPackageAnnotation_rv55__10)).getAnnotationClass())).getAllInnerClasses().isEmpty());
        Assert.assertFalse(((AbstractJClass) (((JAnnotationUse) (o_testPackageAnnotation_rv55__10)).getAnnotationClass())).isParameterized());
        Assert.assertEquals("com.helger.jcodemodel.JReferencedClass(java.lang.annotation.Inherited)", ((AbstractJClass) (((JAnnotationUse) (o_testPackageAnnotation_rv55__10)).getAnnotationClass())).toString());
        Assert.assertTrue(((AbstractJClass) (((JAnnotationUse) (o_testPackageAnnotation_rv55__10)).getAnnotationClass())).isInterface());
        Assert.assertTrue(((Collection) (((AbstractJClass) (((JAnnotationUse) (o_testPackageAnnotation_rv55__10)).getAnnotationClass())).getTypeParameters())).isEmpty());
        Assert.assertTrue(((AbstractJClass) (((JAnnotationUse) (o_testPackageAnnotation_rv55__10)).getAnnotationClass())).isAbstract());
        Assert.assertTrue(((AbstractJClass) (((JAnnotationUse) (o_testPackageAnnotation_rv55__10)).getAnnotationClass())).isReference());
        Assert.assertFalse(((AbstractJClass) (((JAnnotationUse) (o_testPackageAnnotation_rv55__10)).getAnnotationClass())).isArray());
        Assert.assertFalse(((AbstractJClass) (((JAnnotationUse) (o_testPackageAnnotation_rv55__10)).getAnnotationClass())).isPrimitive());
        Assert.assertFalse(((AbstractJClass) (((JAnnotationUse) (o_testPackageAnnotation_rv55__10)).getAnnotationClass())).isError());
        Assert.assertFalse(((JAnnotationUse) (o_testPackageAnnotation_rv55__10)).getAnnotationMembers().isEmpty());
        Assert.assertTrue(((JAnnotationUse) (o_testPackageAnnotation_rv55__10)).hasAnnotationMembers());
        Assert.assertFalse(((Collection) (((JCodeModel) (cm)).getAllPackages())).isEmpty());
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllDontImportClasses())).isEmpty());
    ...
    @Test(timeout = 10000)
    public void testPackageAnnotation_mg23_mg3750_failAssert0() throws Exception {
        try {
            String __DSPOT_sMessage_14 = "VTx>DODA!L#vK5WR{oE1";
            final JCodeModel cm = new JCodeModel();
            JAnnotationUse o_testPackageAnnotation_mg23__4 = cm._package("foo").annotate(Inherited.class);
            CodeModelTestsHelper.parseCodeModel(cm);
            JErrorClass o_testPackageAnnotation_mg23__7 = cm.errorClass(__DSPOT_sMessage_14);
            o_testPackageAnnotation_mg23__7._extends();
            org.junit.Assert.fail("testPackageAnnotation_mg23_mg3750 should have thrown JErrorClassUsedException");
    ...
    @Test(timeout = 10000)
    public void testPackageAnnotation_rv60_mg1382() throws Exception {
        JEnumConstant[] __DSPOT_aValues_913 = new JEnumConstant[]{  };
        String __DSPOT_sName_51 = "($16qvQ}E3:oK*M=;$a4";
        final JCodeModel cm = new JCodeModel();
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllDontImportClasses())).isEmpty());
        ...
        JAnnotationArrayMember o_testPackageAnnotation_rv60__9 = __DSPOT_invoc_3.paramArray(__DSPOT_sName_51);
        Assert.assertTrue(((JAnnotationArrayMember) (o_testPackageAnnotation_rv60__9)).getAllAnnotations().isEmpty());
        JAnnotationArrayMember o_testPackageAnnotation_rv60_mg1382__13 = o_testPackageAnnotation_rv60__9.params(__DSPOT_aValues_913);
        Assert.assertTrue(((JAnnotationArrayMember) (o_testPackageAnnotation_rv60_mg1382__13)).getAllAnnotations().isEmpty());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllDontImportClasses())).isEmpty());
        Assert.assertFalse(((Collection) (((JCodeModel) (cm)).getAllPackages())).isEmpty());
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
    ...
    @Test(timeout = 10000)
    public void testPackageAnnotation_rv72null7416_failAssert0() throws Exception {
        try {
            String[] __DSPOT_aValues_75 = new String[0];
            String __DSPOT_sName_74 = null;
            final JCodeModel cm = new JCodeModel();
            JAnnotationUse __DSPOT_invoc_3 = cm._package("foo").annotate(Inherited.class);
            CodeModelTestsHelper.parseCodeModel(cm);
            JAnnotationUse o_testPackageAnnotation_rv72__10 = __DSPOT_invoc_3.paramArray(__DSPOT_sName_74, __DSPOT_aValues_75);
            org.junit.Assert.fail("testPackageAnnotation_rv72null7416 should have thrown NullPointerException");
    ...
    @Test(timeout = 10000)
    public void testPackageAnnotation_rv60_mg1379() throws Exception {
        AbstractJType[] __DSPOT_aValues_910 = new AbstractJType[]{  };
        String __DSPOT_sName_51 = "($16qvQ}E3:oK*M=;$a4";
        final JCodeModel cm = new JCodeModel();
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllDontImportClasses())).isEmpty());
        ...
        JAnnotationArrayMember o_testPackageAnnotation_rv60__9 = __DSPOT_invoc_3.paramArray(__DSPOT_sName_51);
        Assert.assertTrue(((JAnnotationArrayMember) (o_testPackageAnnotation_rv60__9)).getAllAnnotations().isEmpty());
        JAnnotationArrayMember o_testPackageAnnotation_rv60_mg1379__13 = o_testPackageAnnotation_rv60__9.params(__DSPOT_aValues_910);
        Assert.assertTrue(((JAnnotationArrayMember) (o_testPackageAnnotation_rv60_mg1379__13)).getAllAnnotations().isEmpty());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllDontImportClasses())).isEmpty());
        Assert.assertFalse(((Collection) (((JCodeModel) (cm)).getAllPackages())).isEmpty());
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
