...
public final class JDefinedClassTest {
    ...
    @Test(timeout = 10000)
    public void generatesInstanceInit_literalMutationNumber53_failAssert0_mg2313_failAssert0() throws Exception {
        try {
            {
                IJFormatter __DSPOT_f_573 = null;
                final JCodeModel cm = new JCodeModel();
                final JDefinedClass c = cm._package("myPackage")._class(0, "MyClass");
                c.headerComment().add("Line 1\nLine 2\nLine 3");
                final JFieldVar myField = c.field(JMod.PRIVATE, String.class, "myField");
                ...
                final InitializerDeclaration initializerDeclaration = ((InitializerDeclaration) (classDeclaration.getMembers().get(1)));
                org.junit.Assert.fail("generatesInstanceInit_literalMutationNumber53 should have thrown ArrayIndexOutOfBoundsException");
                c.declare(__DSPOT_f_573);
            }
            org.junit.Assert.fail("generatesInstanceInit_literalMutationNumber53_failAssert0_mg2313 should have thrown ArrayIndexOutOfBoundsException");
        } catch (ArrayIndexOutOfBoundsException expected) {
            Assert.assertEquals("-1", expected.getMessage());
        }
    }
    ...
    @Test(timeout = 10000)
    public void generatesInstanceInit_rv142_failAssert0_add4097_failAssert0() throws Exception {
        try {
            {
                int __DSPOT_index_43 = -338994308;
                final JCodeModel cm = new JCodeModel();
            ...
            org.junit.Assert.fail("generatesInstanceInit_rv142_failAssert0_add4097 should have thrown ArrayIndexOutOfBoundsException");
        } catch (ArrayIndexOutOfBoundsException expected) {
            Assert.assertEquals("-338994308", expected.getMessage());
        }
    }
    ...
    @Test(timeout = 10000)
    public void generatesInstanceInit_literalMutationNumber53_failAssert0_literalMutationNumber2207_failAssert0() throws Exception {
        try {
            {
                final JCodeModel cm = new JCodeModel();
                final JDefinedClass c = cm._package("myPackage")._class(0, "MyClass");
            ...
            org.junit.Assert.fail("generatesInstanceInit_literalMutationNumber53_failAssert0_literalMutationNumber2207 should have thrown ArrayIndexOutOfBoundsException");
        } catch (ArrayIndexOutOfBoundsException expected) {
            Assert.assertEquals("-1", expected.getMessage());
        }
    }
    ...
    @Test(timeout = 10000)
    public void generatesInstanceInit_rv142_failAssert0_mg4211_failAssert0() throws Exception {
        try {
            {
                int __DSPOT_index_43 = -338994308;
                final JCodeModel cm = new JCodeModel();
                ...
                __DSPOT_invoc_11.remove(__DSPOT_index_43);
                org.junit.Assert.fail("generatesInstanceInit_rv142 should have thrown ArrayIndexOutOfBoundsException");
                c.containsErrorTypes();
            }
            org.junit.Assert.fail("generatesInstanceInit_rv142_failAssert0_mg4211 should have thrown ArrayIndexOutOfBoundsException");
        } catch (ArrayIndexOutOfBoundsException expected) {
            Assert.assertEquals("-338994308", expected.getMessage());
        }
    }
