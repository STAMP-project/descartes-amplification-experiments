...
public final class JCodeModelTest {
    ...
    @Test(timeout = 10000)
    public void testEmptyNarrowed_mg74_failAssert0() throws JClassAlreadyExistsException {
        try {
            Class<?>[] __DSPOT_aClazzes_33 = new Class<?>[]{  };
            final JCodeModel cm = new JCodeModel();
            final JDefinedClass jClass = cm._class("EmptyNarrowed", EClassType.INTERFACE);
            final AbstractJClass hashMap = cm.ref(HashMap.class).narrowEmpty();
            jClass.field(JMod.PRIVATE, cm.ref(Map.class).narrow(String.class), "strMap", JExpr._new(hashMap));
            CodeModelTestsHelper.parseCodeModel(cm);
            hashMap.narrow(__DSPOT_aClazzes_33);
            org.junit.Assert.fail("testEmptyNarrowed_mg74 should have thrown IllegalArgumentException");
    ...
    @Test(timeout = 10000)
    public void testEmptyNarrowed_mg34() throws JClassAlreadyExistsException {
        String __DSPOT_sMessage_14 = "`i[aMe!@y;s?/OCDfviV";
        final JCodeModel cm = new JCodeModel();
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllDontImportClasses())).isEmpty());
        ...
        Assert.assertTrue(((JNarrowedClass) (hashMap)).isReference());
        Assert.assertFalse(((JNarrowedClass) (hashMap)).isPrimitive());
        JFieldVar o_testEmptyNarrowed_mg34__9 = jClass.field(JMod.PRIVATE, cm.ref(Map.class).narrow(String.class), "strMap", JExpr._new(hashMap));
        Assert.assertEquals(-1853014235, ((int) (((JFieldVar) (o_testEmptyNarrowed_mg34__9)).hashCode())));
        CodeModelTestsHelper.parseCodeModel(cm);
        JErrorClass o_testEmptyNarrowed_mg34__14 = cm.errorClass(__DSPOT_sMessage_14);
        Assert.assertFalse(((JErrorClass) (o_testEmptyNarrowed_mg34__14)).isInterface());
        Assert.assertFalse(((JErrorClass) (o_testEmptyNarrowed_mg34__14)).isAbstract());
        Assert.assertTrue(((JErrorClass) (o_testEmptyNarrowed_mg34__14)).isError());
        Assert.assertTrue(((Collection) (((JErrorClass) (o_testEmptyNarrowed_mg34__14)).getAllInnerClasses())).isEmpty());
        Assert.assertNull(((JErrorClass) (o_testEmptyNarrowed_mg34__14)).getPrimitiveType());
        Assert.assertFalse(((JErrorClass) (o_testEmptyNarrowed_mg34__14)).isParameterized());
        Assert.assertTrue(((Collection) (((JErrorClass) (o_testEmptyNarrowed_mg34__14)).getTypeParameters())).isEmpty());
        Assert.assertTrue(((JErrorClass) (o_testEmptyNarrowed_mg34__14)).isReference());
        Assert.assertFalse(((JErrorClass) (o_testEmptyNarrowed_mg34__14)).isArray());
        Assert.assertFalse(((JErrorClass) (o_testEmptyNarrowed_mg34__14)).isPrimitive());
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllDontImportClasses())).isEmpty());
        Assert.assertFalse(((Collection) (((JCodeModel) (cm)).getAllPackages())).isEmpty());
    ...
    @Test(timeout = 10000)
    public void testEmptyNarrowed_add4_failAssert0() throws JClassAlreadyExistsException {
        try {
            final JCodeModel cm = new JCodeModel();
            final JDefinedClass jClass = cm._class("EmptyNarrowed", EClassType.INTERFACE);
            final AbstractJClass hashMap = cm.ref(HashMap.class).narrowEmpty();
            ...
            jClass.field(JMod.PRIVATE, cm.ref(Map.class).narrow(String.class), "strMap", JExpr._new(hashMap));
            CodeModelTestsHelper.parseCodeModel(cm);
            org.junit.Assert.fail("testEmptyNarrowed_add4 should have thrown IllegalArgumentException");
        } catch (IllegalArgumentException expected) {
            Assert.assertEquals("The expression must be false but it is not: trying to create the same field twice: strMap", expected.getMessage());
        }
    }
    ...
    @Test(timeout = 10000)
    public void testEmptyNarrowed_literalMutationString17_failAssert0() throws JClassAlreadyExistsException {
        try {
            final JCodeModel cm = new JCodeModel();
            final JDefinedClass jClass = cm._class("EmptyNarrowed", EClassType.INTERFACE);
            final AbstractJClass hashMap = cm.ref(HashMap.class).narrowEmpty();
            jClass.field(JMod.PRIVATE, cm.ref(Map.class).narrow(String.class), "", JExpr._new(hashMap));
            CodeModelTestsHelper.parseCodeModel(cm);
            org.junit.Assert.fail("testEmptyNarrowed_literalMutationString17 should have thrown IllegalArgumentException");
        } catch (IllegalArgumentException expected) {
    ...
    @Test(timeout = 10000)
    public void testEmptyNarrowed_mg84() throws JClassAlreadyExistsException {
        final JCodeModel cm = new JCodeModel();
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllDontImportClasses())).isEmpty());
        ...
        Assert.assertTrue(((JNarrowedClass) (hashMap)).isReference());
        Assert.assertFalse(((JNarrowedClass) (hashMap)).isPrimitive());
        JFieldVar o_testEmptyNarrowed_mg84__8 = jClass.field(JMod.PRIVATE, cm.ref(Map.class).narrow(String.class), "strMap", JExpr._new(hashMap));
        Assert.assertEquals(-1853014235, ((int) (((JFieldVar) (o_testEmptyNarrowed_mg84__8)).hashCode())));
        CodeModelTestsHelper.parseCodeModel(cm);
        JTypeWildcard o_testEmptyNarrowed_mg84__13 = hashMap.wildcard();
        Assert.assertFalse(((JTypeWildcard) (o_testEmptyNarrowed_mg84__13)).isInterface());
        Assert.assertFalse(((JTypeWildcard) (o_testEmptyNarrowed_mg84__13)).isAbstract());
        Assert.assertFalse(((JTypeWildcard) (o_testEmptyNarrowed_mg84__13)).isError());
        Assert.assertTrue(((Collection) (((JTypeWildcard) (o_testEmptyNarrowed_mg84__13)).getAllInnerClasses())).isEmpty());
        Assert.assertNull(((JTypeWildcard) (o_testEmptyNarrowed_mg84__13)).getPrimitiveType());
        Assert.assertFalse(((JTypeWildcard) (o_testEmptyNarrowed_mg84__13)).isParameterized());
        Assert.assertEquals("com.helger.jcodemodel.JTypeWildcard(? extends java.util.HashMap<>)", ((JTypeWildcard) (o_testEmptyNarrowed_mg84__13)).toString());
        Assert.assertTrue(((Collection) (((JTypeWildcard) (o_testEmptyNarrowed_mg84__13)).getTypeParameters())).isEmpty());
        Assert.assertTrue(((JTypeWildcard) (o_testEmptyNarrowed_mg84__13)).isReference());
        Assert.assertFalse(((JTypeWildcard) (o_testEmptyNarrowed_mg84__13)).isArray());
        Assert.assertFalse(((JTypeWildcard) (o_testEmptyNarrowed_mg84__13)).isPrimitive());
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllDontImportClasses())).isEmpty());
        Assert.assertFalse(((Collection) (((JCodeModel) (cm)).getAllPackages())).isEmpty());
    ...
    @Test(timeout = 10000)
    public void testEmptyNarrowed_mg83() throws JClassAlreadyExistsException {
        final JCodeModel cm = new JCodeModel();
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllDontImportClasses())).isEmpty());
        ...
        Assert.assertTrue(((JNarrowedClass) (hashMap)).isReference());
        Assert.assertFalse(((JNarrowedClass) (hashMap)).isPrimitive());
        JFieldVar o_testEmptyNarrowed_mg83__8 = jClass.field(JMod.PRIVATE, cm.ref(Map.class).narrow(String.class), "strMap", JExpr._new(hashMap));
        Assert.assertEquals(-1853014235, ((int) (((JFieldVar) (o_testEmptyNarrowed_mg83__8)).hashCode())));
        CodeModelTestsHelper.parseCodeModel(cm);
        AbstractJType o_testEmptyNarrowed_mg83__13 = hashMap.unboxify();
        Assert.assertFalse(((JNarrowedClass) (o_testEmptyNarrowed_mg83__13)).isInterface());
        Assert.assertFalse(((JNarrowedClass) (o_testEmptyNarrowed_mg83__13)).isArray());
        Assert.assertTrue(((Collection) (((JNarrowedClass) (o_testEmptyNarrowed_mg83__13)).getTypeParameters())).isEmpty());
        Assert.assertFalse(((JNarrowedClass) (o_testEmptyNarrowed_mg83__13)).isAbstract());
        Assert.assertFalse(((JNarrowedClass) (o_testEmptyNarrowed_mg83__13)).isError());
        Assert.assertTrue(((Collection) (((JNarrowedClass) (o_testEmptyNarrowed_mg83__13)).getAllInnerClasses())).isEmpty());
        Assert.assertNull(((JNarrowedClass) (o_testEmptyNarrowed_mg83__13)).getPrimitiveType());
        Assert.assertTrue(((JNarrowedClass) (o_testEmptyNarrowed_mg83__13)).isParameterized());
        Assert.assertEquals("com.helger.jcodemodel.JNarrowedClass(java.util.HashMap<>)", ((JNarrowedClass) (o_testEmptyNarrowed_mg83__13)).toString());
        Assert.assertTrue(((JNarrowedClass) (o_testEmptyNarrowed_mg83__13)).isReference());
        Assert.assertFalse(((JNarrowedClass) (o_testEmptyNarrowed_mg83__13)).isPrimitive());
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllDontImportClasses())).isEmpty());
        Assert.assertFalse(((Collection) (((JCodeModel) (cm)).getAllPackages())).isEmpty());
    ...
    @Test(timeout = 10000)
    public void testEmptyNarrowed_mg49() throws JClassAlreadyExistsException {
        final JCodeModel cm = new JCodeModel();
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllDontImportClasses())).isEmpty());
        ...
        Assert.assertTrue(((JNarrowedClass) (hashMap)).isReference());
        Assert.assertFalse(((JNarrowedClass) (hashMap)).isPrimitive());
        JFieldVar o_testEmptyNarrowed_mg49__8 = jClass.field(JMod.PRIVATE, cm.ref(Map.class).narrow(String.class), "strMap", JExpr._new(hashMap));
        Assert.assertEquals(-1853014235, ((int) (((JFieldVar) (o_testEmptyNarrowed_mg49__8)).hashCode())));
        CodeModelTestsHelper.parseCodeModel(cm);
        boolean o_testEmptyNarrowed_mg49__13 = jClass.containsErrorTypes();
        Assert.assertFalse(o_testEmptyNarrowed_mg49__13);
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllDontImportClasses())).isEmpty());
        Assert.assertFalse(((Collection) (((JCodeModel) (cm)).getAllPackages())).isEmpty());
