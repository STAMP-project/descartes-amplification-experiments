...
public final class JInvocationTest {
    ...
    public void testWithGenerics_rv600_failAssert0() throws Exception {
        try {
            ...
            org.junit.Assert.fail("testWithGenerics_rv600 should have thrown ArrayIndexOutOfBoundsException");
        } catch (ArrayIndexOutOfBoundsException expected) {
            Assert.assertEquals("-1360057752", expected.getMessage());
        }
    }
    ...
    @Test(timeout = 10000)
    public void testWithGenerics_rv600_failAssert0_mg2202_failAssert0() throws Exception {
        try {
            {
                int __DSPOT_index_129 = -1360057752;
                final JCodeModel cm = new JCodeModel();
            ...
            org.junit.Assert.fail("testWithGenerics_rv600_failAssert0_mg2202 should have thrown ArrayIndexOutOfBoundsException");
        } catch (ArrayIndexOutOfBoundsException expected) {
            Assert.assertEquals("-1360057752", expected.getMessage());
        }
    }
    ...
    @Test(timeout = 10000)
    public void testWithGenerics_mg294_failAssert0_rv16871_failAssert0() throws Exception {
        try {
            {
                int __DSPOT_nIndex_38 = -1832891739;
                final JCodeModel cm = new JCodeModel();
                ...
                final JTypeVar tc = cls.generify("IMPL");
                final JMethod mc = cls.constructor(JMod.PUBLIC);
                JVar __DSPOT_invoc_12 = mc.param(JMod.FINAL, tc, "ctor");
                final JMethod m1 = cls.method(JMod.PUBLIC, cm.VOID, "foo1");
                final JTypeVar tv1 = m1.generify("T");
                m1.param(JMod.FINAL, tv1, "foo");
                m1.body()._return();
                ...
                m1.paramAtIndex(__DSPOT_nIndex_38);
                org.junit.Assert.fail("testWithGenerics_mg294 should have thrown ArrayIndexOutOfBoundsException");
                __DSPOT_invoc_12.hashCode();
            }
            org.junit.Assert.fail("testWithGenerics_mg294_failAssert0_rv16871 should have thrown ArrayIndexOutOfBoundsException");
        } catch (ArrayIndexOutOfBoundsException expected) {
            Assert.assertEquals("-1832891739", expected.getMessage());
        }
    }
