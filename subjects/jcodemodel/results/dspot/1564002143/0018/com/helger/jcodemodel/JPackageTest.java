...
public final class JPackageTest {
    ...
    @Test(timeout = 10000)
    public void testGetParent_mg17_mg3224_failAssert0() throws Exception {
        try {
            ...
            o_testGetParent_mg17__17.fullName();
            org.junit.Assert.fail("testGetParent_mg17_mg3224 should have thrown JErrorClassUsedException");
        } catch (JErrorClassUsedException expected) {
            Assert.assertEquals("#Ahw*&z*$G`c:wkJ!][,", expected.getMessage());
        }
    }

    @Test(timeout = 10000)
    public void testGetParent_mg35_mg944_failAssert0() throws Exception {
        try {
            final JCodeModel wModel = new JCodeModel();
            final AbstractJClass wClass = wModel.ref(JExpr.class);
            JPackage wCurrentPackage = wClass._package();
            ...
            o_testGetParent_mg35__16.narrowEmpty();
            org.junit.Assert.fail("testGetParent_mg35_mg944 should have thrown IllegalArgumentException");
        } catch (IllegalArgumentException expected) {
