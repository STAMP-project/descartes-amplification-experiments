...
public final class JDirectClassTest {
    ...
    @Test(timeout = 10000)
    public void testBasic_rv263_mg13478() throws Exception {
        final JCodeModel cm = new JCodeModel();
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllDontImportClasses())).isEmpty());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllPackages())).isEmpty());
        ...
        Assert.assertFalse(((JDirectClass) (rClassId)).isError());
        Assert.assertTrue(((JDirectClass) (rClassId)).isReference());
        String o_testBasic_rv263__6 = rClassId.name();
        Assert.assertEquals("id", o_testBasic_rv263__6);
        String o_testBasic_rv263__7 = rClassId._package().name();
        Assert.assertEquals("id.aa", o_testBasic_rv263__7);
        String o_testBasic_rv263__9 = rClassId.fullName();
        Assert.assertEquals("id.aa.R.id", o_testBasic_rv263__9);
        final JDirectClass rClassMenu = cm.directClass("id.aa.R")._class("menu");
        Assert.assertEquals(87469099, ((int) (((JDirectClass) (rClassMenu)).hashCode())));
        Assert.assertFalse(((JDirectClass) (rClassMenu)).isAbstract());
        Assert.assertFalse(((JDirectClass) (rClassMenu)).isInterface());
        ...
        Assert.assertFalse(((JDirectClass) (rClassMenu)).isError());
        Assert.assertTrue(((JDirectClass) (rClassMenu)).isReference());
        String o_testBasic_rv263__13 = rClassMenu.name();
        Assert.assertEquals("menu", o_testBasic_rv263__13);
        String o_testBasic_rv263__14 = rClassMenu._package().name();
        Assert.assertEquals("id.aa", o_testBasic_rv263__14);
        String o_testBasic_rv263__16 = rClassMenu.fullName();
        Assert.assertEquals("id.aa.R.menu", o_testBasic_rv263__16);
        final JFieldRef myItem = rClassId.staticRef("myItem");
        Assert.assertEquals(512961099, ((int) (((JFieldRef) (myItem)).hashCode())));
        final JFieldRef myMenu = rClassMenu.staticRef("myMenu");
        Assert.assertEquals(-564731709, ((int) (((JFieldRef) (myMenu)).hashCode())));
        ...
        aMethodSelected.body()._if(JExpr.ref("itemId_").eq(myItem));
        CodeModelTestsHelper.parseCodeModel(cm);
        __DSPOT_invoc_33.getContents();
        boolean o_testBasic_rv263_mg13478__54 = aClassAct.containsErrorTypes();
        Assert.assertFalse(o_testBasic_rv263_mg13478__54);
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllDontImportClasses())).isEmpty());
        Assert.assertFalse(((Collection) (((JCodeModel) (cm)).getAllPackages())).isEmpty());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
    ...
    @Test(timeout = 10000)
    public void testBasic_mg215_failAssert0null15967_failAssert0() throws Exception {
        try {
            {
                IJFormatter __DSPOT_f_48 = null;
                final JCodeModel cm = new JCodeModel();
                final JDirectClass rClassId = cm.directClass("id.aa.R")._class("id");
                rClassId.name();
                rClassId._package().name();
                ...
                aMethodSelected.body()._if(JExpr.ref("itemId_").eq(myItem));
                CodeModelTestsHelper.parseCodeModel(cm);
                aMethodSelected.declare(__DSPOT_f_48);
                org.junit.Assert.fail("testBasic_mg215 should have thrown NullPointerException");
            }
            org.junit.Assert.fail("testBasic_mg215_failAssert0null15967 should have thrown NullPointerException");
        } catch (NullPointerException expected) {
    ...
    @Test(timeout = 10000)
    public void testBasic_rv275_mg6541() throws Exception {
        final JCodeModel cm = new JCodeModel();
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllDontImportClasses())).isEmpty());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllPackages())).isEmpty());
        ...
        Collection<JAnnotationUse> o_testBasic_rv275_mg6541__56 = aMethodCreate.annotations();
        Assert.assertTrue(o_testBasic_rv275_mg6541__56.isEmpty());
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllDontImportClasses())).isEmpty());
        Assert.assertFalse(((Collection) (((JCodeModel) (cm)).getAllPackages())).isEmpty());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
    ...
    @Test(timeout = 10000)
    public void testBasic_rv261_mg6091() throws Exception {
        String __DSPOT_sSubPackageName_1075 = "lu&Ptx)3Vol27M&!]V]Z";
        String __DSPOT_sSource_56 = "!EI)uhDiCMs-NCPSNsen";
        final JCodeModel cm = new JCodeModel();
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllDontImportClasses())).isEmpty());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllPackages())).isEmpty());
        ...
        Assert.assertFalse(((JDirectClass) (rClassId)).isError());
        Assert.assertTrue(((JDirectClass) (rClassId)).isReference());
        String o_testBasic_rv261__7 = rClassId.name();
        Assert.assertEquals("id", o_testBasic_rv261__7);
        String o_testBasic_rv261__8 = rClassId._package().name();
        Assert.assertEquals("id.aa", o_testBasic_rv261__8);
        String o_testBasic_rv261__10 = rClassId.fullName();
        Assert.assertEquals("id.aa.R.id", o_testBasic_rv261__10);
        final JDirectClass rClassMenu = cm.directClass("id.aa.R")._class("menu");
        Assert.assertEquals(87469099, ((int) (((JDirectClass) (rClassMenu)).hashCode())));
        Assert.assertFalse(((JDirectClass) (rClassMenu)).isAbstract());
        Assert.assertFalse(((JDirectClass) (rClassMenu)).isInterface());
        ...
        Assert.assertFalse(((JDirectClass) (rClassMenu)).isError());
        Assert.assertTrue(((JDirectClass) (rClassMenu)).isReference());
        String o_testBasic_rv261__14 = rClassMenu.name();
        Assert.assertEquals("menu", o_testBasic_rv261__14);
        String o_testBasic_rv261__15 = rClassMenu._package().name();
        Assert.assertEquals("id.aa", o_testBasic_rv261__15);
        String o_testBasic_rv261__17 = rClassMenu.fullName();
        Assert.assertEquals("id.aa.R.menu", o_testBasic_rv261__17);
        final JFieldRef myItem = rClassId.staticRef("myItem");
        Assert.assertEquals(512961099, ((int) (((JFieldRef) (myItem)).hashCode())));
        final JFieldRef myMenu = rClassMenu.staticRef("myMenu");
        Assert.assertEquals(-564731709, ((int) (((JFieldRef) (myMenu)).hashCode())));
        ...
        aMethodSelected.body()._if(JExpr.ref("itemId_").eq(myItem));
        CodeModelTestsHelper.parseCodeModel(cm);
        __DSPOT_invoc_33.directStatement(__DSPOT_sSource_56);
        JPackage o_testBasic_rv261_mg6091__56 = aPkg2.subPackage(__DSPOT_sSubPackageName_1075);
        Assert.assertTrue(((JPackage) (((JPackage) (((JPackage) (o_testBasic_rv261_mg6091__56)).getPackage())).getPackage())).isPackage());
        Assert.assertFalse(((JPackage) (((JPackage) (((JPackage) (o_testBasic_rv261_mg6091__56)).getPackage())).getPackage())).isClass());
        Assert.assertFalse(((JPackage) (((JPackage) (((JPackage) (o_testBasic_rv261_mg6091__56)).getPackage())).getPackage())).isUnnamed());
        Assert.assertTrue(((Collection) (((JPackage) (((JPackage) (((JPackage) (o_testBasic_rv261_mg6091__56)).getPackage())).getPackage())).getAllResourceFiles())).isEmpty());
        Assert.assertTrue(((JPackage) (((JPackage) (o_testBasic_rv261_mg6091__56)).getPackage())).isPackage());
        Assert.assertFalse(((JPackage) (((JPackage) (o_testBasic_rv261_mg6091__56)).getPackage())).isClass());
        Assert.assertFalse(((JPackage) (((JPackage) (o_testBasic_rv261_mg6091__56)).getPackage())).isUnnamed());
        Assert.assertTrue(((Collection) (((JPackage) (((JPackage) (o_testBasic_rv261_mg6091__56)).getPackage())).getAllResourceFiles())).isEmpty());
        Assert.assertTrue(((JPackage) (o_testBasic_rv261_mg6091__56)).isPackage());
        Assert.assertFalse(((JPackage) (o_testBasic_rv261_mg6091__56)).isClass());
        Assert.assertFalse(((JPackage) (o_testBasic_rv261_mg6091__56)).isUnnamed());
        Assert.assertTrue(((Collection) (((JPackage) (o_testBasic_rv261_mg6091__56)).getAllResourceFiles())).isEmpty());
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllDontImportClasses())).isEmpty());
        Assert.assertFalse(((Collection) (((JCodeModel) (cm)).getAllPackages())).isEmpty());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
    ...
    @Test(timeout = 10000)
    public void testBasic_rv248_rv19224_failAssert0() throws Exception {
        try {
            IJFormatter __DSPOT_f_3625 = null;
            final JCodeModel cm = new JCodeModel();
            final JDirectClass rClassId = cm.directClass("id.aa.R")._class("id");
            ...
            aMethodSelected.body()._if(JExpr.ref("itemId_").eq(myItem));
            CodeModelTestsHelper.parseCodeModel(cm);
            JBreak __DSPOT_invoc_392 = __DSPOT_invoc_33._break();
            __DSPOT_invoc_392.state(__DSPOT_f_3625);
            org.junit.Assert.fail("testBasic_rv248_rv19224 should have thrown NullPointerException");
        } catch (NullPointerException expected) {
            Assert.assertEquals(null, expected.getMessage());
        }
    }
