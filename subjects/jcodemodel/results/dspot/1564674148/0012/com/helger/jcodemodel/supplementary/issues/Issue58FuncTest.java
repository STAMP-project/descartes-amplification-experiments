...
public final class Issue58FuncTest {
    ...
    @Test(timeout = 10000)
    public void testIssue_literalMutationString24() throws Exception {
        final JCodeModel generator = new JCodeModel();
        final JDefinedClass aClass = generator._class("test.Test");
        final JMethod aMethod = aClass.method(0, generator.VOID, "name");
        Assert.assertFalse(((JMethod) (aMethod)).isConstructor());
        Assert.assertTrue(((JMethod) (aMethod)).getThrows().isEmpty());
        Assert.assertFalse(((JMethod) (aMethod)).hasVarArgs());
        JVar o_testIssue_literalMutationString24__7 = aMethod.param(generator.ref(""), "p");
        Assert.assertEquals(-1828404188, ((int) (((JVar) (o_testIssue_literalMutationString24__7)).hashCode())));
        JMethod o_testIssue_literalMutationString24__9 = aClass.getMethod("name", new AbstractJType[]{ generator.ref("test.UnknownClass") });
        Assert.assertNull(o_testIssue_literalMutationString24__9);
        Assert.assertFalse(((JMethod) (aMethod)).isConstructor());
        Assert.assertTrue(((JMethod) (aMethod)).getThrows().isEmpty());
        Assert.assertFalse(((JMethod) (aMethod)).hasVarArgs());
        Assert.assertEquals(-1828404188, ((int) (((JVar) (o_testIssue_literalMutationString24__7)).hashCode())));
    ...
    @Test(timeout = 10000)
    public void testIssue_mg57_mg10461_failAssert0() throws Exception {
        try {
            String __DSPOT_sName_16 = "nkib%A@IY:Wo-9M/^zOC";
            String __DSPOT_sMessage_15 = "{+DN-eV8<Or;(?xw0]W#";
            final JCodeModel generator = new JCodeModel();
            ...
            JMethod o_testIssue_mg57__11 = aClass.getMethod("name", new AbstractJType[]{ generator.ref("test.UnknownClass") });
            JErrorClass o_testIssue_mg57__13 = generator.errorClass(__DSPOT_sMessage_15, __DSPOT_sName_16);
            o_testIssue_mg57__13._extends();
            org.junit.Assert.fail("testIssue_mg57_mg10461 should have thrown JErrorClassUsedException");
        } catch (JErrorClassUsedException expected) {
            Assert.assertEquals("{+DN-eV8<Or;(?xw0]W#", expected.getMessage());
        }
    }

    @Test(timeout = 10000)
    public void testIssue_literalMutationString38_mg15177_mg39608() throws Exception {
        String __DSPOT_sName_4034 = "h<K<`+`9Rp>]?u7dNz@|";
        final JCodeModel generator = new JCodeModel();
        final JDefinedClass aClass = generator._class("test.Test");
        final JMethod aMethod = aClass.method(0, generator.VOID, "name");
        ...
        JEnumConstant o_testIssue_literalMutationString38_mg15177__16 = aClass.enumConstant(__DSPOT_sName_4034);
        Collection<JAnnotationUse> o_testIssue_literalMutationString38_mg15177_mg39608__19 = o_testIssue_literalMutationString38_mg15177__16.annotations();
        Assert.assertTrue(o_testIssue_literalMutationString38_mg15177_mg39608__19.isEmpty());
    }

    @Test(timeout = 10000)
    public void testIssue_mg104_mg18018_mg35174() throws Exception {
        final JCodeModel generator = new JCodeModel();
        final JDefinedClass aClass = generator._class("test.Test");
        final JMethod aMethod = aClass.method(0, generator.VOID, "name");
        JVar o_testIssue_mg104__7 = aMethod.param(generator.ref("test.UnknownClass"), "p");
        JMethod o_testIssue_mg104__9 = aClass.getMethod("name", new AbstractJType[]{ generator.ref("test.UnknownClass") });
        AbstractJType o_testIssue_mg104__11 = aMethod.type();
        AbstractJType o_testIssue_mg104_mg18018__18 = o_testIssue_mg104__9.type();
        AbstractJType o_testIssue_mg104_mg18018_mg35174__21 = o_testIssue_mg104_mg18018__18.erasure();
        Assert.assertTrue(((JPrimitiveType) (o_testIssue_mg104_mg18018_mg35174__21)).isPrimitive());
        Assert.assertEquals("com.helger.jcodemodel.JPrimitiveType(void)", ((JPrimitiveType) (o_testIssue_mg104_mg18018_mg35174__21)).toString());
        Assert.assertFalse(((JPrimitiveType) (o_testIssue_mg104_mg18018_mg35174__21)).isArray());
        Assert.assertFalse(((JPrimitiveType) (o_testIssue_mg104_mg18018_mg35174__21)).isError());
        Assert.assertFalse(((JPrimitiveType) (o_testIssue_mg104_mg18018_mg35174__21)).isReference());
    }

    @Test(timeout = 10000)
    public void testIssue_mg48_mg2785_mg30376_failAssert0() throws Exception {
        try {
            IJFormatter __DSPOT_f_8130 = null;
            String __DSPOT_sName_4 = "i*OdwpauR%h1,xavU[1R";
            final JCodeModel generator = new JCodeModel();
            final JDefinedClass aClass = generator._class("test.Test");
            final JMethod aMethod = aClass.method(0, generator.VOID, "name");
            ...
            JMethod o_testIssue_mg48__10 = aClass.getMethod("name", new AbstractJType[]{ generator.ref("test.UnknownClass") });
            JPackage o_testIssue_mg48__12 = generator._package(__DSPOT_sName_4);
            Map<String, JFieldVar> o_testIssue_mg48_mg2785__19 = aClass.fields();
            o_testIssue_mg48__12.generate(__DSPOT_f_8130);
            org.junit.Assert.fail("testIssue_mg48_mg2785_mg30376 should have thrown NullPointerException");
        } catch (NullPointerException expected) {
            Assert.assertEquals(null, expected.getMessage());
        }
    }
