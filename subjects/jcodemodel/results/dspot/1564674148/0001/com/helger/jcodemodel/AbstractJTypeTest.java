...
public final class AbstractJTypeTest {
    ...
    @Test(timeout = 10000)
    public void testIsAssignableFromRandomized_mg127() throws Exception {
        final JCodeModel codeModel = new JCodeModel();
        Assert.assertTrue(((Collection) (((JCodeModel) (codeModel)).getAllPackages())).isEmpty());
        Assert.assertNull(((JCodeModel) (codeModel)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (codeModel)).getBuildingNewLine());
        ...
        final AbstractJClass _List = codeModel.ref(List.class);
        Assert.assertEquals("com.helger.jcodemodel.JReferencedClass(java.util.List)", ((JReferencedClass) (_List)).toString());
        ((JReferencedClass) (_List)).getTypeParameters().isEmpty();
        Assert.assertTrue(((Collection) (((JReferencedClass) (_List)).getTypeParameters())).isEmpty());
        Assert.assertFalse(((JReferencedClass) (_List)).isParameterized());
        Assert.assertTrue(((Collection) (((JReferencedClass) (_List)).getAllInnerClasses())).isEmpty());
        Assert.assertFalse(((JReferencedClass) (_List)).isArray());
        ...
        JArrayClass o_testIsAssignableFromRandomized_mg127__70 = _List.array();
        Assert.assertFalse(((JArrayClass) (o_testIsAssignableFromRandomized_mg127__70)).isInterface());
        Assert.assertTrue(((JArrayClass) (o_testIsAssignableFromRandomized_mg127__70)).isArray());
        Assert.assertFalse(((JArrayClass) (o_testIsAssignableFromRandomized_mg127__70)).isAbstract());
        Assert.assertEquals("com.helger.jcodemodel.JArrayClass(java.util.List[])", ((JArrayClass) (o_testIsAssignableFromRandomized_mg127__70)).toString());
        Assert.assertTrue(((Collection) (((JArrayClass) (o_testIsAssignableFromRandomized_mg127__70)).getTypeParameters())).isEmpty());
        Assert.assertFalse(((JArrayClass) (o_testIsAssignableFromRandomized_mg127__70)).isParameterized());
        Assert.assertNull(((JArrayClass) (o_testIsAssignableFromRandomized_mg127__70)).getPrimitiveType());
        Assert.assertTrue(((Collection) (((JArrayClass) (o_testIsAssignableFromRandomized_mg127__70)).getAllInnerClasses())).isEmpty());
        Assert.assertFalse(((JArrayClass) (o_testIsAssignableFromRandomized_mg127__70)).isPrimitive());
        Assert.assertFalse(((JArrayClass) (o_testIsAssignableFromRandomized_mg127__70)).isError());
        Assert.assertTrue(((JArrayClass) (o_testIsAssignableFromRandomized_mg127__70)).isReference());
        Assert.assertTrue(((Collection) (((JCodeModel) (codeModel)).getAllPackages())).isEmpty());
        Assert.assertNull(((JCodeModel) (codeModel)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (codeModel)).getBuildingNewLine());
        Assert.assertTrue(((Collection) (((JCodeModel) (codeModel)).getAllDontImportClasses())).isEmpty());
