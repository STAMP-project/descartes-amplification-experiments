...
public final class AbstractJTypeTest {
    ...
    @Test(timeout = 10000)
    public void testIsAssignableFromRandomized_mg102() throws Exception {
        final JCodeModel codeModel = new JCodeModel();
        Assert.assertTrue(((Collection) (((JCodeModel) (codeModel)).getAllPackages())).isEmpty());
        Assert.assertNull(((JCodeModel) (codeModel)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (codeModel)).getBuildingNewLine());
        ...
        AbstractJType o_testIsAssignableFromRandomized_mg102__70 = _Object.unboxify();
        Assert.assertEquals("com.helger.jcodemodel.JReferencedClass(java.lang.Object)", ((JReferencedClass) (o_testIsAssignableFromRandomized_mg102__70)).toString());
        Assert.assertTrue(((Collection) (((JReferencedClass) (o_testIsAssignableFromRandomized_mg102__70)).getTypeParameters())).isEmpty());
        Assert.assertTrue(((Collection) (((JReferencedClass) (o_testIsAssignableFromRandomized_mg102__70)).getAllInnerClasses())).isEmpty());
        Assert.assertFalse(((JReferencedClass) (o_testIsAssignableFromRandomized_mg102__70)).isParameterized());
        Assert.assertFalse(((JReferencedClass) (o_testIsAssignableFromRandomized_mg102__70)).isArray());
        Assert.assertFalse(((JReferencedClass) (o_testIsAssignableFromRandomized_mg102__70)).isPrimitive());
        Assert.assertFalse(((JReferencedClass) (o_testIsAssignableFromRandomized_mg102__70)).isError());
        Assert.assertTrue(((JReferencedClass) (o_testIsAssignableFromRandomized_mg102__70)).isReference());
        Assert.assertTrue(((Collection) (((JCodeModel) (codeModel)).getAllPackages())).isEmpty());
        Assert.assertNull(((JCodeModel) (codeModel)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (codeModel)).getBuildingNewLine());
        Assert.assertTrue(((Collection) (((JCodeModel) (codeModel)).getAllDontImportClasses())).isEmpty());
