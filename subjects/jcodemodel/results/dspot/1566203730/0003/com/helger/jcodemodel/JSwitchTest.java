...
public final class JSwitchTest {
    ...
    @Test(timeout = 10000)
    public void testGenerate_mg81() throws JClassAlreadyExistsException {
        ...
        Assert.assertEquals(520295679, ((int) (((JEnumConstant) (cb)).hashCode())));
        Assert.assertEquals("myPackage.SwitchTest.MyEnum.B", ((JEnumConstant) (cb)).getName());
        JEnumConstant o_testGenerate_mg81__14 = jEnumClass.enumConstant("C");
        Assert.assertFalse(((JEnumConstant) (o_testGenerate_mg81__14)).hasArgs());
        Assert.assertEquals(520295680, ((int) (((JEnumConstant) (o_testGenerate_mg81__14)).hashCode())));
        Assert.assertEquals("myPackage.SwitchTest.MyEnum.C", ((JEnumConstant) (o_testGenerate_mg81__14)).getName());
        final JMethod m = c2.method(0, cm.VOID, "dummy");
        Assert.assertTrue(((JMethod) (m)).getThrows().isEmpty());
        Assert.assertFalse(((JMethod) (m)).hasVarArgs());
        Assert.assertFalse(((JMethod) (m)).isConstructor());
        ...
        s._default().body()._break();
        CodeModelTestsHelper.parseCodeModel(cm);
        JErrorClass o_testGenerate_mg81__32 = cm.errorClass(__DSPOT_sMessage_15, __DSPOT_sName_16);
        Assert.assertFalse(((JErrorClass) (o_testGenerate_mg81__32)).isInterface());
        Assert.assertFalse(((JErrorClass) (o_testGenerate_mg81__32)).isAbstract());
        Assert.assertTrue(((JErrorClass) (o_testGenerate_mg81__32)).isError());
        Assert.assertFalse(((JErrorClass) (o_testGenerate_mg81__32)).isParameterized());
        Assert.assertNull(((JErrorClass) (o_testGenerate_mg81__32)).getPrimitiveType());
        Assert.assertTrue(((Collection) (((JErrorClass) (o_testGenerate_mg81__32)).getAllInnerClasses())).isEmpty());
        Assert.assertTrue(((Collection) (((JErrorClass) (o_testGenerate_mg81__32)).getTypeParameters())).isEmpty());
        Assert.assertTrue(((JErrorClass) (o_testGenerate_mg81__32)).isReference());
        Assert.assertFalse(((JErrorClass) (o_testGenerate_mg81__32)).isArray());
        Assert.assertFalse(((JErrorClass) (o_testGenerate_mg81__32)).isPrimitive());
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllDontImportClasses())).isEmpty());
        Assert.assertFalse(((Collection) (((JCodeModel) (cm)).getAllPackages())).isEmpty());
    ...
    @Test(timeout = 10000)
    public void testGenerate_rv213() throws JClassAlreadyExistsException {
        final JCodeModel cm = new JCodeModel();
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllDontImportClasses())).isEmpty());
        ...
        Assert.assertEquals(520295679, ((int) (((JEnumConstant) (cb)).hashCode())));
        Assert.assertEquals("myPackage.SwitchTest.MyEnum.B", ((JEnumConstant) (cb)).getName());
        JEnumConstant o_testGenerate_rv213__12 = jEnumClass.enumConstant("C");
        Assert.assertFalse(((JEnumConstant) (o_testGenerate_rv213__12)).hasArgs());
        Assert.assertEquals(520295680, ((int) (((JEnumConstant) (o_testGenerate_rv213__12)).hashCode())));
        Assert.assertEquals("myPackage.SwitchTest.MyEnum.C", ((JEnumConstant) (o_testGenerate_rv213__12)).getName());
        final JMethod m = c2.method(0, cm.VOID, "dummy");
        Assert.assertTrue(((JMethod) (m)).getThrows().isEmpty());
        Assert.assertFalse(((JMethod) (m)).hasVarArgs());
        Assert.assertFalse(((JMethod) (m)).isConstructor());
        ...
        s._default().body()._break();
        CodeModelTestsHelper.parseCodeModel(cm);
        JLabel o_testGenerate_rv213__32 = __DSPOT_invoc_20.label();
        Assert.assertNull(o_testGenerate_rv213__32);
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllDontImportClasses())).isEmpty());
        Assert.assertFalse(((Collection) (((JCodeModel) (cm)).getAllPackages())).isEmpty());
    ...
    @Test(timeout = 10000)
    public void testGenerate_mg147() throws JClassAlreadyExistsException {
        final JCodeModel cm = new JCodeModel();
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllDontImportClasses())).isEmpty());
        ...
        Assert.assertEquals(520295679, ((int) (((JEnumConstant) (cb)).hashCode())));
        Assert.assertEquals("myPackage.SwitchTest.MyEnum.B", ((JEnumConstant) (cb)).getName());
        JEnumConstant o_testGenerate_mg147__12 = jEnumClass.enumConstant("C");
        Assert.assertFalse(((JEnumConstant) (o_testGenerate_mg147__12)).hasArgs());
        Assert.assertEquals(520295680, ((int) (((JEnumConstant) (o_testGenerate_mg147__12)).hashCode())));
        Assert.assertEquals("myPackage.SwitchTest.MyEnum.C", ((JEnumConstant) (o_testGenerate_mg147__12)).getName());
        final JMethod m = c2.method(0, cm.VOID, "dummy");
        Assert.assertTrue(((JMethod) (m)).getThrows().isEmpty());
        Assert.assertFalse(((JMethod) (m)).hasVarArgs());
        Assert.assertFalse(((JMethod) (m)).isConstructor());
        ...
        s._default().body()._break();
        CodeModelTestsHelper.parseCodeModel(cm);
        List<IJExpression> o_testGenerate_mg147__30 = cb.argsMutable();
        Assert.assertTrue(o_testGenerate_mg147__30.isEmpty());
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllDontImportClasses())).isEmpty());
        Assert.assertFalse(((Collection) (((JCodeModel) (cm)).getAllPackages())).isEmpty());
    ...
    @Test(timeout = 10000)
    public void testGenerate_literalMutationNumber54_failAssert0() throws JClassAlreadyExistsException {
        try {
            final JCodeModel cm = new JCodeModel();
            final JDefinedClass c2 = cm._package("myPackage")._class("SwitchTest");
            final JDefinedClass jEnumClass = c2._enum("MyEnum");
            ...
            s._default().body()._break();
            CodeModelTestsHelper.parseCodeModel(cm);
            org.junit.Assert.fail("testGenerate_literalMutationNumber54 should have thrown IllegalArgumentException");
        } catch (IllegalArgumentException expected) {
        }
    }
    ...
    public void testGenerate_mg168_failAssert0() throws JClassAlreadyExistsException {
        try {
            ...
            org.junit.Assert.fail("testGenerate_mg168 should have thrown ArrayIndexOutOfBoundsException");
    ...
    @Test(timeout = 10000)
    public void testGenerate_rv201() throws JClassAlreadyExistsException {
        final JCodeModel cm = new JCodeModel();
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllDontImportClasses())).isEmpty());
        ...
        s._default().body()._break();
        CodeModelTestsHelper.parseCodeModel(cm);
        List<IJExpression> o_testGenerate_rv201__32 = __DSPOT_invoc_12.args();
        Assert.assertTrue(o_testGenerate_rv201__32.isEmpty());
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllDontImportClasses())).isEmpty());
        Assert.assertFalse(((Collection) (((JCodeModel) (cm)).getAllPackages())).isEmpty());
