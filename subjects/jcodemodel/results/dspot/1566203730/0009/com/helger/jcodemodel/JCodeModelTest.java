...
public final class JCodeModelTest {
    ...
    @Test(timeout = 10000)
    public void testEmptyNarrowed_mg35() throws JClassAlreadyExistsException {
        ...
        Assert.assertEquals(-1853014235, ((int) (((JFieldVar) (o_testEmptyNarrowed_mg35__10)).hashCode())));
        CodeModelTestsHelper.parseCodeModel(cm);
        JErrorClass o_testEmptyNarrowed_mg35__15 = cm.errorClass(__DSPOT_sMessage_15, __DSPOT_sName_16);
        Assert.assertFalse(((JErrorClass) (o_testEmptyNarrowed_mg35__15)).isInterface());
        Assert.assertFalse(((JErrorClass) (o_testEmptyNarrowed_mg35__15)).isAbstract());
        Assert.assertEquals("Tx>DODA!L#vK5WR{oE1L", ((JErrorClass) (o_testEmptyNarrowed_mg35__15)).getMessage());
        Assert.assertTrue(((JErrorClass) (o_testEmptyNarrowed_mg35__15)).isError());
        Assert.assertTrue(((Collection) (((JErrorClass) (o_testEmptyNarrowed_mg35__15)).getAllInnerClasses())).isEmpty());
        Assert.assertNull(((JErrorClass) (o_testEmptyNarrowed_mg35__15)).getPrimitiveType());
        Assert.assertFalse(((JErrorClass) (o_testEmptyNarrowed_mg35__15)).isParameterized());
        Assert.assertTrue(((Collection) (((JErrorClass) (o_testEmptyNarrowed_mg35__15)).getTypeParameters())).isEmpty());
        Assert.assertTrue(((JErrorClass) (o_testEmptyNarrowed_mg35__15)).isReference());
        Assert.assertFalse(((JErrorClass) (o_testEmptyNarrowed_mg35__15)).isArray());
        Assert.assertFalse(((JErrorClass) (o_testEmptyNarrowed_mg35__15)).isPrimitive());
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllDontImportClasses())).isEmpty());
        Assert.assertFalse(((Collection) (((JCodeModel) (cm)).getAllPackages())).isEmpty());
    ...
    @Test(timeout = 10000)
    public void testEmptyNarrowed_mg86() throws JClassAlreadyExistsException {
        final JCodeModel cm = new JCodeModel();
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllDontImportClasses())).isEmpty());
