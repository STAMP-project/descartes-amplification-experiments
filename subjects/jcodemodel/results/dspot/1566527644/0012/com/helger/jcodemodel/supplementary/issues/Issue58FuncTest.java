...
public final class Issue58FuncTest {
    ...
    @Test(timeout = 10000)
    public void testIssue_literalMutationString41() throws Exception {
        final JCodeModel generator = new JCodeModel();
        final JDefinedClass aClass = generator._class("test.Test");
        final JMethod aMethod = aClass.method(0, generator.VOID, "name");
        Assert.assertTrue(((JMethod) (aMethod)).getThrows().isEmpty());
        Assert.assertFalse(((JMethod) (aMethod)).hasVarArgs());
        Assert.assertFalse(((JMethod) (aMethod)).isConstructor());
        JVar o_testIssue_literalMutationString41__7 = aMethod.param(generator.ref("test.UnknownClass"), "p");
        Assert.assertEquals(-1828404188, ((int) (((JVar) (o_testIssue_literalMutationString41__7)).hashCode())));
        JMethod o_testIssue_literalMutationString41__9 = aClass.getMethod("name", new AbstractJType[]{ generator.ref("tesst.UnknownClass") });
        Assert.assertNull(o_testIssue_literalMutationString41__9);
        Assert.assertTrue(((JMethod) (aMethod)).getThrows().isEmpty());
        Assert.assertFalse(((JMethod) (aMethod)).hasVarArgs());
        Assert.assertFalse(((JMethod) (aMethod)).isConstructor());
        Assert.assertEquals(-1828404188, ((int) (((JVar) (o_testIssue_literalMutationString41__7)).hashCode())));
    ...
    @Test(timeout = 10000)
    public void testIssue_mg92_mg16841() throws Exception {
        String __DSPOT_sValue_4459 = "vXO_x>G+*_|}C(D!%#kR";
        String __DSPOT_sAttribute_4458 = "usq-Wh_q7}Tn h&!pN^/";
        String __DSPOT_sName_4457 = "^epyN:z?E2,AfG(?3:)G";
        final JCodeModel generator = new JCodeModel();
        final JDefinedClass aClass = generator._class("test.Test");
        final JMethod aMethod = aClass.method(0, generator.VOID, "name");
        JVar o_testIssue_mg92__7 = aMethod.param(generator.ref("test.UnknownClass"), "p");
        JMethod o_testIssue_mg92__9 = aClass.getMethod("name", new AbstractJType[]{ generator.ref("test.UnknownClass") });
        JDocComment o_testIssue_mg92__11 = aMethod.javadoc();
        Map<String, String> o_testIssue_mg92_mg16841__21 = o_testIssue_mg92__11.addXdoclet(__DSPOT_sName_4457, __DSPOT_sAttribute_4458, __DSPOT_sValue_4459);
        Assert.assertTrue(o_testIssue_mg92_mg16841__21.containsKey("usq-Wh_q7}Tn h&!pN^/"));
        Assert.assertEquals("vXO_x>G+*_|}C(D!%#kR", o_testIssue_mg92_mg16841__21.get("usq-Wh_q7}Tn h&!pN^/"));
    }
}
