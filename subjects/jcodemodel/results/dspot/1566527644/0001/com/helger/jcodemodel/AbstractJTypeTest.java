...
public final class AbstractJTypeTest {
    ...
    @Test(timeout = 10000)
    public void testIsAssignableFromRandomized_mg117() throws Exception {
        final JCodeModel codeModel = new JCodeModel();
        Assert.assertTrue(((Collection) (((JCodeModel) (codeModel)).getAllPackages())).isEmpty());
        Assert.assertNull(((JCodeModel) (codeModel)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (codeModel)).getBuildingNewLine());
        ...
        AbstractJClass o_testIsAssignableFromRandomized_mg117__70 = _Integer.narrowEmpty();
        Assert.assertFalse(((JNarrowedClass) (o_testIsAssignableFromRandomized_mg117__70)).isInterface());
        Assert.assertFalse(((JNarrowedClass) (o_testIsAssignableFromRandomized_mg117__70)).isArray());
        Assert.assertTrue(((Collection) (((JNarrowedClass) (o_testIsAssignableFromRandomized_mg117__70)).getTypeParameters())).isEmpty());
        Assert.assertFalse(((JNarrowedClass) (o_testIsAssignableFromRandomized_mg117__70)).isAbstract());
        Assert.assertFalse(((JNarrowedClass) (o_testIsAssignableFromRandomized_mg117__70)).isError());
        Assert.assertTrue(((Collection) (((JNarrowedClass) (o_testIsAssignableFromRandomized_mg117__70)).getAllInnerClasses())).isEmpty());
        Assert.assertTrue(((JNarrowedClass) (o_testIsAssignableFromRandomized_mg117__70)).isParameterized());
        Assert.assertNull(((JNarrowedClass) (o_testIsAssignableFromRandomized_mg117__70)).getPrimitiveType());
        Assert.assertEquals("com.helger.jcodemodel.JNarrowedClass(java.lang.Integer<>)", ((JNarrowedClass) (o_testIsAssignableFromRandomized_mg117__70)).toString());
        Assert.assertTrue(((JNarrowedClass) (o_testIsAssignableFromRandomized_mg117__70)).isReference());
        Assert.assertFalse(((JNarrowedClass) (o_testIsAssignableFromRandomized_mg117__70)).isPrimitive());
        Assert.assertTrue(((Collection) (((JCodeModel) (codeModel)).getAllPackages())).isEmpty());
        Assert.assertNull(((JCodeModel) (codeModel)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (codeModel)).getBuildingNewLine());
        Assert.assertTrue(((Collection) (((JCodeModel) (codeModel)).getAllDontImportClasses())).isEmpty());
