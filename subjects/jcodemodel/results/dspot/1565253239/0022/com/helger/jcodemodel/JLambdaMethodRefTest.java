...
public final class JLambdaMethodRefTest {
    ...
    @Test(timeout = 10000)
    public void testStaticMethodRef_JMethod_literalMutationString37_failAssert0() throws JClassAlreadyExistsException {
        try {
            final JCodeModel cm = new JCodeModel();
            final JDefinedClass cl = cm._class("com.helger.test.LambdaTest");
            final JMethod m = cl.method(((JMod.PUBLIC) | (JMod.STATIC)), cm.ref(String.class), "myToString");
            ...
            aLambda.var();
            aLambda.methodName();
            org.junit.Assert.fail("testStaticMethodRef_JMethod_literalMutationString37 should have thrown IllegalArgumentException");
        } catch (IllegalArgumentException expected) {
    ...
    @Test(timeout = 10000)
    public void testStaticMethodRef_JMethodnull138_failAssert0() throws JClassAlreadyExistsException {
        try {
            final JCodeModel cm = new JCodeModel();
            final JDefinedClass cl = cm._class("com.helger.test.LambdaTest");
            final JMethod m = cl.method(((JMod.PUBLIC) | (JMod.STATIC)), cm.ref(String.class), "myToString");
            ...
            aLambda.var();
            aLambda.methodName();
            org.junit.Assert.fail("testStaticMethodRef_JMethodnull138 should have thrown NullPointerException");
