...
public class Issue61FuncTest {
    ...
    @Test(timeout = 10000)
    public void testIssue_mg47() throws Exception {
        String __DSPOT_sName_13 = "{l>^r@)C1RND7C-6y}W`";
        final JCodeModel cm = new JCodeModel();
        final Charset ascii = Charset.forName("US-ASCII");
        final ByteArrayOutputStream resOut = new ByteArrayOutputStream();
        final JTextFile res = ((JTextFile) (cm.rootPackage().addResourceFile(new JTextFile("example.txt", ascii))));
        ...
        final String txtRes = ascii.decode(ByteBuffer.wrap(resOut.toByteArray())).toString();
        Assert.assertEquals("-----------------------------------example.txt-----------------------------------\nTesting", txtRes);
        boolean o_testIssue_mg47__23 = txtRes.contains("Testing");
        Assert.assertTrue(o_testIssue_mg47__23);
        JDirectClass o_testIssue_mg47__24 = cm.directClass(__DSPOT_sName_13);
        Assert.assertEquals(1147692126, ((int) (((JDirectClass) (o_testIssue_mg47__24)).hashCode())));
        Assert.assertFalse(((JDirectClass) (o_testIssue_mg47__24)).isAbstract());
        Assert.assertNull(((JDirectClass) (o_testIssue_mg47__24)).getOuter());
        Assert.assertFalse(((JDirectClass) (o_testIssue_mg47__24)).isAnnotationTypeDeclaration());
        Assert.assertFalse(((JDirectClass) (o_testIssue_mg47__24)).isAnonymous());
        Assert.assertTrue(((JDirectClass) (o_testIssue_mg47__24)).isClass());
        Assert.assertFalse(((JDirectClass) (o_testIssue_mg47__24)).isInterface());
        Assert.assertFalse(((JDirectClass) (o_testIssue_mg47__24)).isPackage());
        Assert.assertTrue(((Collection) (((JDirectClass) (o_testIssue_mg47__24)).getAllInnerClasses())).isEmpty());
        Assert.assertNull(((JDirectClass) (o_testIssue_mg47__24)).getPrimitiveType());
        Assert.assertFalse(((JDirectClass) (o_testIssue_mg47__24)).isParameterized());
        Assert.assertEquals("com.helger.jcodemodel.JDirectClass({l>^r@)C1RND7C-6y}W`)", ((JDirectClass) (o_testIssue_mg47__24)).toString());
        Assert.assertTrue(((Collection) (((JDirectClass) (o_testIssue_mg47__24)).getTypeParameters())).isEmpty());
        Assert.assertTrue(((JDirectClass) (o_testIssue_mg47__24)).isReference());
        Assert.assertFalse(((JDirectClass) (o_testIssue_mg47__24)).isArray());
        Assert.assertFalse(((JDirectClass) (o_testIssue_mg47__24)).isPrimitive());
        Assert.assertFalse(((JDirectClass) (o_testIssue_mg47__24)).isError());
        Assert.assertEquals("-----------------------------------example.txt-----------------------------------\nTesting", txtRes);
        Assert.assertTrue(o_testIssue_mg47__23);
    }
    ...
    @Test(timeout = 10000)
    public void testIssue_mg40_mg3738() throws Exception {
        String __DSPOT_sSubPackageName_1088 = "QcaKR}t@-}[H)Ae0uC={";
        String __DSPOT_sName_4 = "rb0/|]6^FT)-ef&bk*20";
        final JCodeModel cm = new JCodeModel();
        final Charset ascii = Charset.forName("US-ASCII");
        final ByteArrayOutputStream resOut = new ByteArrayOutputStream();
        ...
        boolean o_testIssue_mg40__23 = txtRes.contains("Testing");
        JPackage o_testIssue_mg40__24 = cm._package(__DSPOT_sName_4);
        JPackage o_testIssue_mg40_mg3738__30 = o_testIssue_mg40__24.subPackage(__DSPOT_sSubPackageName_1088);
        Assert.assertFalse(((JPackage) (o_testIssue_mg40_mg3738__30)).isUnnamed());
        Assert.assertFalse(((JPackage) (o_testIssue_mg40_mg3738__30)).isClass());
        Assert.assertTrue(((Collection) (((JPackage) (o_testIssue_mg40_mg3738__30)).getAllResourceFiles())).isEmpty());
        Assert.assertFalse(((JPackage) (((JPackage) (o_testIssue_mg40_mg3738__30)).getPackage())).isUnnamed());
        Assert.assertFalse(((JPackage) (((JPackage) (o_testIssue_mg40_mg3738__30)).getPackage())).isClass());
        Assert.assertTrue(((Collection) (((JPackage) (((JPackage) (o_testIssue_mg40_mg3738__30)).getPackage())).getAllResourceFiles())).isEmpty());
        Assert.assertFalse(((JPackage) (((JPackage) (((JPackage) (o_testIssue_mg40_mg3738__30)).getPackage())).getPackage())).isUnnamed());
        Assert.assertFalse(((JPackage) (((JPackage) (((JPackage) (o_testIssue_mg40_mg3738__30)).getPackage())).getPackage())).isClass());
        Assert.assertTrue(((Collection) (((JPackage) (((JPackage) (((JPackage) (o_testIssue_mg40_mg3738__30)).getPackage())).getPackage())).getAllResourceFiles())).isEmpty());
        Assert.assertTrue(((JPackage) (((JPackage) (((JPackage) (o_testIssue_mg40_mg3738__30)).getPackage())).getPackage())).isPackage());
        Assert.assertTrue(((JPackage) (((JPackage) (o_testIssue_mg40_mg3738__30)).getPackage())).isPackage());
        Assert.assertTrue(((JPackage) (o_testIssue_mg40_mg3738__30)).isPackage());
        Assert.assertEquals("-----------------------------------example.txt-----------------------------------\nTesting", txtRes);
    }

    @Test(timeout = 10000)
    public void testIssue_mg49_mg3971_failAssert0() throws Exception {
        try {
            ...
            o_testIssue_mg49__25._package();
            org.junit.Assert.fail("testIssue_mg49_mg3971 should have thrown JErrorClassUsedException");
