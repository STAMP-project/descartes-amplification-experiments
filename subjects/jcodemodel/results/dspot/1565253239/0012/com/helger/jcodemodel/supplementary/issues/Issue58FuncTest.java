...
public final class Issue58FuncTest {
    ...
    @Test(timeout = 10000)
    public void testIssue_mg59_mg14855_failAssert0() throws Exception {
        try {
            ...
            o_testIssue_mg59__12.elementType();
            org.junit.Assert.fail("testIssue_mg59_mg14855 should have thrown IllegalArgumentException");
        } catch (IllegalArgumentException expected) {
            Assert.assertEquals("Not an array type: xu", expected.getMessage());
        }
    }

    @Test(timeout = 10000)
    public void testIssue_mg67_mg9821_mg32322_failAssert0() throws Exception {
        try {
            Object __DSPOT_o_8767 = new Object();
            final JCodeModel generator = new JCodeModel();
            final JDefinedClass aClass = generator._class("test.Test");
            final JMethod aMethod = aClass.method(0, generator.VOID, "name");
            JVar o_testIssue_mg67__7 = aMethod.param(generator.ref("test.UnknownClass"), "p");
            JMethod o_testIssue_mg67__9 = aClass.getMethod("name", new AbstractJType[]{ generator.ref("test.UnknownClass") });
            Collection<JAnnotationUse> o_testIssue_mg67__11 = aClass.annotations();
            JDocComment o_testIssue_mg67_mg9821__18 = aClass.headerComment();
            o_testIssue_mg67_mg9821__18.append(__DSPOT_o_8767);
            org.junit.Assert.fail("testIssue_mg67_mg9821_mg32322 should have thrown IllegalArgumentException");
        } catch (IllegalArgumentException expected) {
