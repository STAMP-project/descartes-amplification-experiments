...
public final class JAnnotationUseTest {
    ...
    @Test(timeout = 10000)
    public void testPackageAnnotation_add2() throws Exception {
        final JCodeModel cm = new JCodeModel();
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllPackages())).isEmpty());
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
    ...
    @Test(timeout = 10000)
    public void testPackageAnnotation_rv54() throws Exception {
        int __DSPOT_nValue_42 = 1594241263;
        String __DSPOT_sName_41 = "uV!aV(v6Iw9b>c1NAnIw";
        final JCodeModel cm = new JCodeModel();
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllPackages())).isEmpty());
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        ...
        JAnnotationUse __DSPOT_invoc_3 = cm._package("foo").annotate(Inherited.class);
        CodeModelTestsHelper.parseCodeModel(cm);
        JAnnotationUse o_testPackageAnnotation_rv54__10 = __DSPOT_invoc_3.param(__DSPOT_sName_41, __DSPOT_nValue_42);
        Assert.assertNull(((AbstractJClass) (((JAnnotationUse) (o_testPackageAnnotation_rv54__10)).getAnnotationClass())).getPrimitiveType());
        Assert.assertTrue(((AbstractJClass) (((JAnnotationUse) (o_testPackageAnnotation_rv54__10)).getAnnotationClass())).getAllInnerClasses().isEmpty());
        Assert.assertFalse(((AbstractJClass) (((JAnnotationUse) (o_testPackageAnnotation_rv54__10)).getAnnotationClass())).isParameterized());
        Assert.assertEquals("com.helger.jcodemodel.JReferencedClass(java.lang.annotation.Inherited)", ((AbstractJClass) (((JAnnotationUse) (o_testPackageAnnotation_rv54__10)).getAnnotationClass())).toString());
        Assert.assertTrue(((AbstractJClass) (((JAnnotationUse) (o_testPackageAnnotation_rv54__10)).getAnnotationClass())).isInterface());
        Assert.assertTrue(((Collection) (((AbstractJClass) (((JAnnotationUse) (o_testPackageAnnotation_rv54__10)).getAnnotationClass())).getTypeParameters())).isEmpty());
        Assert.assertTrue(((AbstractJClass) (((JAnnotationUse) (o_testPackageAnnotation_rv54__10)).getAnnotationClass())).isAbstract());
        Assert.assertTrue(((AbstractJClass) (((JAnnotationUse) (o_testPackageAnnotation_rv54__10)).getAnnotationClass())).isReference());
        Assert.assertFalse(((AbstractJClass) (((JAnnotationUse) (o_testPackageAnnotation_rv54__10)).getAnnotationClass())).isArray());
        Assert.assertFalse(((AbstractJClass) (((JAnnotationUse) (o_testPackageAnnotation_rv54__10)).getAnnotationClass())).isPrimitive());
        Assert.assertFalse(((AbstractJClass) (((JAnnotationUse) (o_testPackageAnnotation_rv54__10)).getAnnotationClass())).isError());
        Assert.assertFalse(((JAnnotationUse) (o_testPackageAnnotation_rv54__10)).getAnnotationMembers().isEmpty());
        Assert.assertTrue(((JAnnotationUse) (o_testPackageAnnotation_rv54__10)).hasAnnotationMembers());
        Assert.assertFalse(((Collection) (((JCodeModel) (cm)).getAllPackages())).isEmpty());
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllDontImportClasses())).isEmpty());
    ...
    @Test(timeout = 10000)
    public void testPackageAnnotation_rv35_rv4146() throws Exception {
        AbstractJClass[] __DSPOT_aClazz_2957 = new AbstractJClass[]{  };
        final JCodeModel cm = new JCodeModel();
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllPackages())).isEmpty());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllDontImportClasses())).isEmpty());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        ...
        JAnnotationUse __DSPOT_invoc_3 = cm._package("foo").annotate(Inherited.class);
        CodeModelTestsHelper.parseCodeModel(cm);
        AbstractJClass __DSPOT_invoc_22 = __DSPOT_invoc_3.getAnnotationClass();
        AbstractJClass o_testPackageAnnotation_rv35_rv4146__12 = __DSPOT_invoc_22.narrow(__DSPOT_aClazz_2957);
        Assert.assertTrue(((JNarrowedClass) (o_testPackageAnnotation_rv35_rv4146__12)).isInterface());
        Assert.assertFalse(((JNarrowedClass) (o_testPackageAnnotation_rv35_rv4146__12)).isArray());
        Assert.assertTrue(((Collection) (((JNarrowedClass) (o_testPackageAnnotation_rv35_rv4146__12)).getTypeParameters())).isEmpty());
        Assert.assertTrue(((JNarrowedClass) (o_testPackageAnnotation_rv35_rv4146__12)).isAbstract());
        Assert.assertFalse(((JNarrowedClass) (o_testPackageAnnotation_rv35_rv4146__12)).isError());
        Assert.assertNull(((JNarrowedClass) (o_testPackageAnnotation_rv35_rv4146__12)).getPrimitiveType());
        Assert.assertTrue(((Collection) (((JNarrowedClass) (o_testPackageAnnotation_rv35_rv4146__12)).getAllInnerClasses())).isEmpty());
        Assert.assertTrue(((JNarrowedClass) (o_testPackageAnnotation_rv35_rv4146__12)).isParameterized());
        Assert.assertEquals("com.helger.jcodemodel.JNarrowedClass(java.lang.annotation.Inherited<>)", ((JNarrowedClass) (o_testPackageAnnotation_rv35_rv4146__12)).toString());
        Assert.assertTrue(((JNarrowedClass) (o_testPackageAnnotation_rv35_rv4146__12)).isReference());
        Assert.assertFalse(((JNarrowedClass) (o_testPackageAnnotation_rv35_rv4146__12)).isPrimitive());
        Assert.assertFalse(((Collection) (((JCodeModel) (cm)).getAllPackages())).isEmpty());
        Assert.assertTrue(((Collection) (((JCodeModel) (cm)).getAllDontImportClasses())).isEmpty());
        Assert.assertEquals("\n", ((JCodeModel) (cm)).getBuildingNewLine());
        Assert.assertNull(((JCodeModel) (cm)).getBuildingCharset());
    ...
    @Test(timeout = 10000)
    public void testPackageAnnotation_mg24_mg4050_failAssert0() throws Exception {
        try {
            String __DSPOT_sName_16 = "6y}W`_*s>).BmtV)2[ga";
            String __DSPOT_sMessage_15 = "L&q_{{l>^r@)C1RND7C-";
            final JCodeModel cm = new JCodeModel();
            ...
            CodeModelTestsHelper.parseCodeModel(cm);
            JErrorClass o_testPackageAnnotation_mg24__8 = cm.errorClass(__DSPOT_sMessage_15, __DSPOT_sName_16);
            o_testPackageAnnotation_mg24__8._extends();
            org.junit.Assert.fail("testPackageAnnotation_mg24_mg4050 should have thrown JErrorClassUsedException");
        } catch (JErrorClassUsedException expected) {
            Assert.assertEquals("L&q_{{l>^r@)C1RND7C-", expected.getMessage());
        }
    }

    @Test(timeout = 10000)
    public void testPackageAnnotation_rv72null7510_failAssert0() throws Exception {
        try {
            String[] __DSPOT_aValues_75 = new String[0];
            String __DSPOT_sName_74 = "xjff`y&R/x5,;cXLFumz";
            final JCodeModel cm = new JCodeModel();
            JAnnotationUse __DSPOT_invoc_3 = cm._package("foo").annotate(Inherited.class);
            CodeModelTestsHelper.parseCodeModel(cm);
            JAnnotationUse o_testPackageAnnotation_rv72__10 = __DSPOT_invoc_3.paramArray(null, __DSPOT_aValues_75);
            org.junit.Assert.fail("testPackageAnnotation_rv72null7510 should have thrown NullPointerException");
    ...
    @Test(timeout = 10000)
    public void testPackageAnnotation_mg23_mg3647_failAssert0() throws Exception {
        try {
            String __DSPOT_sMessage_14 = "VTx>DODA!L#vK5WR{oE1";
            final JCodeModel cm = new JCodeModel();
            JAnnotationUse o_testPackageAnnotation_mg23__4 = cm._package("foo").annotate(Inherited.class);
            CodeModelTestsHelper.parseCodeModel(cm);
            JErrorClass o_testPackageAnnotation_mg23__7 = cm.errorClass(__DSPOT_sMessage_14);
            o_testPackageAnnotation_mg23__7._package();
            org.junit.Assert.fail("testPackageAnnotation_mg23_mg3647 should have thrown JErrorClassUsedException");
        } catch (JErrorClassUsedException expected) {
