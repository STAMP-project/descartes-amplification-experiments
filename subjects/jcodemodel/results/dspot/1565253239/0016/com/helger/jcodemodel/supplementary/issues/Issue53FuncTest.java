...
public final class Issue53FuncTest {
    @Test(timeout = 10000)
    public void testIssue_literalMutationString121_failAssert0() throws Exception {
        try {
            ...
            {
                final JVar l1 = method.body().decl(generator.ref(Supplier.class).narrowAny(), "x1", JLambda.simple(JExpr._this().invoke("").invoke("andThen").arg(methodLambda)));
                final JLambda lambda = new JLambda();
                final JLambdaParam aParam = lambda.addParam("xx");
                lambda.body().lambdaExpr(aParam.invoke("getValueProvider").invoke("andThen").arg(methodLambda));
            ...
            org.junit.Assert.fail("testIssue_literalMutationString121 should have thrown ParseProblemException");
    ...
    @Test(timeout = 10000)
    public void testIssue_literalMutationString135_failAssert0_mg10241_failAssert0null28362_failAssert0() throws Exception {
        try {
            {
                {
                    final JCodeModel generator = new JCodeModel();
                ...
                org.junit.Assert.fail("testIssue_literalMutationString135_failAssert0_mg10241 should have thrown IllegalArgumentException");
            }
            org.junit.Assert.fail("testIssue_literalMutationString135_failAssert0_mg10241_failAssert0null28362 should have thrown NullPointerException");
