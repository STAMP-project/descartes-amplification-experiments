...
public final class AbstractJTypeTest {
    ...
    @Test(timeout = 10000)
    public void testIsAssignableFromRandomized_mg137() throws Exception {
        final JCodeModel codeModel = new JCodeModel();
        Assert.assertTrue(((Collection) (((JCodeModel) (codeModel)).getAllPackages())).isEmpty());
        Assert.assertNull(((JCodeModel) (codeModel)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (codeModel)).getBuildingNewLine());
        ...
        AbstractJClass o_testIsAssignableFromRandomized_mg137__70 = _List.narrowAny();
        Assert.assertTrue(((JNarrowedClass) (o_testIsAssignableFromRandomized_mg137__70)).isInterface());
        Assert.assertFalse(((JNarrowedClass) (o_testIsAssignableFromRandomized_mg137__70)).isArray());
        Assert.assertFalse(((Collection) (((JNarrowedClass) (o_testIsAssignableFromRandomized_mg137__70)).getTypeParameters())).isEmpty());
        Assert.assertTrue(((JNarrowedClass) (o_testIsAssignableFromRandomized_mg137__70)).isAbstract());
        Assert.assertFalse(((JNarrowedClass) (o_testIsAssignableFromRandomized_mg137__70)).isError());
        Assert.assertTrue(((JNarrowedClass) (o_testIsAssignableFromRandomized_mg137__70)).isParameterized());
        Assert.assertNull(((JNarrowedClass) (o_testIsAssignableFromRandomized_mg137__70)).getPrimitiveType());
        Assert.assertTrue(((Collection) (((JNarrowedClass) (o_testIsAssignableFromRandomized_mg137__70)).getAllInnerClasses())).isEmpty());
        Assert.assertEquals("com.helger.jcodemodel.JNarrowedClass(java.util.List<? extends java.lang.Object>)", ((JNarrowedClass) (o_testIsAssignableFromRandomized_mg137__70)).toString());
        Assert.assertTrue(((JNarrowedClass) (o_testIsAssignableFromRandomized_mg137__70)).isReference());
        Assert.assertFalse(((JNarrowedClass) (o_testIsAssignableFromRandomized_mg137__70)).isPrimitive());
        Assert.assertTrue(((Collection) (((JCodeModel) (codeModel)).getAllPackages())).isEmpty());
        Assert.assertNull(((JCodeModel) (codeModel)).getBuildingCharset());
        Assert.assertEquals("\n", ((JCodeModel) (codeModel)).getBuildingNewLine());
        Assert.assertTrue(((Collection) (((JCodeModel) (codeModel)).getAllDontImportClasses())).isEmpty());
