...
public final class JDirectClassTest {
    ...
    public void testBasic_rv273_failAssert0() throws Exception {
        try {
            ...
            org.junit.Assert.fail("testBasic_rv273 should have thrown ArrayIndexOutOfBoundsException");
        } catch (ArrayIndexOutOfBoundsException expected) {
            Assert.assertEquals("-636981950", expected.getMessage());
        }
    }

    @Test(timeout = 10000)
    public void testBasic_literalMutationString102_failAssert0() throws Exception {
        try {
            final JCodeModel cm = new JCodeModel();
            final JDirectClass rClassId = cm.directClass("id.aa.R")._class("id");
            rClassId.name();
            ...
            final JMethod aMethodSelected = aClassAct.method(JMod.PUBLIC, cm.BOOLEAN, "onOptionsItemSelected");
            aMethodSelected.body()._if(JExpr.ref(" V!3a(!").eq(myItem));
            CodeModelTestsHelper.parseCodeModel(cm);
            org.junit.Assert.fail("testBasic_literalMutationString102 should have thrown ParseProblemException");
    ...
    @Test(timeout = 10000)
    public void testBasic_rv271() throws Exception {
        final JCodeModel cm = new JCodeModel();
        ...
        Assert.assertEquals(1, ((int) (o_testBasic_rv271__41)));
