...
public class HtmlParserTest {
    ...
    @Test(timeout = 10000)
    public void handlesSpanInTbody_add4() throws Exception {
        String h = "<table><tbody><span class='1'><tr><td>One</td></tr><tr><td>Two</td></tr></span></tbody></table>";
        Document doc = Jsoup.parse(h);
        Element o_handlesSpanInTbody_add4__5 = doc.select("span").first();
        Assert.assertFalse(((Element) (o_handlesSpanInTbody_add4__5)).isBlock());
        Assert.assertFalse(((Collection) (((Element) (o_handlesSpanInTbody_add4__5)).getAllElements())).isEmpty());
        Assert.assertFalse(((Element) (o_handlesSpanInTbody_add4__5)).hasText());
        Assert.assertTrue(((Element) (o_handlesSpanInTbody_add4__5)).hasParent());
        int o_handlesSpanInTbody_add4__7 = doc.select("span").first().children().size();
        Assert.assertEquals(0, ((int) (o_handlesSpanInTbody_add4__7)));
        int o_handlesSpanInTbody_add4__11 = doc.select("table").size();
        Assert.assertEquals(1, ((int) (o_handlesSpanInTbody_add4__11)));
        Assert.assertFalse(((Element) (o_handlesSpanInTbody_add4__5)).isBlock());
        Assert.assertFalse(((Collection) (((Element) (o_handlesSpanInTbody_add4__5)).getAllElements())).isEmpty());
        Assert.assertFalse(((Element) (o_handlesSpanInTbody_add4__5)).hasText());
        Assert.assertTrue(((Element) (o_handlesSpanInTbody_add4__5)).hasParent());
    ...
    @Test(timeout = 10000)
    public void handlesSpanInTbody_literalMutationString9_mg991_mg14851() throws Exception {
        int __DSPOT_maxErrors_4185 = 218250256;
        ...
        Parser o_handlesSpanInTbody_literalMutationString9_mg991__15 = doc.parser();
        Assert.assertFalse(((Parser) (o_handlesSpanInTbody_literalMutationString9_mg991__15)).isTrackErrors());
        Assert.assertTrue(((Collection) (((Parser) (o_handlesSpanInTbody_literalMutationString9_mg991__15)).getErrors())).isEmpty());
        Parser o_handlesSpanInTbody_literalMutationString9_mg991_mg14851__19 = o_handlesSpanInTbody_literalMutationString9_mg991__15.setTrackErrors(__DSPOT_maxErrors_4185);
        Assert.assertTrue(((Parser) (o_handlesSpanInTbody_literalMutationString9_mg991_mg14851__19)).isTrackErrors());
        Assert.assertTrue(((Collection) (((Parser) (o_handlesSpanInTbody_literalMutationString9_mg991_mg14851__19)).getErrors())).isEmpty());
        Assert.assertTrue(((Parser) (o_handlesSpanInTbody_literalMutationString9_mg991__15)).isTrackErrors());
        Assert.assertTrue(((Collection) (((Parser) (o_handlesSpanInTbody_literalMutationString9_mg991__15)).getErrors())).isEmpty());
    }
}
