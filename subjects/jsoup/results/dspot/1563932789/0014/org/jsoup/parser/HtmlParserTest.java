...
public class HtmlParserTest {
    ...
    @Test(timeout = 10000)
    public void tracksLimitedErrorsWhenRequested_literalMutationString14_literalMutationString5501_failAssert0() throws Exception {
        try {
            String html = "><(;FkQj(!%3b`58ZE3#sHdd*?(,MAonC[6(hnhqK2v/<C*&?]6}7rckzfmb2";
            Parser parser = Parser.htmlParser().setTrackErrors(3);
            Document doc = parser.parseInput(html, "http://example.com");
            List<ParseError> errors = parser.getErrors();
            int o_tracksLimitedErrorsWhenRequested_literalMutationString14__9 = errors.size();
            errors.get(0).toString();
            errors.get(1).toString();
            errors.get(2).toString();
            org.junit.Assert.fail("tracksLimitedErrorsWhenRequested_literalMutationString14_literalMutationString5501 should have thrown IndexOutOfBoundsException");
        } catch (IndexOutOfBoundsException expected) {
            Assert.assertEquals("Index 2 out of bounds for length 2", expected.getMessage());
        }
    }
}
