...
public class NodeTest {
    ...
    @Test(timeout = 10000)
    public void orphanNodeReturnsNullForSiblingElements_mg57() throws Exception {
        Element __DSPOT_parent_18 = new Element("^r,Jp9Flz5*yC=M]:bMo");
        Node node = new Element(Tag.valueOf("p"), "");
        Assert.assertFalse(((Collection) (((Element) (node)).getAllElements())).isEmpty());
        Assert.assertFalse(((Element) (node)).hasText());
        Assert.assertTrue(((Element) (node)).isBlock());
        ...
        Assert.assertTrue(((Element) (el)).isBlock());
        Assert.assertFalse(((Element) (el)).hasParent());
        int o_orphanNodeReturnsNullForSiblingElements_mg57__9 = node.siblingIndex();
        Assert.assertEquals(0, ((int) (o_orphanNodeReturnsNullForSiblingElements_mg57__9)));
        int o_orphanNodeReturnsNullForSiblingElements_mg57__10 = node.siblingNodes().size();
        Assert.assertEquals(0, ((int) (o_orphanNodeReturnsNullForSiblingElements_mg57__10)));
        Node o_orphanNodeReturnsNullForSiblingElements_mg57__12 = node.previousSibling();
        Assert.assertNull(o_orphanNodeReturnsNullForSiblingElements_mg57__12);
        Node o_orphanNodeReturnsNullForSiblingElements_mg57__13 = node.nextSibling();
        Assert.assertNull(o_orphanNodeReturnsNullForSiblingElements_mg57__13);
        int o_orphanNodeReturnsNullForSiblingElements_mg57__14 = el.siblingElements().size();
        Assert.assertEquals(0, ((int) (o_orphanNodeReturnsNullForSiblingElements_mg57__14)));
        Element o_orphanNodeReturnsNullForSiblingElements_mg57__16 = el.previousElementSibling();
        Assert.assertNull(o_orphanNodeReturnsNullForSiblingElements_mg57__16);
        Element o_orphanNodeReturnsNullForSiblingElements_mg57__17 = el.nextElementSibling();
        Assert.assertNull(o_orphanNodeReturnsNullForSiblingElements_mg57__17);
        Element o_orphanNodeReturnsNullForSiblingElements_mg57__18 = el.appendTo(__DSPOT_parent_18);
        Assert.assertFalse(((Collection) (((Element) (o_orphanNodeReturnsNullForSiblingElements_mg57__18)).getAllElements())).isEmpty());
        Assert.assertFalse(((Element) (o_orphanNodeReturnsNullForSiblingElements_mg57__18)).hasText());
        Assert.assertTrue(((Element) (o_orphanNodeReturnsNullForSiblingElements_mg57__18)).isBlock());
        Assert.assertTrue(((Element) (o_orphanNodeReturnsNullForSiblingElements_mg57__18)).hasParent());
        Assert.assertFalse(((Collection) (((Element) (node)).getAllElements())).isEmpty());
        Assert.assertFalse(((Element) (node)).hasText());
        Assert.assertTrue(((Element) (node)).isBlock());
        Assert.assertFalse(((Element) (node)).hasParent());
        ...
        Assert.assertFalse(((Element) (el)).hasText());
        Assert.assertTrue(((Element) (el)).isBlock());
        Assert.assertTrue(((Element) (el)).hasParent());
        Assert.assertEquals(0, ((int) (o_orphanNodeReturnsNullForSiblingElements_mg57__9)));
        Assert.assertEquals(0, ((int) (o_orphanNodeReturnsNullForSiblingElements_mg57__10)));
        Assert.assertNull(o_orphanNodeReturnsNullForSiblingElements_mg57__12);
        Assert.assertNull(o_orphanNodeReturnsNullForSiblingElements_mg57__13);
