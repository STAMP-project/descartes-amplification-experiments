...
public class TextNodeTest {
    ...
    @Test(timeout = 10000)
    public void testSplitAnEmbolden_mg129_mg38836() throws Exception {
        String __DSPOT_regex_14694 = "-*%&l ]+A&I+#Zn8q2GF";
        Document doc = Jsoup.parse("<div>Hello there</div>");
        Assert.assertFalse(((Collection) (((Document) (doc)).getAllElements())).isEmpty());
        Assert.assertTrue(((Document) (doc)).hasText());
        Assert.assertFalse(((Document) (doc)).isBlock());
        ...
        Assert.assertEquals("there", ((TextNode) (tail)).toString());
        Assert.assertTrue(((TextNode) (tail)).hasParent());
        Node o_testSplitAnEmbolden_mg129__10 = tail.wrap("<b></b>");
        Assert.assertFalse(((TextNode) (o_testSplitAnEmbolden_mg129__10)).isBlank());
        Assert.assertEquals("there", ((TextNode) (o_testSplitAnEmbolden_mg129__10)).getWholeText());
        Assert.assertEquals("there", ((TextNode) (o_testSplitAnEmbolden_mg129__10)).toString());
        Assert.assertTrue(((TextNode) (o_testSplitAnEmbolden_mg129__10)).hasParent());
        TextUtil.stripNewlines(div.html());
        String o_testSplitAnEmbolden_mg129__13 = div.val();
        Assert.assertEquals("", o_testSplitAnEmbolden_mg129__13);
        Elements o_testSplitAnEmbolden_mg129_mg38836__19 = div.getElementsMatchingOwnText(__DSPOT_regex_14694);
        Assert.assertTrue(o_testSplitAnEmbolden_mg129_mg38836__19.isEmpty());
        Assert.assertFalse(((Collection) (((Document) (doc)).getAllElements())).isEmpty());
        Assert.assertTrue(((Document) (doc)).hasText());
        Assert.assertFalse(((Document) (doc)).isBlock());
        Assert.assertFalse(((Document) (doc)).hasParent());
