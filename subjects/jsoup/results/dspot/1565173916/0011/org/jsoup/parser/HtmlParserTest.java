...
public class HtmlParserTest {
    ...
    @Test(timeout = 10000)
    public void testSelectWithOption_mg33_mg3754() throws Exception {
        String __DSPOT_keyPrefix_1093 = "?vDm:3]o-BXOtJfk44Bk";
        ...
        Elements o_testSelectWithOption_mg33_mg3754__17 = o_testSelectWithOption_mg33__9.getElementsByAttributeStarting(__DSPOT_keyPrefix_1093);
        Assert.assertTrue(o_testSelectWithOption_mg33_mg3754__17.isEmpty());
        Assert.assertTrue(((Collection) (((Parser) (parser)).getErrors())).isEmpty());
        Assert.assertTrue(((Parser) (parser)).isTrackErrors());
        Assert.assertTrue(((Collection) (((Parser) (o_testSelectWithOption_mg33__4)).getErrors())).isEmpty());
        Assert.assertTrue(((Parser) (o_testSelectWithOption_mg33__4)).isTrackErrors());
    ...
    @Test(timeout = 10000)
    public void testSelectWithOption_mg43_mg3934() throws Exception {
        String __DSPOT_searchText_1193 = "Rcpd!pP}@g/WJu4%q8 3";
        ...
        Elements o_testSelectWithOption_mg43_mg3934__17 = o_testSelectWithOption_mg43__9.getElementsContainingText(__DSPOT_searchText_1193);
        Assert.assertTrue(o_testSelectWithOption_mg43_mg3934__17.isEmpty());
        Assert.assertTrue(((Collection) (((Parser) (parser)).getErrors())).isEmpty());
        Assert.assertTrue(((Parser) (parser)).isTrackErrors());
        Assert.assertTrue(((Collection) (((Parser) (o_testSelectWithOption_mg43__4)).getErrors())).isEmpty());
        Assert.assertTrue(((Parser) (o_testSelectWithOption_mg43__4)).isTrackErrors());
    ...
    @Test(timeout = 10000)
    public void testSelectWithOption_rv54_mg1020_failAssert0() throws Exception {
        try {
            String __DSPOT_regex_248 = "9#Fc@aj6MF5:6[z{Ik(w";
            String __DSPOT_baseUri_14 = "@T5!^MYU(dM7KJ&><6yc";
            Element __DSPOT_context_13 = new Element("5_w)+KtmI6N*:lKC*+{5");
            String __DSPOT_fragment_12 = "Q7-#sa<}t>?]?7gchsEp";
            Parser parser = Parser.htmlParser();
            ...
            int o_testSelectWithOption_rv54__12 = parser.getErrors().size();
            List<Node> o_testSelectWithOption_rv54__14 = __DSPOT_invoc_3.parseFragmentInput(__DSPOT_fragment_12, __DSPOT_context_13, __DSPOT_baseUri_14);
            __DSPOT_context_13.getElementsMatchingOwnText(__DSPOT_regex_248);
            org.junit.Assert.fail("testSelectWithOption_rv54_mg1020 should have thrown IllegalArgumentException");
        } catch (IllegalArgumentException expected) {
        }
    }

    @Test(timeout = 10000)
    public void testSelectWithOption_mg25_mg2328() throws Exception {
        String __DSPOT_searchText_649 = "/0y<!DT{at1!DzhBA^q ";
        ...
        Elements o_testSelectWithOption_mg25_mg2328__20 = __DSPOT_context_1.getElementsContainingOwnText(__DSPOT_searchText_649);
        Assert.assertTrue(o_testSelectWithOption_mg25_mg2328__20.isEmpty());
        Assert.assertTrue(((Collection) (((Parser) (parser)).getErrors())).isEmpty());
        Assert.assertTrue(((Parser) (parser)).isTrackErrors());
        Assert.assertTrue(((Collection) (((Parser) (o_testSelectWithOption_mg25__7)).getErrors())).isEmpty());
        Assert.assertTrue(((Parser) (o_testSelectWithOption_mg25__7)).isTrackErrors());
