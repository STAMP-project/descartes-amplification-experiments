...
public class TextNodeTest {
    ...
    @Test(timeout = 10000)
    public void testSplitAnEmbolden_rv162_mg17950() throws Exception {
        Document doc = Jsoup.parse("<div>Hello there</div>");
        Assert.assertTrue(((Document) (doc)).hasText());
        Assert.assertFalse(((Document) (doc)).isBlock());
        Assert.assertFalse(((Collection) (((Document) (doc)).getAllElements())).isEmpty());
        ...
        Node __DSPOT_invoc_10 = tail.wrap("<b></b>");
        TextUtil.stripNewlines(div.html());
        Node o_testSplitAnEmbolden_rv162__15 = __DSPOT_invoc_10.parent();
        Assert.assertTrue(((Element) (o_testSplitAnEmbolden_rv162__15)).hasText());
        Assert.assertFalse(((Element) (o_testSplitAnEmbolden_rv162__15)).isBlock());
        Assert.assertFalse(((Collection) (((Element) (o_testSplitAnEmbolden_rv162__15)).getAllElements())).isEmpty());
        Assert.assertTrue(((Element) (o_testSplitAnEmbolden_rv162__15)).hasParent());
        Node o_testSplitAnEmbolden_rv162_mg17950__18 = o_testSplitAnEmbolden_rv162__15.previousSibling();
        Assert.assertFalse(((TextNode) (o_testSplitAnEmbolden_rv162_mg17950__18)).isBlank());
        Assert.assertEquals("Hello ", ((TextNode) (o_testSplitAnEmbolden_rv162_mg17950__18)).getWholeText());
        Assert.assertEquals("\nHello ", ((TextNode) (o_testSplitAnEmbolden_rv162_mg17950__18)).toString());
        Assert.assertTrue(((TextNode) (o_testSplitAnEmbolden_rv162_mg17950__18)).hasParent());
        Assert.assertTrue(((Document) (doc)).hasText());
        Assert.assertFalse(((Document) (doc)).isBlock());
        Assert.assertFalse(((Collection) (((Document) (doc)).getAllElements())).isEmpty());
        Assert.assertFalse(((Document) (doc)).hasParent());
