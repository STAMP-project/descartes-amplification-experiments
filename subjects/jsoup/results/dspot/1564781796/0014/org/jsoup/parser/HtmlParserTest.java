...
public class HtmlParserTest {
    ...
    @Test(timeout = 10000)
    public void tracksLimitedErrorsWhenRequested_mg47() throws Exception {
        int __DSPOT_maxErrors_5 = -888898802;
        String html = "<p>One</p href='no'><!DOCTYPE html>&arrgh;<font /><br /><foo";
        Parser parser = Parser.htmlParser().setTrackErrors(3);
        Assert.assertTrue(((Parser) (parser)).isTrackErrors());
        Assert.assertTrue(((Collection) (((Parser) (parser)).getErrors())).isEmpty());
        Document doc = parser.parseInput(html, "http://example.com");
        List<ParseError> errors = parser.getErrors();
        int o_tracksLimitedErrorsWhenRequested_mg47__10 = errors.size();
        Assert.assertEquals(3, ((int) (o_tracksLimitedErrorsWhenRequested_mg47__10)));
        errors.get(0).toString();
        errors.get(1).toString();
        errors.get(2).toString();
        Parser o_tracksLimitedErrorsWhenRequested_mg47__17 = parser.setTrackErrors(__DSPOT_maxErrors_5);
        Assert.assertFalse(((Parser) (o_tracksLimitedErrorsWhenRequested_mg47__17)).isTrackErrors());
        Assert.assertTrue(((Collection) (((Parser) (o_tracksLimitedErrorsWhenRequested_mg47__17)).getErrors())).isEmpty());
    ...
    @Test(timeout = 10000)
    public void tracksLimitedErrorsWhenRequested_mg45_mg5682() throws Exception {
        String __DSPOT_searchText_1005 = ").8Wk6SVAo+!4r>0!aCV";
        String __DSPOT_baseUri_2 = "bk*201yCi*OdwpauR%h1";
        Element __DSPOT_context_1 = new Element("g[?i!rb0/|]6^FT)-ef&");
        String __DSPOT_fragment_0 = "O/woO!OKS@Rl&{ha!&Bc";
        String html = "<p>One</p href='no'><!DOCTYPE html>&arrgh;<font /><br /><foo";
        Parser parser = Parser.htmlParser().setTrackErrors(3);
        Assert.assertTrue(((Collection) (((Parser) (parser)).getErrors())).isEmpty());
        Assert.assertTrue(((Parser) (parser)).isTrackErrors());
        Document doc = parser.parseInput(html, "http://example.com");
        List<ParseError> errors = parser.getErrors();
        int o_tracksLimitedErrorsWhenRequested_mg45__13 = errors.size();
        errors.get(0).toString();
        errors.get(1).toString();
        errors.get(2).toString();
        List<Node> o_tracksLimitedErrorsWhenRequested_mg45__20 = parser.parseFragmentInput(__DSPOT_fragment_0, __DSPOT_context_1, __DSPOT_baseUri_2);
        Elements o_tracksLimitedErrorsWhenRequested_mg45_mg5682__26 = __DSPOT_context_1.getElementsContainingText(__DSPOT_searchText_1005);
        Assert.assertTrue(o_tracksLimitedErrorsWhenRequested_mg45_mg5682__26.isEmpty());
        Assert.assertFalse(((Collection) (((Parser) (parser)).getErrors())).isEmpty());
        Assert.assertTrue(((Parser) (parser)).isTrackErrors());
    }
}
