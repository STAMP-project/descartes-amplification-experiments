...
public class SelectorTest {
    ...
    @Test(timeout = 10000)
    public void testPseudoLessThan_mg70() throws Exception {
        Document doc = Jsoup.parse("<div><p>One</p><p>Two</p><p>Three</>p></div><div><p>Four</p>");
        Elements ps = doc.select("div p:lt(2)");
        Assert.assertFalse(ps.isEmpty());
        int o_testPseudoLessThan_mg70__5 = ps.size();
        Assert.assertEquals(3, ((int) (o_testPseudoLessThan_mg70__5)));
        String o_testPseudoLessThan_mg70__6 = ps.get(0).text();
        Assert.assertEquals("One", o_testPseudoLessThan_mg70__6);
        String o_testPseudoLessThan_mg70__8 = ps.get(1).text();
        Assert.assertEquals("Two", o_testPseudoLessThan_mg70__8);
        String o_testPseudoLessThan_mg70__10 = ps.get(2).text();
        Assert.assertEquals("Four", o_testPseudoLessThan_mg70__10);
        Element o_testPseudoLessThan_mg70__12 = ps.last();
        Assert.assertTrue(((Element) (o_testPseudoLessThan_mg70__12)).isBlock());
        Assert.assertFalse(((Collection) (((Element) (o_testPseudoLessThan_mg70__12)).getAllElements())).isEmpty());
        Assert.assertTrue(((Element) (o_testPseudoLessThan_mg70__12)).hasText());
        Assert.assertTrue(((Element) (o_testPseudoLessThan_mg70__12)).hasParent());
        Assert.assertFalse(ps.isEmpty());
        Assert.assertEquals(3, ((int) (o_testPseudoLessThan_mg70__5)));
        Assert.assertEquals("One", o_testPseudoLessThan_mg70__6);
        Assert.assertEquals("Two", o_testPseudoLessThan_mg70__8);
