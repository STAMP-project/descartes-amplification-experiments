...
public class HtmlParserTest {
    ...
    @Test(timeout = 10000)
    public void tracksLimitedErrorsWhenRequested_mg63_mg3764() throws Exception {
        String __DSPOT_regex_618 = "4D=fN6wf=/#,GA4F?C-?";
        ...
        Elements o_tracksLimitedErrorsWhenRequested_mg63_mg3764__23 = o_tracksLimitedErrorsWhenRequested_mg63__17.getElementsMatchingText(__DSPOT_regex_618);
        Assert.assertTrue(o_tracksLimitedErrorsWhenRequested_mg63_mg3764__23.isEmpty());
        Assert.assertFalse(((Collection) (((Parser) (parser)).getErrors())).isEmpty());
        Assert.assertTrue(((Parser) (parser)).isTrackErrors());
    }

    @Test(timeout = 10000)
    public void tracksLimitedErrorsWhenRequested_mg63_mg3740() throws Exception {
        String __DSPOT_searchText_614 = "5aIuT;Sr (_<SNMpn7@)";
        String __DSPOT_text_9 = "_83OI`-k-a8(J8Bp[$Xd";
        String html = "<p>One</p href='no'><!DOCTYPE html>&arrgh;<font /><br /><foo";
        Parser parser = Parser.htmlParser().setTrackErrors(3);
        Assert.assertTrue(((Collection) (((Parser) (parser)).getErrors())).isEmpty());
        ...
        errors.get(2).toString();
        Element o_tracksLimitedErrorsWhenRequested_mg63__17 = doc.text(__DSPOT_text_9);
        Elements o_tracksLimitedErrorsWhenRequested_mg63_mg3740__23 = o_tracksLimitedErrorsWhenRequested_mg63__17.getElementsContainingOwnText(__DSPOT_searchText_614);
        Assert.assertTrue(o_tracksLimitedErrorsWhenRequested_mg63_mg3740__23.isEmpty());
        Assert.assertFalse(((Collection) (((Parser) (parser)).getErrors())).isEmpty());
        Assert.assertTrue(((Parser) (parser)).isTrackErrors());
    }
}
