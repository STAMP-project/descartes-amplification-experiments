...
public class SelectorTest {
    ...
    @Test(timeout = 10000)
    public void multiChildDescent_add5() throws Exception {
        ...
        int o_multiChildDescent_add5__6 = els.size();
        Assert.assertEquals(1, ((int) (o_multiChildDescent_add5__6)));
        Element o_multiChildDescent_add5__7 = els.first();
        Assert.assertFalse(((Element) (o_multiChildDescent_add5__7)).isBlock());
        Assert.assertFalse(((Collection) (((Element) (o_multiChildDescent_add5__7)).getAllElements())).isEmpty());
        Assert.assertTrue(((Element) (o_multiChildDescent_add5__7)).hasText());
        Assert.assertTrue(((Element) (o_multiChildDescent_add5__7)).hasParent());
        String o_multiChildDescent_add5__8 = els.first().tagName();
        Assert.assertEquals("a", o_multiChildDescent_add5__8);
        Assert.assertFalse(els.isEmpty());
        Assert.assertEquals(1, ((int) (o_multiChildDescent_add5__6)));
        Assert.assertFalse(((Element) (o_multiChildDescent_add5__7)).isBlock());
        Assert.assertFalse(((Collection) (((Element) (o_multiChildDescent_add5__7)).getAllElements())).isEmpty());
