...
public class XmlTreeBuilderTest {
    ...
    @Test(timeout = 10000)
    public void testCommentAndDocType_mg23_mg1230() throws Exception {
        String xml = "<!DOCTYPE HTML><!-- a comment -->One <qux />Two";
        XmlTreeBuilder tb = new XmlTreeBuilder();
        Document doc = tb.parse(xml, "http://foo.com/");
        TextUtil.stripNewlines(doc.html());
        Document o_testCommentAndDocType_mg23__8 = doc.normalise();
        Element o_testCommentAndDocType_mg23_mg1230__11 = doc.head();
        Assert.assertFalse(((Element) (o_testCommentAndDocType_mg23_mg1230__11)).hasText());
        Assert.assertTrue(((Element) (o_testCommentAndDocType_mg23_mg1230__11)).isBlock());
        Assert.assertFalse(((Collection) (((Element) (o_testCommentAndDocType_mg23_mg1230__11)).getAllElements())).isEmpty());
        Assert.assertTrue(((Element) (o_testCommentAndDocType_mg23_mg1230__11)).hasParent());
    }
