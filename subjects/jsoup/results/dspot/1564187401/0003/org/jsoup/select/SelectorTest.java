...
public class SelectorTest {
    ...
    @Test(timeout = 10000)
    public void multiChildDescent_mg54() throws Exception {
        ...
        Assert.assertEquals(1, ((int) (o_multiChildDescent_mg54__6)));
        ...
        Assert.assertFalse(((Element) (o_multiChildDescent_mg54__9)).isBlock());
        Assert.assertFalse(((Collection) (((Element) (o_multiChildDescent_mg54__9)).getAllElements())).isEmpty());
        Assert.assertTrue(((Element) (o_multiChildDescent_mg54__9)).hasText());
        Assert.assertTrue(((Element) (o_multiChildDescent_mg54__9)).hasParent());
        Assert.assertFalse(els.isEmpty());
        Assert.assertEquals(1, ((int) (o_multiChildDescent_mg54__6)));
        Assert.assertEquals("a", o_multiChildDescent_mg54__7);
    }
