...
public class XmlTreeBuilderTest {
    ...
    @Test(timeout = 10000)
    public void testPopToClose_mg19_mg1092() throws Exception {
        Element __DSPOT_parent_276 = new Element("w#b@ByP.bRrDAE !rxKQ");
        ...
        Element o_testPopToClose_mg19_mg1092__15 = o_testPopToClose_mg19__10.appendTo(__DSPOT_parent_276);
        Assert.assertFalse(((Element) (o_testPopToClose_mg19_mg1092__15)).isBlock());
        Assert.assertFalse(((Collection) (((Element) (o_testPopToClose_mg19_mg1092__15)).getAllElements())).isEmpty());
        Assert.assertFalse(((Element) (o_testPopToClose_mg19_mg1092__15)).hasText());
        Assert.assertTrue(((Element) (o_testPopToClose_mg19_mg1092__15)).hasParent());
    }
