...
public class HtmlParserTest {
    ...
    @Test(timeout = 10000)
    public void handleNullContextInParseFragment_literalMutationNumber21_failAssert0_literalMutationNumber716_failAssert0() throws Exception {
        try {
            {
                String html = "<ol><li>One</li></ol><p>Two</p>";
                List<Node> nodes = Parser.parseFragment(html, null, "http://example.com/");
                ...
                org.junit.Assert.fail("handleNullContextInParseFragment_literalMutationNumber21 should have thrown ArrayIndexOutOfBoundsException");
            }
            org.junit.Assert.fail("handleNullContextInParseFragment_literalMutationNumber21_failAssert0_literalMutationNumber716 should have thrown ArrayIndexOutOfBoundsException");
