...
public class TextNodeTest {
    ...
    @Test(timeout = 10000)
    public void testSplitAnEmbolden_mg59_mg14788() throws Exception {
        String __DSPOT_regex_5713 = "d?PpY_%g*R5DPEpT.S p";
        String __DSPOT_key_5712 = "T0Jx,|L>lTGNB&?GY{j#";
        String __DSPOT_text_9 = ">YSe|%xHdm7#=ToX)D7x";
        Document doc = Jsoup.parse("<div>Hello there</div>");
        Assert.assertFalse(((Collection) (((Document) (doc)).getAllElements())).isEmpty());
        Assert.assertFalse(((Document) (doc)).isBlock());
        Assert.assertTrue(((Document) (doc)).hasText());
        ...
        Assert.assertEquals("there", ((TextNode) (tail)).toString());
        Assert.assertTrue(((TextNode) (tail)).hasParent());
        Node o_testSplitAnEmbolden_mg59__11 = tail.wrap("<b></b>");
        Assert.assertFalse(((TextNode) (o_testSplitAnEmbolden_mg59__11)).isBlank());
        Assert.assertEquals("there", ((TextNode) (o_testSplitAnEmbolden_mg59__11)).getWholeText());
        Assert.assertEquals("there", ((TextNode) (o_testSplitAnEmbolden_mg59__11)).toString());
        Assert.assertTrue(((TextNode) (o_testSplitAnEmbolden_mg59__11)).hasParent());
        TextUtil.stripNewlines(div.html());
        Element o_testSplitAnEmbolden_mg59__14 = div.appendText(__DSPOT_text_9);
        Assert.assertFalse(((Collection) (((Element) (o_testSplitAnEmbolden_mg59__14)).getAllElements())).isEmpty());
        Assert.assertTrue(((Element) (o_testSplitAnEmbolden_mg59__14)).isBlock());
        Assert.assertTrue(((Element) (o_testSplitAnEmbolden_mg59__14)).hasText());
        Assert.assertTrue(((Element) (o_testSplitAnEmbolden_mg59__14)).hasParent());
        Assert.assertEquals("<div>\n Hello \n <b>there</b>&gt;YSe|%xHdm7#=ToX)D7x\n</div>", ((Element) (o_testSplitAnEmbolden_mg59__14)).toString());
        Elements o_testSplitAnEmbolden_mg59_mg14788__21 = o_testSplitAnEmbolden_mg59__14.getElementsByAttributeValueMatching(__DSPOT_key_5712, __DSPOT_regex_5713);
        Assert.assertTrue(o_testSplitAnEmbolden_mg59_mg14788__21.isEmpty());
        Assert.assertFalse(((Collection) (((Document) (doc)).getAllElements())).isEmpty());
        Assert.assertFalse(((Document) (doc)).isBlock());
        Assert.assertTrue(((Document) (doc)).hasText());
        Assert.assertFalse(((Document) (doc)).hasParent());
