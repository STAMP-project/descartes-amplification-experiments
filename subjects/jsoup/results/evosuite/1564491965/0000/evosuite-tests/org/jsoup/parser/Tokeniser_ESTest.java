...
public class Tokeniser_ESTest extends Tokeniser_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      CharacterReader characterReader0 = new CharacterReader("l~7_`wQ69S");
      ParseErrorList parseErrorList0 = new ParseErrorList(1567, 1567);
  ...
  public void test2()  throws Throwable  {
      ...
      CharacterReader characterReader0 = new CharacterReader(stringReader0);
      ParseErrorList parseErrorList0 = new ParseErrorList(29, (-3790));
      Tokeniser tokeniser0 = new Tokeniser(characterReader0, parseErrorList0);
