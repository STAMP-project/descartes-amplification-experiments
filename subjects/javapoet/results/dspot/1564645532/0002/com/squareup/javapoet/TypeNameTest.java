...
public class TypeNameTest {
    ...
    @Test(timeout = 10000)
    public void genericType_rv82() throws Exception {
        Method recursiveEnum = getClass().getDeclaredMethod("generic", Enum[].class);
        TypeName o_genericType_rv82__4 = TypeName.get(recursiveEnum.getReturnType());
        Truth.assertThat(((ClassName) (o_genericType_rv82__4)).isAnnotated()).isFalse();
        Truth.assertThat(((ClassName) (o_genericType_rv82__4)).toString()).isEqualTo("java.lang.Enum");
        Truth.assertThat(((int) (((ClassName) (o_genericType_rv82__4)).hashCode()))).isEqualTo(398585941);
        Truth.assertThat(((ClassName) (o_genericType_rv82__4)).isPrimitive()).isFalse();
        Truth.assertThat(((ClassName) (o_genericType_rv82__4)).isBoxedPrimitive()).isFalse();
        TypeName o_genericType_rv82__6 = TypeName.get(recursiveEnum.getGenericReturnType());
        Truth.assertThat(((TypeVariableName) (o_genericType_rv82__6)).toString()).isEqualTo("E");
        Truth.assertThat(((int) (((TypeVariableName) (o_genericType_rv82__6)).hashCode()))).isEqualTo(69);
        Truth.assertThat(((TypeVariableName) (o_genericType_rv82__6)).isPrimitive()).isFalse();
        Truth.assertThat(((TypeVariableName) (o_genericType_rv82__6)).isAnnotated()).isFalse();
        Truth.assertThat(((TypeVariableName) (o_genericType_rv82__6)).isBoxedPrimitive()).isFalse();
        TypeName genericTypeName = TypeName.get(recursiveEnum.getParameterTypes()[0]);
        Truth.assertThat(((ArrayTypeName) (genericTypeName)).toString()).isEqualTo("java.lang.Enum[]");
        Truth.assertThat(((int) (((ArrayTypeName) (genericTypeName)).hashCode()))).isEqualTo(789002871);
        Truth.assertThat(((ArrayTypeName) (genericTypeName)).isPrimitive()).isFalse();
        ...
        TypeName o_genericType_rv82__15 = __DSPOT_invoc_11.withoutAnnotations();
        Truth.assertThat(((ArrayTypeName) (o_genericType_rv82__15)).toString()).isEqualTo("E[]");
        Truth.assertThat(((int) (((ArrayTypeName) (o_genericType_rv82__15)).hashCode()))).isEqualTo(69223);
        Truth.assertThat(((ArrayTypeName) (o_genericType_rv82__15)).isPrimitive()).isFalse();
        Truth.assertThat(((ArrayTypeName) (o_genericType_rv82__15)).isAnnotated()).isFalse();
        Truth.assertThat(((ArrayTypeName) (o_genericType_rv82__15)).isBoxedPrimitive()).isFalse();
        Truth.assertThat(((ClassName) (o_genericType_rv82__4)).isAnnotated()).isFalse();
        Truth.assertThat(((ClassName) (o_genericType_rv82__4)).toString()).isEqualTo("java.lang.Enum");
        Truth.assertThat(((int) (((ClassName) (o_genericType_rv82__4)).hashCode()))).isEqualTo(398585941);
        Truth.assertThat(((ClassName) (o_genericType_rv82__4)).isPrimitive()).isFalse();
