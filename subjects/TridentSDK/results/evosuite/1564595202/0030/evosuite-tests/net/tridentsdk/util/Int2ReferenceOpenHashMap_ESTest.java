...
public class Int2ReferenceOpenHashMap_ESTest extends Int2ReferenceOpenHashMap_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      try {
        int2ReferenceOpenHashMap0 = new Int2ReferenceOpenHashMap<Object>(2145853137, 0.26197532F);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Too large (2145853137 expected elements with load factor 0.26197532)
         //
         verifyException("net.tridentsdk.util.Int2ReferenceOpenHashMap", e);
      }
  }
  ...
  public void test2()  throws Throwable  {
      Int2ReferenceOpenHashMap<String> int2ReferenceOpenHashMap0 = new Int2ReferenceOpenHashMap<String>(3074, 1.0F);
  }
  ...
  public void test3()  throws Throwable  {
      ...
      int2ReferenceOpenHashMap0.size = 1533;
      // Undeclared exception!
      try { 
  ...
  public void test5()  throws Throwable  {
      ...
      int2ReferenceOpenHashMap0.size = 0;
      intArray0[0] = (-1640531561);
      intArray0[1] = 1;
      int2ReferenceOpenHashMap0.key = intArray0;
      int2ReferenceOpenHashMap0.size = (-1640531561);
      // Undeclared exception!
      int2ReferenceOpenHashMap0.rehash(1385);
  }
