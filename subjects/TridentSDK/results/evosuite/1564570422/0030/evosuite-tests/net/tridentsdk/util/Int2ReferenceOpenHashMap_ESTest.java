...
public class Int2ReferenceOpenHashMap_ESTest extends Int2ReferenceOpenHashMap_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      int2ReferenceOpenHashMap0.size = 300;
      // Undeclared exception!
      try { 
        int2ReferenceOpenHashMap0.rehash(1062);
  ...
  public void test2()  throws Throwable  {
      ...
      try {
        int2ReferenceOpenHashMap0 = new Int2ReferenceOpenHashMap<String>(2146123352, 0.4767621F);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Too large (2146123352 expected elements with load factor 0.4767621)
         //
         verifyException("net.tridentsdk.util.Int2ReferenceOpenHashMap", e);
      }
  }
  ...
  public void test5()  throws Throwable  {
      Int2ReferenceOpenHashMap<Integer> int2ReferenceOpenHashMap0 = new Int2ReferenceOpenHashMap<Integer>(1490, 1.0F);
      // Undeclared exception!
      try { 
        int2ReferenceOpenHashMap0.rehash((-2705));
