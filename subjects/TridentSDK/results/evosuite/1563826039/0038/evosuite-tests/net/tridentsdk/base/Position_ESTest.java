...
public class Position_ESTest extends Position_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Position position0 = new Position(world0, 4534.94283, 4534.94283, 2279.733558145);
      ...
      assertEquals(2.056570647136841E7, position1.getY(), 0.01);
      assertEquals(0.0F, position1.getYaw(), 0.01F);
      assertEquals(0.0F, position0.getPitch(), 0.01F);
      assertEquals(324824, position1.getChunkZ());
      assertEquals(1285356, position1.getChunkX());
  }

  @Test(timeout = 4000)
  public void test1()  throws Throwable  {
      World world0 = mock(World.class, new ViolatedAssumptionAnswer());
      Position position0 = new Position(world0, (-3968), (-3968), (-3968));
      assertEquals(0.0F, position0.getYaw(), 0.01F);
      assertEquals(0.0F, position0.getPitch(), 0.01F);
  }
  ...
  public void test2()  throws Throwable  {
      World world0 = mock(World.class, new ViolatedAssumptionAnswer());
      Position position0 = new Position(world0, 0.2, 0.2, 0.0, 0.0F, 548.5F);
      assertEquals(0.0F, position0.getYaw(), 0.01F);
      assertEquals(8.5F, position0.getPitch(), 0.01F);
  }
