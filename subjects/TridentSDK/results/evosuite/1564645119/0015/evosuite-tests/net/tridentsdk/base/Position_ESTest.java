...
public class Position_ESTest extends Position_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Position position0 = new Position(world0, (double) 881, (double) 881, (double) 881);
  ...
  public void test1()  throws Throwable  {
      World world0 = mock(World.class, new ViolatedAssumptionAnswer());
      Position position0 = new Position(world0, 881, 881, 881);
      assertEquals(0.0F, position0.getYaw(), 0.01F);
      assertEquals(0.0F, position0.getPitch(), 0.01F);
  }
  ...
  public void test2()  throws Throwable  {
      World world0 = mock(World.class, new ViolatedAssumptionAnswer());
      Position position0 = new Position(world0, 1.0, 6.0E7, 6.0E7, (-90.0F), (-505));
      assertEquals((-55.0F), position0.getPitch(), 0.01F);
