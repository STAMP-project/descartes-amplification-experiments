...
public class Int2ReferenceOpenHashMap_ESTest extends Int2ReferenceOpenHashMap_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      Int2ReferenceOpenHashMap<String> int2ReferenceOpenHashMap0 = new Int2ReferenceOpenHashMap<String>(1179, 1.0F);
      int2ReferenceOpenHashMap0.size = 1073741799;
  ...
  public void test2()  throws Throwable  {
      ...
      int2ReferenceOpenHashMap0.size = (-1619);
      // Undeclared exception!
      try { 
        int2ReferenceOpenHashMap0.trim();
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
