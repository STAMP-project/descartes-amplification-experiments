...
public class Position_ESTest extends Position_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn("NETHER").when(world0).getName();
      Position position0 = new Position(world0, (-550), (-550), (-550));
      Position position1 = position0.subtract((double) (-550), (double) (-550), (double) (-550));
  ...
  public void test1()  throws Throwable  {
      World world0 = mock(World.class, new ViolatedAssumptionAnswer());
      Position position0 = new Position(world0, (-414), 1.0, 0.0, (-414), 64.0F);
      assertEquals((-54.0F), position0.getYaw(), 0.01F);
      assertEquals(64.0F, position0.getPitch(), 0.01F);
  }

  @Test(timeout = 4000)
  public void test2()  throws Throwable  {
      World world0 = mock(World.class, new ViolatedAssumptionAnswer());
      Position position0 = new Position(world0, 7.518506398011492, 7.518506398011492, 7.518506398011492);
      assertEquals(0.0F, position0.getYaw(), 0.01F);
      assertEquals(0.0F, position0.getPitch(), 0.01F);
  }
