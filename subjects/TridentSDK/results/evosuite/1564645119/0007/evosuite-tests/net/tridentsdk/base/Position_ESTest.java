...
public class Position_ESTest extends Position_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Position position0 = new Position(world0, 1523.17857498, 1523.17857498, (-1697.0), 1490.0F, (-1136.0F));
      Position position1 = position0.divide(position0);
      assertEquals((-56.0F), position1.getPitch(), 0.01F);
      assertEquals(1, position1.getIntX());
      assertEquals(50.0F, position1.getYaw(), 0.01F);
  ...
  public void test1()  throws Throwable  {
      World world0 = mock(World.class, new ViolatedAssumptionAnswer());
      Position position0 = new Position(world0, 3, 0, 0);
  ...
  public void test2()  throws Throwable  {
      World world0 = mock(World.class, new ViolatedAssumptionAnswer());
      Position position0 = new Position(world0, (double) (-1623), (double) (-1623), (double) (-1623));
      assertEquals(0.0F, position0.getYaw(), 0.01F);
      assertEquals(0.0F, position0.getPitch(), 0.01F);
  }
