...
public class Int2ReferenceOpenHashMap_ESTest extends Int2ReferenceOpenHashMap_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      int2ReferenceOpenHashMap0.size = 2254;
  ...
  public void test2()  throws Throwable  {
      ...
      try {
        int2ReferenceOpenHashMap0 = new Int2ReferenceOpenHashMap<String>(2141950636, 0.27104983F);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Too large (2141950636 expected elements with load factor 0.27104983)
         //
         verifyException("net.tridentsdk.util.Int2ReferenceOpenHashMap", e);
      }
  }
  ...
  public void test3()  throws Throwable  {
      Int2ReferenceOpenHashMap<String> int2ReferenceOpenHashMap0 = new Int2ReferenceOpenHashMap<String>(3329, 1.0F);
  }
  ...
  public void test5()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        int2ReferenceOpenHashMap0.rehash(2567);
  ...
  public void test6()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        int2ReferenceOpenHashMap0.rehash((-2348));
