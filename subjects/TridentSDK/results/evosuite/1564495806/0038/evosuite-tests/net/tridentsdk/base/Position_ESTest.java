...
public class Position_ESTest extends Position_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Position position0 = new Position(world0, 1425, 1425, 1425);
      ...
      assertEquals(2030625.0, position1.getX(), 0.01);
      assertEquals(2030625, position1.getIntY());
      assertEquals(2030625, position1.getIntZ());
  ...
  public void test1()  throws Throwable  {
      World world0 = mock(World.class, new ViolatedAssumptionAnswer());
      Position position0 = new Position(world0, (-555.6925221335001), 0.0, 0.0, (-979.77F), 0);
      assertEquals((-259.77002F), position0.getYaw(), 0.01F);
      assertEquals(0.0F, position0.getPitch(), 0.01F);
  }
  ...
  public void test2()  throws Throwable  {
      World world0 = mock(World.class, new ViolatedAssumptionAnswer());
      Position position0 = new Position(world0, (double) (-1111), (double) (-1111), (double) (-1111));
      assertEquals(0.0F, position0.getYaw(), 0.01F);
      assertEquals(0.0F, position0.getPitch(), 0.01F);
  }
