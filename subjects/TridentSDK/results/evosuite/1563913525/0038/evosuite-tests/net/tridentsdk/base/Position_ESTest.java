...
public class Position_ESTest extends Position_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Position position0 = new Position(world0, (double) (-3244), (double) (-3244), (double) (-3244));
      ...
      assertEquals(10523536, position1.getIntZ());
      assertEquals(1.0523536E7, position1.getY(), 0.01);
      assertEquals(1.0523536E7, position1.getX(), 0.01);
  }

  @Test(timeout = 4000)
  public void test1()  throws Throwable  {
      World world0 = mock(World.class, new ViolatedAssumptionAnswer());
      Position position0 = new Position(world0, (-3244), (-3244), (-3244));
      assertEquals(0.0F, position0.getYaw(), 0.01F);
      assertEquals(0.0F, position0.getPitch(), 0.01F);
  }
  ...
  public void test2()  throws Throwable  {
      World world0 = mock(World.class, new ViolatedAssumptionAnswer());
      Position position0 = new Position(world0, (-1163.865370786431), 0.0, 0.0, 0.0F, (-1480.0F));
      assertEquals(0.0F, position0.getYaw(), 0.01F);
      assertEquals((-40.0F), position0.getPitch(), 0.01F);
  }
