...
public class Int2ReferenceOpenHashMap_ESTest extends Int2ReferenceOpenHashMap_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      Int2ReferenceOpenHashMap<String> int2ReferenceOpenHashMap0 = new Int2ReferenceOpenHashMap<String>(4, 1.0F);
      int[] intArray0 = new int[9];
      intArray0[0] = (-128);
      intArray0[1] = (-128);
      intArray0[2] = 4;
      int2ReferenceOpenHashMap0.key = intArray0;
      int2ReferenceOpenHashMap0.size = (-128);
  ...
  public void test2()  throws Throwable  {
      ...
      int2ReferenceOpenHashMap0.n = (-765);
  ...
  public void test6()  throws Throwable  {
      Int2ReferenceOpenHashMap<String> int2ReferenceOpenHashMap0 = new Int2ReferenceOpenHashMap<String>();
      int2ReferenceOpenHashMap0.size = 2141898965;
      // Undeclared exception!
      try { 
        int2ReferenceOpenHashMap0.trim();
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Too large (2141898965 expected elements with load factor 0.75)
         //
         verifyException("net.tridentsdk.util.Int2ReferenceOpenHashMap", e);
      }
  }
