...
public class Int2ReferenceOpenHashMap_ESTest extends Int2ReferenceOpenHashMap_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      try {
        int2ReferenceOpenHashMap0 = new Int2ReferenceOpenHashMap<Object>(2146573697, 0.2595718F);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Too large (2146573697 expected elements with load factor 0.2595718)
         //
         verifyException("net.tridentsdk.util.Int2ReferenceOpenHashMap", e);
      }
  }
  ...
  public void test3()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        int2ReferenceOpenHashMap0.rehash(4167);
  ...
  public void test4()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        int2ReferenceOpenHashMap0.rehash((-2661));
  ...
  public void test5()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        int2ReferenceOpenHashMap0.rehash(1807);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test6()  throws Throwable  {
      Int2ReferenceOpenHashMap<Integer> int2ReferenceOpenHashMap0 = new Int2ReferenceOpenHashMap<Integer>();
      int2ReferenceOpenHashMap0.rehash(2961);
  }
}
