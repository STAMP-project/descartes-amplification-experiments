...
public class Position_ESTest extends Position_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Position position0 = new Position(world0, 2415.6646797537746, 2415.6646797537746, 1.171, 90.0F, 90.0F);
      Position position1 = position0.add(position0);
      assertEquals(90.0F, position1.getYaw(), 0.01F);
      assertEquals(90.0F, position1.getPitch(), 0.01F);
      assertEquals(4831, position1.getIntY());
      assertEquals(90.0F, position0.getYaw(), 0.01F);
      assertEquals(90.0F, position0.getPitch(), 0.01F);
      assertEquals(2, position1.getIntZ());
      assertEquals(301, position1.getChunkX());
  }
  ...
  public void test2()  throws Throwable  {
      World world0 = mock(World.class, new ViolatedAssumptionAnswer());
      Position position0 = new Position(world0, (-1654.5346679102897), (-1654.5346679102897), (-1654.5346679102897));
      assertEquals(0.0F, position0.getYaw(), 0.01F);
      assertEquals(0.0F, position0.getPitch(), 0.01F);
  }
