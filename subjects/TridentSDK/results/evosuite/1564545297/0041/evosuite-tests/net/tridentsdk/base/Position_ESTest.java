...
public class Position_ESTest extends Position_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Position position0 = new Position(world0, 1510, 0, 0);
      Position position1 = position0.subtract(291, 125, 4201);
      assertEquals(0.0F, position1.getYaw(), 0.01F);
      assertEquals(0.0F, position1.getPitch(), 0.01F);
      assertEquals((-125.0), position1.getY(), 0.01);
      assertEquals(0.0F, position0.getYaw(), 0.01F);
      assertEquals((-263), position1.getChunkZ());
      assertEquals(1219.0, position1.getX(), 0.01);
  ...
  public void test1()  throws Throwable  {
      World world0 = mock(World.class, new ViolatedAssumptionAnswer());
      Position position0 = new Position(world0, 0, 0.0, 0, 0.0F, 0);
      assertEquals(0.0F, position0.getYaw(), 0.01F);
      assertEquals(0.0F, position0.getPitch(), 0.01F);
  }
  ...
  public void test2()  throws Throwable  {
      World world0 = mock(World.class, new ViolatedAssumptionAnswer());
      Position position0 = new Position(world0, 125, 2392.0602, 2392.0602);
      assertEquals(0.0F, position0.getPitch(), 0.01F);
      assertEquals(0.0F, position0.getYaw(), 0.01F);
  }
