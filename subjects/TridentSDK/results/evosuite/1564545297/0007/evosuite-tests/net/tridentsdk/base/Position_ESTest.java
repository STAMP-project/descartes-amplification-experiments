...
public class Position_ESTest extends Position_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Position position0 = new Position(world0, (-2256.53), (-2256.53), (-2256.53), 1046.66F, 2381.1128F);
      Position position1 = position0.divide(position0);
      assertEquals(41.112793F, position1.getPitch(), 0.01F);
      assertEquals(326.66003F, position1.getYaw(), 0.01F);
      assertEquals(1.0, position1.getY(), 0.01);
      assertEquals(0, position1.getChunkZ());
      assertEquals(0, position1.getChunkX());
      assertEquals(326.66003F, position0.getYaw(), 0.01F);
  }

  @Test(timeout = 4000)
  public void test1()  throws Throwable  {
      World world0 = mock(World.class, new ViolatedAssumptionAnswer());
      Position position0 = new Position(world0, 0, 0, (-2546));
  ...
  public void test2()  throws Throwable  {
      World world0 = mock(World.class, new ViolatedAssumptionAnswer());
      Position position0 = new Position(world0, 1573.99, 0.0, (-2256.53));
      assertEquals(0.0F, position0.getPitch(), 0.01F);
      assertEquals(0.0F, position0.getYaw(), 0.01F);
  }
