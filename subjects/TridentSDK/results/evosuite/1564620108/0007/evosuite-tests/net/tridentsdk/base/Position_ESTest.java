...
public class Position_ESTest extends Position_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn("LCXhatlz").when(world0).getName();
      Position position0 = new Position(world0, 3429.9406471756515, 3429.9406471756515, 3429.9406471756515);
  ...
  public void test1()  throws Throwable  {
      World world0 = mock(World.class, new ViolatedAssumptionAnswer());
      Position position0 = new Position(world0, (-3405), (-3405), (-3405));
      assertEquals(0.0F, position0.getYaw(), 0.01F);
      assertEquals(0.0F, position0.getPitch(), 0.01F);
  }
  ...
  public void test2()  throws Throwable  {
      World world0 = mock(World.class, new ViolatedAssumptionAnswer());
      Position position0 = new Position(world0, 6.0E7, 0.0, 0.0, 1740.0F, 1740.0F);
      assertEquals(30.0F, position0.getPitch(), 0.01F);
      assertEquals(300.0F, position0.getYaw(), 0.01F);
  }
