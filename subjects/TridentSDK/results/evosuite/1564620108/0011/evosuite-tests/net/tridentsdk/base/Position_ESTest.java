...
public class Position_ESTest extends Position_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Position position0 = new Position(world0, (-3761.46381), 0.0, (-3761.46381));
      ...
      assertEquals((-471), position1.getChunkZ());
      assertEquals((-7522.92762), position1.getX(), 0.01);
  ...
  public void test1()  throws Throwable  {
      World world0 = mock(World.class, new ViolatedAssumptionAnswer());
      doReturn((String) null).when(world0).getName();
      Position position0 = new Position(world0, 722.22143, 722.22143, 0.0, (-1.0F), (-1.0F));
      Position position1 = position0.add(position0);
      assertEquals(0.0, position1.getZ(), 0.01);
      assertEquals(1444.44286, position1.getY(), 0.01);
      assertEquals(1444.44286, position1.getX(), 0.01);
  ...
  public void test2()  throws Throwable  {
      World world0 = mock(World.class, new ViolatedAssumptionAnswer());
      Position position0 = new Position(world0, 2283, 2283, 2283);
      assertEquals(0.0F, position0.getPitch(), 0.01F);
      assertEquals(0.0F, position0.getYaw(), 0.01F);
  }
