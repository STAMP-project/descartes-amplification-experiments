...
public class SampleXmlBuilder_ESTest extends SampleXmlBuilder_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      QualifiedName qualifiedName0 = new QualifiedName((String) null, "[z.z-ft[WF]Q8");
      Element element0 = new Element(qualifiedName0, 1694);
  ...
  public void test2()  throws Throwable  {
      ...
      QualifiedName qualifiedName0 = new QualifiedName(namespace0, "HG?`#9~#vU5e5x#");
      Element element0 = new Element(qualifiedName0, 0);
      Document document0 = new Document(element0);
      SampleXmlBuilder sampleXmlBuilder0 = new SampleXmlBuilder(document0, "\n");
      // Undeclared exception!
      try { 
        sampleXmlBuilder0.createRandomElement("HG?`#9~#vU5e5x#");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Can't find type definition of HG?`#9~#vU5e5x#
         //
