...
public class SampleXmlBuilder_ESTest extends SampleXmlBuilder_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      try {
        sampleXmlBuilder0 = new SampleXmlBuilder((URL) null, "aLB>K,5 =?O77EG");
  ...
  public void test1()  throws Throwable  {
      QualifiedName qualifiedName0 = new QualifiedName("simpleTyte");
      Element element0 = new Element(qualifiedName0, (-1));
      Document document0 = new Document(element0);
      LinkedList<Document> linkedList0 = new LinkedList<Document>();
      SampleXmlBuilder sampleXmlBuilder0 = new SampleXmlBuilder("simpleTyte", document0, linkedList0);
  }

  @Test(timeout = 4000)
  public void test2()  throws Throwable  {
      QualifiedName qualifiedName0 = new QualifiedName("import", "import", "import");
      Element element0 = new Element(qualifiedName0, 0);
      Document document0 = new Document(element0);
      SampleXmlBuilder sampleXmlBuilder0 = new SampleXmlBuilder(document0, "V]<qF+}4'");
      // Undeclared exception!
      try { 
        sampleXmlBuilder0.randomElementText("import", element0);
        fail("Expecting exception: NullPointerException");
