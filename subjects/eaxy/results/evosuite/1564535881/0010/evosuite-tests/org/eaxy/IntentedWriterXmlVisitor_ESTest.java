...
public class IntentedWriterXmlVisitor_ESTest extends IntentedWriterXmlVisitor_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      IntentedWriterXmlVisitor intentedWriterXmlVisitor0 = new IntentedWriterXmlVisitor(stringWriter0, ">{beXow ");
      Xml.CommentElement xml_CommentElement0 = new Xml.CommentElement(">{beXow ");
