...
public class SampleXmlBuilder_ESTest extends SampleXmlBuilder_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      try {
        sampleXmlBuilder0 = new SampleXmlBuilder((URL) null, "c[Ua% $[4");
  ...
  public void test1()  throws Throwable  {
      QualifiedName qualifiedName0 = new QualifiedName("l|+!*]Xn8");
      Element element0 = new Element(qualifiedName0, 785);
  ...
  public void test2()  throws Throwable  {
      QualifiedName qualifiedName0 = new QualifiedName("^3si*o|WX#H7");
      Element element0 = new Element(qualifiedName0, (-1556));
      Document document0 = new Document(element0);
      SampleXmlBuilder sampleXmlBuilder0 = new SampleXmlBuilder(document0, "^3si*o|WX#H7");
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Can't find type definition of ^3si*o|WX#H7
         //
         verifyException("org.eaxy.experimental.SampleXmlBuilder", e);
      }
  }
