...
public class SampleSoapXmlBuilder_ESTest extends SampleSoapXmlBuilder_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      QualifiedName qualifiedName0 = new QualifiedName("", "iSvH?nd");
      Element element0 = new Element(qualifiedName0, 4198);
  ...
  public void test1()  throws Throwable  {
      QualifiedName qualifiedName0 = new QualifiedName("CMA", "CMA");
  ...
  public void test2()  throws Throwable  {
      QualifiedName qualifiedName0 = new QualifiedName("thMn", "thMn");
      Element element0 = new Element(qualifiedName0, 496);
      Document document0 = new Document(element0);
      SampleSoapXmlBuilder sampleSoapXmlBuilder0 = new SampleSoapXmlBuilder(document0);
      SampleSoapXmlBuilder.SoapServiceDefinition sampleSoapXmlBuilder_SoapServiceDefinition0 = null;
      try {
        sampleSoapXmlBuilder_SoapServiceDefinition0 = sampleSoapXmlBuilder0.new SoapServiceDefinition("thMn");
  ...
  public void test4()  throws Throwable  {
      SampleSoapXmlBuilder sampleSoapXmlBuilder0 = null;
      try {
        sampleSoapXmlBuilder0 = new SampleSoapXmlBuilder(" Pctual el&ments: ");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Can't find resource / Pctual el&ments: 
         //
