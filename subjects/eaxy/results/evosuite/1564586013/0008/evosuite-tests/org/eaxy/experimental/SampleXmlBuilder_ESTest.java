...
public class SampleXmlBuilder_ESTest extends SampleXmlBuilder_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      try {
        sampleXmlBuilder0 = new SampleXmlBuilder((URL) null, "-c^K1#<)P\"TZ");
  ...
  public void test1()  throws Throwable  {
      ...
      Element element0 = new Element(qualifiedName0, 2048);
  ...
  public void test2()  throws Throwable  {
      QualifiedName qualifiedName0 = new QualifiedName("simpleTyp]", "simpleTyp]");
      Element element0 = new Element(qualifiedName0, (-1624624074));
      Document document0 = new Document(element0);
      LinkedList<Document> linkedList0 = new LinkedList<Document>();
      SampleXmlBuilder sampleXmlBuilder0 = new SampleXmlBuilder("s*\b", document0, linkedList0);
      // Undeclared exception!
      try { 
        sampleXmlBuilder0.randomData(element0);
        fail("Expecting exception: NullPointerException");
