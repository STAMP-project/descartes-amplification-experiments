...
public class SampleSoapXmlBuilder_ESTest extends SampleSoapXmlBuilder_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      QualifiedName qualifiedName0 = new QualifiedName(namespace0, "output");
      Element element0 = new Element(qualifiedName0, (-2355));
  ...
  public void test1()  throws Throwable  {
      QualifiedName qualifiedName0 = new QualifiedName("ovperation[nam=");
      ...
      try {
        sampleSoapXmlBuilder_SoapServiceDefinition0 = sampleSoapXmlBuilder0.new SoapServiceDefinition("ovperation[nam=");
  ...
  public void test2()  throws Throwable  {
      ...
      Element element0 = new Element(qualifiedName0, 71);
      Document document0 = new Document(element0);
      SampleSoapXmlBuilder sampleSoapXmlBuilder0 = new SampleSoapXmlBuilder(document0);
      SampleSoapXmlBuilder.SoapServiceDefinition sampleSoapXmlBuilder_SoapServiceDefinition0 = null;
      try {
  ...
  public void test4()  throws Throwable  {
      SampleSoapXmlBuilder sampleSoapXmlBuilder0 = null;
      try {
        sampleSoapXmlBuilder0 = new SampleSoapXmlBuilder("nc_#F62X</wn");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Can't find resource /nc_#F62X</wn
         //
