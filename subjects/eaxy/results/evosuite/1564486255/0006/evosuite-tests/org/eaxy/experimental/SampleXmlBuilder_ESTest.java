...
public class SampleXmlBuilder_ESTest extends SampleXmlBuilder_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      try {
        sampleXmlBuilder0 = new SampleXmlBuilder((URL) null, "StringWriter doesn't throw IOException");
  ...
  public void test2()  throws Throwable  {
      ...
      QualifiedName qualifiedName0 = new QualifiedName(namespace0, "there");
      Element element0 = new Element(qualifiedName0, 0);
      Document document0 = new Document(element0);
      LinkedList<Document> linkedList0 = new LinkedList<Document>();
      SampleXmlBuilder sampleXmlBuilder0 = new SampleXmlBuilder("3kx?AIxXcD9", document0, linkedList0);
      // Undeclared exception!
      try { 
        sampleXmlBuilder0.randomAttributeText("there", element0);
        fail("Expecting exception: NullPointerException");
