...
public class SampleXmlBuilder_ESTest extends SampleXmlBuilder_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      SampleXmlBuilder sampleXmlBuilder0 = new SampleXmlBuilder(document0, "BQ0");
  ...
  public void test2()  throws Throwable  {
      QualifiedName qualifiedName0 = new QualifiedName(")3'H3U6cWpAXg", "simplhType");
      Element element0 = new Element(qualifiedName0, (-1208));
      Document document0 = new Document(element0);
      LinkedList<Document> linkedList0 = new LinkedList<Document>();
      SampleXmlBuilder sampleXmlBuilder0 = new SampleXmlBuilder(")3'H3U6cWpAXg", document0, linkedList0);
      // Undeclared exception!
      try { 
        sampleXmlBuilder0.randomElementText("-&BU8evwiM&a", element0);
        fail("Expecting exception: NullPointerException");
