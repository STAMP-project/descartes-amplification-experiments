...
public class SampleSoapXmlBuilder_ESTest extends SampleSoapXmlBuilder_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      QualifiedName qualifiedName0 = new QualifiedName("b,.=R2^h!", "b,.=R2^h!");
      Element element0 = new Element(qualifiedName0, 2511);
  ...
  public void test1()  throws Throwable  {
      Namespace namespace0 = new Namespace("!un&<k}", "*");
      QualifiedName qualifiedName0 = new QualifiedName(namespace0, "*");
      Element element0 = new Element(qualifiedName0, 2901);
      Document document0 = new Document(element0);
  ...
  public void test2()  throws Throwable  {
      QualifiedName qualifiedName0 = new QualifiedName("\b.*", "\b.*", "\b.*");
      Element element0 = new Element(qualifiedName0, 0);
      Document document0 = new Document(element0);
      SampleSoapXmlBuilder sampleSoapXmlBuilder0 = new SampleSoapXmlBuilder(document0);
      SampleSoapXmlBuilder.SoapServiceDefinition sampleSoapXmlBuilder_SoapServiceDefinition0 = null;
      try {
        sampleSoapXmlBuilder_SoapServiceDefinition0 = sampleSoapXmlBuilder0.new SoapServiceDefinition("\b.*");
  ...
  public void test4()  throws Throwable  {
      SampleSoapXmlBuilder sampleSoapXmlBuilder0 = null;
      try {
        sampleSoapXmlBuilder0 = new SampleSoapXmlBuilder("bgUHPs$q&k`A");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Can't find resource /bgUHPs$q&k`A
         //
