...
public class SampleXmlBuilder_ESTest extends SampleXmlBuilder_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      QualifiedName qualifiedName0 = new QualifiedName(".^EH^UC", ".^EH^UC", ".^EH^UC");
      Element element0 = new Element(qualifiedName0, 17);
      Document document0 = new Document(element0);
      SampleXmlBuilder sampleXmlBuilder0 = new SampleXmlBuilder(document0, ".^EH^UC");
  ...
  public void test2()  throws Throwable  {
      QualifiedName qualifiedName0 = new QualifiedName("* Hq3d2");
      Element element0 = new Element(qualifiedName0, (-4092));
      Document document0 = new Document(element0);
      LinkedList<Document> linkedList0 = new LinkedList<Document>();
      SampleXmlBuilder sampleXmlBuilder0 = new SampleXmlBuilder("* Hq3d2", document0, linkedList0);
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Can't find type definition of * Hq3d2
         //
         verifyException("org.eaxy.experimental.SampleXmlBuilder", e);
      }
  }
