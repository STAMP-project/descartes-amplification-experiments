...
public class SampleXmlBuilder_ESTest extends SampleXmlBuilder_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      QualifiedName qualifiedName0 = new QualifiedName("tell", "simpleType");
      Element element0 = new Element(qualifiedName0, (-3371));
  ...
  public void test2()  throws Throwable  {
      QualifiedName qualifiedName0 = new QualifiedName("simpl5Type");
      Element element0 = new Element(qualifiedName0, 74);
      Document document0 = new Document(element0);
      LinkedList<Document> linkedList0 = new LinkedList<Document>();
      SampleXmlBuilder sampleXmlBuilder0 = new SampleXmlBuilder("simpl5Type", document0, linkedList0);
      // Undeclared exception!
      try { 
        sampleXmlBuilder0.randomData(element0);
        fail("Expecting exception: NullPointerException");
