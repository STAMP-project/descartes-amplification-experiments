...
public class SampleXmlBuilder_ESTest extends SampleXmlBuilder_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      try {
        sampleXmlBuilder0 = new SampleXmlBuilder((URL) null, "IjTcI$A~7;i");
  ...
  public void test2()  throws Throwable  {
      QualifiedName qualifiedName0 = new QualifiedName("A:.!F=l9p9s|2f", "A:.!F=l9p9s|2f", "A:.!F=l9p9s|2f");
      Element element0 = new Element(qualifiedName0, 5);
      Document document0 = new Document(element0);
      SampleXmlBuilder sampleXmlBuilder0 = new SampleXmlBuilder(document0, "A:.!F=l9p9s|2f");
