...
public class SampleXmlBuilder_ESTest extends SampleXmlBuilder_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      Element element0 = new Element(qualifiedName0, (-1909054820));
  ...
  public void test2()  throws Throwable  {
      ...
      QualifiedName qualifiedName0 = new QualifiedName(namespace0, "$impleType");
      Element element0 = new Element(qualifiedName0, (-1803349593));
      Document document0 = new Document(element0);
      LinkedList<Document> linkedList0 = new LinkedList<Document>();
      SampleXmlBuilder sampleXmlBuilder0 = new SampleXmlBuilder("$impleType", document0, linkedList0);
      // Undeclared exception!
      try { 
        sampleXmlBuilder0.randomData(element0);
        fail("Expecting exception: NullPointerException");
