...
public class SampleXmlBuilder_ESTest extends SampleXmlBuilder_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      QualifiedName qualifiedName0 = new QualifiedName("GuE");
      Element element0 = new Element(qualifiedName0, 40);
  ...
  public void test2()  throws Throwable  {
      QualifiedName qualifiedName0 = new QualifiedName("P{|,nk5`M?}", "P{|,nk5`M?}", "P{|,nk5`M?}");
      Element element0 = new Element(qualifiedName0, 1725);
      Document document0 = new Document(element0);
      LinkedList<Document> linkedList0 = new LinkedList<Document>();
      SampleXmlBuilder sampleXmlBuilder0 = new SampleXmlBuilder("P{|,nk5`M?}", document0, linkedList0);
