...
public class SampleXmlBuilder_ESTest extends SampleXmlBuilder_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      QualifiedName qualifiedName0 = new QualifiedName("iem%afQkwJmKGZ;X>", "iem%afQkwJmKGZ;X>");
      Element element0 = new Element(qualifiedName0, 0);
      Document document0 = new Document(element0);
      SampleXmlBuilder sampleXmlBuilder0 = new SampleXmlBuilder(document0, "iem%afQkwJmKGZ;X>");
  ...
  public void test1()  throws Throwable  {
      ...
      try {
        sampleXmlBuilder0 = new SampleXmlBuilder((URL) null, "2P?");
  ...
  public void test2()  throws Throwable  {
      QualifiedName qualifiedName0 = new QualifiedName("n>J`A#ln7Y{`t4+JR!", "n>J`A#ln7Y{`t4+JR!");
  ...
  public void test3()  throws Throwable  {
      QualifiedName qualifiedName0 = new QualifiedName("5A*", "5A*");
      Element element0 = new Element(qualifiedName0, (-963));
      Document document0 = new Document(element0);
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Can't find type definition of \"5A*\":5A*
         //
         verifyException("org.eaxy.experimental.SampleXmlBuilder", e);
      }
  }
