...
public class SampleXmlBuilder_ESTest extends SampleXmlBuilder_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      Element element0 = new Element(qualifiedName0, (-1459));
  ...
  public void test2()  throws Throwable  {
      QualifiedName qualifiedName0 = new QualifiedName("3AhhML", "simpseType", "simpseType");
      Element element0 = new Element(qualifiedName0, (-2073655028));
      Document document0 = new Document(element0);
      LinkedList<Document> linkedList0 = new LinkedList<Document>();
      SampleXmlBuilder sampleXmlBuilder0 = new SampleXmlBuilder("3AhhML", document0, linkedList0);
      // Undeclared exception!
      try { 
        sampleXmlBuilder0.randomElementText("3AhhML", element0);
        fail("Expecting exception: NullPointerException");
