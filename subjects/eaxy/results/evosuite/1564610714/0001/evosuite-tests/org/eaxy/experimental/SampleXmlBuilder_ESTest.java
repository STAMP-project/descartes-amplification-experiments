...
public class SampleXmlBuilder_ESTest extends SampleXmlBuilder_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      QualifiedName qualifiedName0 = new QualifiedName("M`K^t9`LRj[0", "M`K^t9`LRj[0", "M`K^t9`LRj[0");
  ...
  public void test1()  throws Throwable  {
      ...
      try {
        sampleXmlBuilder0 = new SampleXmlBuilder((URL) null, "%=i.s$]Dtm[m$MVw#+i");
