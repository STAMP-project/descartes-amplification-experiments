...
public class SampleXmlBuilder_ESTest extends SampleXmlBuilder_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      QualifiedName qualifiedName0 = new QualifiedName("f*I");
      Element element0 = new Element(qualifiedName0, (-1116));
      Document document0 = new Document(element0);
      LinkedList<Document> linkedList0 = new LinkedList<Document>();
      SampleXmlBuilder sampleXmlBuilder0 = new SampleXmlBuilder("f*I", document0, linkedList0);
  }
  ...
  public void test1()  throws Throwable  {
      ...
      try {
        sampleXmlBuilder0 = new SampleXmlBuilder((URL) null, "then");
  ...
  public void test3()  throws Throwable  {
      QualifiedName qualifiedName0 = new QualifiedName("simpl}Type", "simpl}Type", "simpl}Type");
      Element element0 = new Element(qualifiedName0, 8);
      Document document0 = new Document(element0);
      SampleXmlBuilder sampleXmlBuilder0 = new SampleXmlBuilder(document0, "simpl}Type");
      // Undeclared exception!
      try { 
        sampleXmlBuilder0.randomData(element0);
        fail("Expecting exception: NullPointerException");
