...
public class SampleSoapXmlBuilder_ESTest extends SampleSoapXmlBuilder_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      QualifiedName qualifiedName0 = new QualifiedName("portType[name=", "4`/:*ApXd}", "4`/:*ApXd}");
      Element element0 = new Element(qualifiedName0, 2189);
  ...
  public void test1()  throws Throwable  {
      QualifiedName qualifiedName0 = new QualifiedName("SM5Ca", "SM5Ca");
      Element element0 = new Element(qualifiedName0, 2439);
      Document document0 = new Document(element0);
  ...
  public void test2()  throws Throwable  {
      QualifiedName qualifiedName0 = new QualifiedName("9$.`y}v", "9$.`y}v");
      Element element0 = new Element(qualifiedName0, (-1042));
      Document document0 = new Document(element0);
      SampleSoapXmlBuilder sampleSoapXmlBuilder0 = new SampleSoapXmlBuilder(document0);
      SampleSoapXmlBuilder.SoapServiceDefinition sampleSoapXmlBuilder_SoapServiceDefinition0 = null;
      try {
  ...
  public void test4()  throws Throwable  {
      SampleSoapXmlBuilder sampleSoapXmlBuilder0 = null;
      try {
        sampleSoapXmlBuilder0 = new SampleSoapXmlBuilder("dN");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Can't find resource /dN
         //
