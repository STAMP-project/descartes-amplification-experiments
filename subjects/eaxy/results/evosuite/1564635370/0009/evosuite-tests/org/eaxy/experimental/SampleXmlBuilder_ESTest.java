...
public class SampleXmlBuilder_ESTest extends SampleXmlBuilder_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      QualifiedName qualifiedName0 = new QualifiedName("A#0Vr?7$/h", "A#0Vr?7$/h", "A#0Vr?7$/h");
      Element element0 = new Element(qualifiedName0, (-33));
      Document document0 = new Document(element0);
      SampleXmlBuilder sampleXmlBuilder0 = new SampleXmlBuilder(document0, "A#0Vr?7$/h");
  }
  ...
  public void test1()  throws Throwable  {
      ...
      try {
        sampleXmlBuilder0 = new SampleXmlBuilder((URL) null, "ny8<<DE'p[g");
