...
public class SampleXmlBuilder_ESTest extends SampleXmlBuilder_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      try {
        sampleXmlBuilder0 = new SampleXmlBuilder((URL) null, "ZYuGbHyHnxp,X#(Qg");
  ...
  public void test1()  throws Throwable  {
      Namespace namespace0 = new Namespace("EZyhQ<c`");
      QualifiedName qualifiedName0 = new QualifiedName(namespace0, "FYU!dEGa");
      Element element0 = new Element(qualifiedName0, (-371));
      Document document0 = new Document(element0);
      LinkedList<Document> linkedList0 = new LinkedList<Document>();
      SampleXmlBuilder sampleXmlBuilder0 = new SampleXmlBuilder("EZyhQ<c`", document0, linkedList0);
  }

  @Test(timeout = 4000)
  public void test2()  throws Throwable  {
      QualifiedName qualifiedName0 = new QualifiedName("-K?>|wjC_`", "simpleType", "-K?>|wjC_`");
  ...
  public void test3()  throws Throwable  {
      QualifiedName qualifiedName0 = new QualifiedName("|htmcj|hs");
      Element element0 = new Element(qualifiedName0, 2277);
      Document document0 = new Document(element0);
